...
开发人员和开源作者现在有许多提供免费层的服务，但找到它们都需要时间来做出明智的决策。

这是一个包含免费开发者层级的软件（SaaS、PaaS、IaaS 等）和其他产品的列表。

这个特定列表的范围仅限于基础设施开发人员（系统管理员、DevOps 从业者等）可能会发现有用的东西。我们喜欢那里所有的免费服务，但保持主题相关会很好。有时候这是一条灰色的线，所以这是有偏见的；如果我不接受你的贡献，请不要感到冒犯。

这个列表是通过拉取请求、评论、想法和 1600 多人的工作产生的。你也可以通过发送[拉取请求](https://github.com/ripienaar/free-for-dev)来添加更多服务或删除那些提供的服务已经更改或已退役的服务。

[![跟踪优秀列表](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/ripienaar/free-for-dev)

**注意**：此列表仅适用于即服务产品，不适用于自托管软件。要符合条件，服务必须提供免费层，而不仅仅是免费试用。如果是时间 bucket 型的，免费层必须至少为一年。我们还从安全角度考虑免费层，因此 SSO 是可以的，但我不会接受将 TLS 限制为仅付费层的服务。
...
## 主要云服务提供商的免费服务限制
  ...
  * [Amazon Web Services](https://aws.amazon.com)
    * [CloudFront](https://aws.amazon.com/cloudfront/) - 每月 1TB 出站流量和每月 2M 函数调用次数
  ...
  * [Microsoft Azure](https://azure.microsoft.com)
    ...
    * [Azure Pipelines](https://azure.microsoft.com/services/devops/pipelines/) - Linux、macOS 和 Windows 的开源版本每月有 10 个免费并行作业，且不限时间
    ...
    * [Static Web Apps](https://azure.microsoft.com/pricing/details/app-service/static/) - 构建、部署和托管静态应用和无服务器函数，免费提供 SSL、身份验证/授权和自定义域
    * [Storage](https://azure.microsoft.com/services/storage/) - 5GB LRS 文件或Blob 存储（12 个月）
    * [Cognitive Services](https://azure.microsoft.com/services/cognitive-services/) - AI/ML API（计算机视觉、翻译、面部检测、机器人等），包括免费层和有限的事务
    * [Cognitive Search](https://azure.microsoft.com/services/search/#features) - 基于 AI 的搜索和索引服务，免费 10,000 份文档
    * [Azure Kubernetes Service](https://azure.microsoft.com/services/kubernetes-service/) - 托管 Kubernetes 服务，免费集群管理
    * [Event Grid](https://azure.microsoft.com/services/event-grid/) - 每月 100K 个操作
    * 完整详细列表 - https://azure.microsoft.com/free/

  * [Oracle Cloud](https://www.oracle.com/cloud/)
    * 计算
       - 2 个基于 AMD 的 Compute VM，每个 VM 具有 1/8 OCPU 和 1GB 内存
       - 4 个基于 Arm 的 Ampere A1 核心和 24GB 内存，可作为一个 VM 使用，也可最多用于 4 个 VM
       - 实例在被视为空闲时会被回收[参考](https://docs.oracle.com/en-us/iaas/Content/FreeTier/freetier_topic-Always_Free_Resources.htm#compute__idleinstances)
  ...
  * [Cloudflare](https://www.cloudflare.com/)
    ...
    * [Cloudflare Tunnel](https://www.cloudflare.com/products/tunnel/) - 您可以通过[Quick Tunnels](https://developers.cloudflare.com/cloudflare-one/connections/connect-apps/run-tunnel/trycloudflare)在尝试 cloudflare.com 上的随机子域上暴露本地运行的 HTTP 端口，无需帐户。更多功能（TCP 隧道、负载均衡、VPN）在[Zero Trust](https://www.cloudflare.com/products/zero-trust/)免费计划中。
...
## 云管理解决方案
  ...
  * [Cloud 66](https://www.cloud66.com/) - 个人项目免费（包括一个部署服务器，一个静态站点），Cloud 66 为您提供构建、部署和扩展应用程序所需的一切，而无需头疼“服务器问题”。
  * [Pulumi](https://www.pulumi.com/) — 现代基础架构即代码平台，允许您使用熟悉的编程语言和工具构建、部署和管理云基础架构。
  * [terraform.io](https://www.terraform.io/) — Terraform Cloud。免费的远程状态管理和团队协作，最多可管理 500 个资源。
  * [scalr.com](https://scalr.com/) - Scalr 是一个 Terraform 自动化和协作（TACO）产品，用于更好地协作和自动化由 Terraform 管理的基础架构和配置。完全支持 Terraform CLI，集成 OPA，以及分层配置模型。无单点登录税。所有功能都包含在内。免费使用高达 50 次/月的运行次数。
  * [deployment.io](https://deployment.io) - Deployment.io 帮助开发人员在 AWS 上自动化部署。在我们的免费层，开发人员（单个用户）可以无限部署静态站点、Web 服务和环境。我们每月提供 20 次免费的作业执行，其中包括预览和自动部署。

**[⬆️ 返回顶部](#目录)**

## 源代码存储库

  * [Bitbucket](https://bitbucket.org/)——无限制的公共和私人 Git 存储库，最多可供 5 个用户使用，带有用于 CI/CD 的 Pipelines
  * [chiselapp.com](https://chiselapp.com/)——无限制的公共和私人 Fossil 存储库
  * [codebasehq.com](https://www.codebasehq.com/)——一个免费项目，提供 100MB 空间和两个用户
  * [Codeberg](https://codeberg.org/)——无限制的公共和私人 Git 存储库，可免费用于开源项目（无限制的协作者）。由 [Forgejo](https://forgejo.org/) 提供支持。提供静态网站托管[Codeberg Pages](https://codeberg.page/)。提供 CI/CD 托管[Codeberg 的 CI](https://docs.codeberg.org/ci/)。提供翻译托管[Codeberg Translate](https://translate.codeberg.org/)。包括包和容器托管、项目管理和问题跟踪
  * [GitGud](https://gitgud.io)——无限制的私有和公共存储库。永久免费。由 GitLab 和 Sapphire 提供支持。不提供 CI/CD。
  * [GitHub](https://github.com/)——无限制的公共存储库和无限制的私有存储库（无限制的协作者）。包括 CI/CD、开发环境、静态托管、包和容器托管、项目管理和 AI Copilot
  * [gitlab.com](https://about.gitlab.com/)——无限制的公共和私人 Git 存储库，最多可与 5 个协作者一起使用。包括 CI/CD、静态托管、容器注册表、项目管理和问题跟踪
  * [framagit.org](https://framagit.org/)——Framagit 是基于 Gitlab 软件的 Framasoft 的软件 forge，包括 CI、静态页面、项目页面和问题跟踪。
...
## API、数据和机器学习
  ...
  * [APIVerve](https://apiverve.com) - 立即访问 120 多个 API，免费使用，注重质量、一致性和可靠性。免费计划每月涵盖最多 50 个 API 令牌。
  ...
  * [bigml.com](https://bigml.com/) - 托管机器学习算法。开发免费，无限制任务，数据/任务限制为 16MB。
  * [Browse AI](https://www.browse.ai) - 提取和监控网络上的数据。每月免费 50 个信用点。
  * [BrowserCat](https://www.browsercat.com) - 无头浏览器 API，用于自动化、抓取、AI 代理网络访问、图像/ PDF 生成等。免费计划每月 1k 次请求。
  * [Bruzu](https://bruzu.com/) - 自动化图像制作。使用 API、集成或无代码表生成大量图像变体。API 免费使用，但带有水印。
  * [Calendarific](https://calendarific.com) - 企业级公共假期 API 服务，适用于 200 多个国家。免费计划包括每月 1,000 次调用。
  ...
  * [Cloudmersive](https://cloudmersive.com/) - 实用程序 API 平台，可全面访问广泛的 API 库，包括文档转换、病毒扫描等，每月 800 次调用。
  * [Colaboratory](https://colab.research.google.com) - 免费基于网络的 Python 笔记本环境，配备 Nvidia Tesla K80 GPU。
  ...
  * [Country-State-City Microservice API](https://country-state-city.rebuscando.info/) - API 和微服务，提供广泛的信息，包括国家、地区、省份、城市、邮政编码等。免费层每天包括最多 100 个请求。
  ...
  * [Datalore](https://datalore.jetbrains.com) - Jetbrains 的 Python 笔记本。每月包含 10GB 存储空间和 120 小时运行时间。
  ...
  * [DB-IP](https://db-ip.com/api/free) - 免费 IP 地理位置定位 API，每个 IP 每天 1k 次请求。免费的 lite 数据库也在 CC-BY 4.0 许可证下提供。
  * [DB Designer](https://www.dbdesigner.net/) - 基于云的数据库模式设计和建模工具，免费入门计划为每个模型 2 个数据库模型和 10 个表。
  * [DeepAR](https://developer.deepar.ai) - 用于任何平台的增强现实面部滤镜，一个 SDK。免费计划提供最多 10 个每月活跃用户 (MAU)，并跟踪最多 4 个面部
  * [Deepnote](https://deepnote.com) - 新的数据科学笔记本。兼容 Jupyter，具有实时协作和在云中运行的功能。免费层包括无限个人项目、高达 750 小时的标准硬件和最多 3 个编辑器的团队。
  ...
  * [dreamfactory.com](https://dreamfactory.com/)——用于移动、网络和物联网应用的开源 REST API 后端。连接任何 SQL/NoSQL 数据库、文件存储系统或外部服务，它会立即创建一个具有实时文档和用户管理的全面 REST API 平台。
  ...
  * [Geekflare API](https://geekflare.com/api)——Geekflare API 让你可以截取屏幕截图、审核网站、TLS 扫描、DNS 查找、测试 TTFB 等。免费计划提供 3,000 次 API 请求。
  ...
  * [Hook0](https://www.hook0.com/)——Hook0 是一个开源的 Webhooks-as-a-service (WaaS)，使在线产品提供 Webhooks 变得容易。免费提供七天历史记录保留，每月最多可调度 3,000 个事件。
  * [Hoppscotch](https://hoppscotch.io)——一个免费、快速和美丽的 API 请求构建器。
  * [Hybiscus](https://hybiscus.dev/)——使用简单声明性 API 构建 PDF 报告。免费层包括每月最多 100 份单页报告的能力，并能够自定义调色板和字体。
  ...
  * [ipbase.com](https://ipbase.com)——IP 地理定位 API——永久免费计划，每月可使用 150 次。
  * [IP Geolocation](https://ipgeolocation.io/)——IP 地理定位 API——开发人员的永久免费计划，每月有 30k 请求限制（每天 1k）。
  * [IP Geolocation API](https://www.abstractapi.com/ip-geolocation-api)——来自 Abstract 的 IP 地理定位 API——提供广泛的免费计划，允许每月 20,000 次请求。
  * [IP2Location](https://www.ip2location.com)——免费增值 IP 地理定位服务。LITE 数据库可免费下载。将数据库导入服务器并进行本地查询以确定城市、坐标和 ISP 信息。
  * [IP2Location.io](https://www.ip2location.io/)——免费增值、快速可靠的 IP 地理定位 API，可确定城市、坐标、ISP 等地理定位数据。免费计划每月提供 30k 信用额度。订阅付费计划以获得更多高级功能或联系我们以获得个性化计划。
  * [ipapi](https://ipapi.co/)——由 Kloudend, Inc 提供的 IP 地址位置 API——基于 AWS 构建的可靠地理定位 API，受到 Fortune 500 的信任。免费层提供每月 30k 次查找（每天 1k 次），无需注册。
  * [ipapi.is](https://ipapi.is/)——为开发人员提供的可靠 IP 地址 API，具有最好的托管检测功能。免费计划提供 1000 次无注册查找。
  * [IPinfo](https://ipinfo.io/)——快速、准确且免费（每月最多 50k）的 IP 地址数据 API。提供有关地理定位、公司、运营商、IP 范围、域、滥用联系人等的 API。所有付费 API 都可以免费试用。
  * [BigDataCloud](https://www.bigdatacloud.com/)——为现代网络提供快速、准确且免费（无限或每月 10K-50K）的 API，如 IP 地理定位、反向地理编码、网络洞察、电子邮件和电话验证、客户端信息等。
  * [IPTrace](https://iptrace.io)——一个简单的 API，为您的企业提供可靠且有用的 IP 地理定位数据。
  * [JSON2Video](https://json2video.com)——一个视频编辑 API，用于自动执行视频营销和社交媒体视频，无论是通过编程还是无代码。
  ...
  * [JSONing](https://jsoning.com/api/)——从 JSON 对象创建假的 REST API，并自定义 HTTP 状态代码、标头和响应正文。
  ...
  * [市场数据 API](https://www.marketdata.app) - 提供股票、期权、共同基金等的实时和历史金融数据。免费永久 API 层允许每天无限制地进行 100 次 API 请求。
  * [Meteosource 天气 API](https://www.meteosource.com/)——全球天气 API，用于当前和预测的天气数据。预测是基于机器学习对多个天气模型的组合，以实现更好的准确性。免费计划每天提供 400 次调用。
  ...
  * [Mockfly](https://www.mockfly.dev/)——Mockfly 是一个值得信赖的 API 模拟和功能标志管理开发工具。通过直观的界面快速生成和控制模拟 API。免费层每天提供 500 个请求。
  ...
  * [pdfEndpoint.com](https://pdfendpoint.com)——使用简单的 API 将 HTML 或 URL 轻松转换为 PDF。每月免费进行 100 次转换。
  * [PDF-API.io](https://pdf-api.io)——PDF 自动化 API，具有可视化模板编辑器或 HTML 到 PDF，动态数据集成和 PDF 渲染功能的 API。免费计划包括一个模板，每月 100 个 PDF。
  * [Pixela](https://pixe.la/)——免费的日流数据库服务。所有操作均通过 API 执行。也可以使用热图和折线图进行可视化。
  * [Postbacks](https://postbacks.io/)——请求稍后的 HTTP 回调。注册时提供 8000 个免费请求。
  * [Postman](https://postman.com)——用于设计和测试 API 的协作平台，可简化工作流程并加快速度。免费使用 Postman App 永久。Postman 云功能也永久免费，但有一定限制。
  ...
  * [PromptLoop](https://www.promptloop.com/)——使用简单的电子表格公式，使用 AI 和大型语言模型（如 GPT-3）在 Google Sheets 中转换、理解和分析文本。每月免费 2000 个信用额度。
  * [Crawlbase](https://crawlbase.com/)——无需代理、基础设施或浏览器即可抓取和抓取网站。我们为您解决验证码，并防止您被阻止。前 1000 个调用免费。
  ...
  * [QuickMocker](https://quickmocker.com/)——管理自己子域下的在线虚假 API 端点，将请求转发到本地主机 URL 进行 Webhooks 开发和测试，使用 RegExp 和多个 HTTP 方法进行 URL 路径，对端点进行优先级排序，每个端点超过 100 个短代码（动态或虚假响应值）进行响应模板化，从 OpenAPI（Swagger）规范以 JSON 格式导入，代理请求，根据 IP 地址和授权标头限制端点。免费帐户提供一个随机子域、十个端点、五个 RegExp URL 路径、每个端点 50 个短代码、每天 100 个请求和请求日志中的 50 个历史记录。
  * [Rapidapi](https://rapidapi.com/)——世界上最大的 API 中心，数百万开发人员找到并连接到数千个 API，使用有趣的挑战（有解决方案！）和交互式示例进行 API 开发。
  * [RequestBin.com](https://requestbin.com)——创建一个免费的端点，您可以向该端点发送 HTTP 请求。发送到该端点的任何 HTTP 请求都将被记录下来，并附带相关的有效负载和标头，以便您可以观察网络钩子和其他服务的建议。
  ...
  * [Scraper's Proxy](https://scrapersproxy.com) — 用于抓取的简单 HTTP 代理 API。无需担心限制、阻止或验证码即可匿名抓取。每月前 100 次成功抓取免费，包括 JavaScript 渲染（如果您联系支持人员，还可以获得更多）。
  * [ScrapingAnt](https://scrapingant.com/) — 无头 Chrome 抓取 API 和免费检查代理服务。JavaScript 渲染，优质旋转代理，验证码回避。提供免费计划。
  * [ScraperBox](https://scraperbox.com/) — 使用真实 Chrome 浏览器和代理轮换实现的不可检测网络抓取 API。使用简单的 API 调用抓取任何网页。免费计划每月有 1000 次请求。
  ...
  * [Select Star](https://www.selectstar.com/) - 是一个智能数据发现平台，可自动分析和记录您的数据。免费的轻量级 tier，包含 1 个数据源、最多 100 个表和 10 个用户。
  * [Sheetson](https://sheetson.com) - 立即将任何 Google Sheets 转换为 RESTful API。提供免费计划。
  * [Shipyard](https://www.shipyardapp.com) — 用于云的低代码数据编排平台。使用混合低代码模板和您的代码（Python、Node.js、Bash、SQL）构建。我们的免费开发者计划为每个用户每月提供 10 小时的运行时间——足以自动化多个工作流程。
  * [shrtcode API](https://shrtco.de/docs) - 无需授权的免费 URL 缩短 API，无请求限制。
  ...
  * [TemplateTo](https://templateto.com) - 使用我们的拖放编辑器和简单 API，从可重用模板自动生成 PDF/TXT 文档。免费计划每月提供 450 份 PDF 和三个模板。
  * [TinyMCE](https://www.tiny.cloud) - 富文本编辑 API。核心功能免费，无使用限制。
  * [Treblle](https://www.treblle.com) - Treblle 帮助团队构建、交付和管理 API。具有高级 API 日志聚合、可观测性、文档和调试功能。所有功能都是免费的，但免费层每月对请求的限制高达 250k。
  ...
  * [ZenRows](https://www.zenrows.com/) — Web Scraping API 和代理服务器，可绕过任何反机器人解决方案，同时提供 JavaScript 渲染、旋转代理和地理定位。免费层为 1000 次 API 调用。
  * [Zenscrape](https://zenscrape.com/web-scraping-api) — 具有无头浏览器、住宅 IP 和直接定价的 Web 抓取 API。每月一千次免费 API 调用，学生和非营利组织有额外积分。
  * [ip-api](https://ip-api.com) — IP 地理位置 API，非商业用途免费，无需 API 密钥，免费计划每个 IP 地址每分钟限制为 45 个请求。
  * [WebScraping.AI](https://webscraping.ai) - 具有内置解析、Chrome 渲染和代理的简单 Web 抓取 API。每月两千次免费 API 调用。
  * [Zipcodebase](https://zipcodebase.com) - 免费邮编 API，可访问全球邮政编码数据。每月十万次免费请求。
  * [huggingface.co](https://huggingface.co) - 用于 Pytorch、TensorFlow 和 JAX 的 NLP 模型的构建、训练和部署。免费使用量高达每月 30k 输入字符。
  * [vatcheckapi.com](https://vatcheckapi.com) - 简单免费的 VAT 号码验证 API。每月五百次免费请求。
  * [numlookupapi.com](https://numlookupapi.com) - 免费电话号码验证 API - 每月 100 万次免费请求。
  ...
  * [Zipcodestack](https://zipcodestack.com) - 免费邮编 API 和邮政编码验证。每月十万次免费请求。
  * [Zuplo](https://zuplo.com/) - 在几分钟内为任何 API 添加 API 密钥身份验证、速率限制和开发人员文档。免费计划提供最多 10 个项目、无限的生产边缘环境、250 个 API 密钥、100K 每月请求和 1GB 出口。
  * [OpenWeb Ninja](https://www.openwebninja.com/) - 极其全面的实时 SERP 和公共数据 API：谷歌搜索、购物、工作、图片、镜头、新闻、谷歌地图企业/地点、评论、照片、网站电子邮件和社交联系人抓取器、亚马逊、Yelp 等。所有 API 都包含免费 tier，每月有 100 到 200 次免费请求。
...
## 工件存储库
  ...
  * [Artifactory](https://jfrog.com/start-free/) - 一个支持多种软件包格式的工件存储库，如 Maven、Docker、Cargo、Helm、PyPI、CocoaPods 和 GitLFS。其中包括包扫描工具 XRay 和 CI/CD 工具 Pipelines（以前称为 Shippable），每月有 2,000 分钟的免费 CI/CD 分钟数。
...
## 团队和协作工具
  ...
  * [Calendly](https://calendly.com) — Calendly 是连接和安排会议的工具。免费计划为每个用户提供 1 个日历连接，并且无限制会议。还提供桌面和移动应用程序。
  ...
  * [Duckly](https://duckly.com/) — 与团队实时交谈和协作。支持配对编程、IDE、终端共享、语音、视频和屏幕共享。适用于小型团队。
  ...
  * [Gather](https://www.gather.town/) - 在线见面的更好方式。围绕完全可定制的空间，Gather 使与您的社区共度时光变得与现实生活一样容易。免费最多 10 个并发用户。
  ...
  * [GitDailies](https://gitdailies.com) - 您团队在 GitHub 上的提交和拉取请求活动的每日报告。包括推送可视化器、同伴认可系统和自定义警报构建器。免费层有无限用户、三个存储库和 3 个警报配置。
  * [gitter.im](https://gitter.im/) — GitHub 的聊天工具。无限公共和私人房间，团队最多 25 人免费
  ...
  * [Keybase](https://keybase.io/) — Keybase 是 Slack 的开源替代方案；它从家庭到社区再到公司，都能确保每个人的聊天和文件安全。
  * [Google Meet](https://meet.google.com/) — 使用 Google Meet 满足您企业的在线视频会议需求。Meet 提供安全、易于加入的在线会议。
  * [/meet for Slack](https://meetslack.com) - 使用 /meet 在任何频道、组或 DM 中直接从 Slack 启动 Google 会议。免费，无任何限制。
  * [Livecycle](https://www.livecycle.io/) — Livecycle 是一个包容的协作平台，使跨职能产品团队和开源项目的工作流程无摩擦。
  ...
  * [Microsoft Teams](https://products.office.com/microsoft-teams/free) — Microsoft Teams 是一个基于聊天的数字中心，将对话、内容和应用程序集中在一个地方，来自单一体验。免费最多 500k 用户。
  * [Miro](https://miro.com/) - 可扩展、安全、跨设备且适用于分布式团队的企业级协作白板。有免费增值计划。
  * [nootiz](https://www.nootiz.com/) - 收集和管理任何网站上视觉反馈的首选工具
  * [Notion](https://www.notion.so/) - 具有 markdown 支持的笔记记录和协作应用程序。该公司将该应用程序描述为笔记记录、项目管理和任务管理的一体化工作空间。除了跨平台应用程序，它还可以通过大多数网络浏览器访问。
  * [Nuclino](https://www.nuclino.com) - 适用于您团队所有知识、文档和笔记的轻量级协作 wiki。免费计划包含所有基本功能，最多 50 个项目和 5GB 存储空间。
  * [OnlineInterview.io](https://onlineinterview.io/) - 免费的代码面试平台，带有嵌入式视频聊天、绘图板和在线代码编辑器，您可以在浏览器上编译和运行代码。您可以一键创建远程面试室。
  * [Quidlo Timesheets](https://www.quidlo.com/timesheets) - 适用于团队的简单时间表和时间跟踪应用程序。免费计划具有时间跟踪和生成报告功能，最多可用于 10 个用户。
  * [PageShare.dev](https://www.pageshare.dev) - 为 GitHub Pull 请求添加视觉评论功能，无需部署网站。免费最多每月 10 页和总存储量 100MB。
  ...
  * [element.io](https://element.io/) — 基于 Matrix 的去中心化和开源通信工具。组聊天、直接消息、加密文件传输、语音和视频聊天以及与其他服务的轻松集成。

  * [seafile.com](https://www.seafile.com/)——私人或云存储、文件共享、同步、讨论。云版本只有 1GB
  * [Sema](https://www.semasoftware.com/)——免费的开发者投资组合工具，能够将多个存储库中的贡献整合并快照到一个单一报告中。
  * [Slab](https://slab.com/)——一个现代的团队知识管理服务。最多支持 10 个用户免费使用。
  * [slack.com](https://slack.com/)——无限制用户免费使用，但有一些功能限制。
  * [Spectrum](https://spectrum.chat/)——免费创建公共或私人社区。
  * [StatusPile](https://www.statuspile.com/)——一个状态页面的状态页面。你能跟踪你的上游提供商的状态页面吗？
  * [Stickies](https://stickies.app/)——用于头脑风暴、内容整理和笔记的可视化协作应用。最多支持 3 个墙、无限制用户和 1GB 存储空间免费使用。
  * [talky.io](https://talky.io/)——免费的小组视频聊天。匿名的。点对点。无需插件、注册或支付。
  * [Teamhood](https://teamhood.com/)——免费的项目、任务和问题跟踪软件。支持带有泳道的看板和完整的 Scrum 实现。集成了时间跟踪功能。免费提供给最多 5 个用户和 3 个项目组合。
  * [Teamplify](https://teamplify.com)——通过团队分析和智能每日站立会改进团队开发流程。包括远程优先团队的全功能休假管理。免费提供给最多 5 个用户的小团体。
  * [Tefter](https://tefter.io)——具有强大 Slack 集成的书签应用。免费提供给开源团队。
  * [TeleType](https://teletype.oorja.io/)——共享终端、语音、代码、电子白板等。对于开发人员来说，无需登录即可进行端到端加密协作。
  ...
  * [BookmarkOS.com](https://bookmarkos.com/)——免费的一体化书签管理器、选项卡管理器和任务管理器，可在可自定义的在线桌面上使用，支持文件夹协作。
  ...
  * [vadoo.tv](https://vadoo.tv/)——简单的视频托管和营销。一键上传视频。记录、管理、分享等。免费层提供最多 10 个视频、1GB 存储空间和 10GB 带宽/每月
  * [userforge.com](https://userforge.com/)——相互关联的在线个人资料、用户故事和上下文映射。有助于保持设计和开发的同步，最多免费提供 3 个人物和两个协作者。
  * [wistia.com](https://wistia.com/)——具有观众分析、高清视频交付和营销工具的视频托管，可帮助您了解访问者，25 个视频，和 Wistia 品牌播放器
  * [wormhol.org](https://www.wormhol.org/)——直截了当的文件共享服务。与多达多个同行共享无限大文件，每个文件高达 5GB。
  ...
  * [Zulip](https://zulip.com/)——具有独特电子邮件式线程模型的实时聊天。免费计划包括 10,000 条消息搜索历史记录和高达 5GB 的文件存储。它还提供可自托管的开源版本。
  * [robocorp.com](https://robocorp.com)——用于推动自动化运维的开源堆栈。免费试用云功能并实现简单自动化。机器人工作 240 分钟/月，10 个助手运行，存储 100MB。
  * [Fleep.io](https://fleep.io/)——Fleep 是 Slack 的替代方案。它为小型团队提供免费计划，包括完整的消息历史记录、无限 1:1 对话、1 个组对话和 1GB 文件存储。
  * [Chanty.com](https://chanty.com/)——Chanty 是 Slack 的另一种替代方案。它为小型团队（最多 10 人）提供免费的永久计划，包括无限的公共和私人对话、可搜索的历史记录、无限的 1:1 音频通话、无限的语音消息、10 个集成和每个团队 20GB 的存储空间。
  ...
  * [Webvizio](https://webvizio.com)——用于直接在实时网站和网络应用程序、图像、PDF 和设计文件上进行网站反馈、网站审查和错误报告的工具。
  * [Pullflow](https://pullflow.com)——在 GitHub、Slack 和 VS Code 上提供 AI 增强的代码审查协作平台。
  * [Webex](https://www.webex.com/)——提供免费计划的视频会议，每个会议提供 40 分钟，最多 100 名参会者。
  * [RingCentral](https://www.ringcentral.com/)——提供免费计划的视频会议，每个会议提供 50 分钟，最多 100 名参与者。
  ...
  * [Revolt.chat](https://revolt.chat/)——一个开源的[Discord](https://discord.com/)替代方案，尊重您的隐私。它还免费提供了 Discord 的大多数专有功能。Revolt 是一个安全、快速的一体化应用程序，同时完全免费。所有功能都是免费的。它们还支持（官方和非官方）插件，与大多数主流聊天应用程序不同。
  * [Tencent RTC](https://trtc.io/)——腾讯实时通信（TRTC）提供了用于组音频/视频通话的解决方案。第一年每月免费 10,000 分钟。
  * [Pastefy](https://pastefy.app/)——一个美观简洁的 Pastebin，可选客户端加密、多标签粘贴、API、突出的编辑器等。
...
## 内容管理系统（CMS）
  ...
  * [DatoCMS](https://www.datocms.com/)——为小型项目提供免费层级。DatoCMS 是一个基于 GraphQL 的 CMS。在较低层级，您每月有 100 万次调用。
  * [Directus](https://directus.io)——无头 CMS。一个完全免费和开源的平台，用于管理本地或云端的资产和数据库内容。没有限制或付费墙。
  * [FrontAid](https://frontaid.io/)——无头 CMS，直接将 JSON 内容存储在您的 Git 存储库中。无限制。
  * [kontent.ai](https://www.kontent.ai)——内容即服务平台，为您提供无头 CMS 的所有好处，同时赋能营销人员。开发者计划为每个用户提供两个用户、无限项目、两个环境、500 个内容项目、两种语言的交付和管理 API 以及自定义元素支持。您可以使用更详细的计划来满足您的需求。
  * [Prismic](https://www.prismic.io/)——无头 CMS。具有完全托管和可扩展 API 的内容管理界面。社区计划为一个用户提供无限的 API 调用、文档、自定义类型、资产和地区。您下一个项目所需的一切。对于开源内容/开源项目，有更大的免费计划。
  * [Sanity.io](https://www.sanity.io/)——具有开源编辑环境和实时托管数据存储的结构化内容平台。无限项目。无限管理员用户、三个非管理员用户、两个数据集、500K API CDN 请求、10GB 带宽和每个项目免费包含 5GB 资产。
  * [sensenet](https://sensenet.com)——API 优先的无头 CMS，为各种规模的企业提供企业级解决方案。开发者计划提供三个用户、500 个内容项目、三个内置角色、25+5 种内容类型、完全可访问的 REST API、文档预览生成和 Office Online 编辑。
  * [TinaCMS](https://tina.io/)——取代 Forestry.io。开源 Git 支持的无头 CMS，支持 Markdown、MDX 和 JSON。基本套餐免费，可提供两个用户。
  * [GatsbyjsCMS](https://www.gatsbyjs.com/)——Gatsby 是快速灵活的框架，使使用任何 CMS、API 或数据库构建网站再次变得有趣。构建和部署无服务器网站，以推动更多流量、更好地转化和赚取更多收入！
  * [Hygraph](https://hygraph.com/)——为小型项目提供免费层级。GraphQL 优先 API。摆脱遗留解决方案，采用 GraphQL 原生无头 CMS——并首先提供多渠道内容 API。
  ...
  * [Storyblok](https://www.storyblok.com)——面向开发人员和营销人员的无头 CMS，适用于所有现代框架。社区（免费）层级提供管理 API、可视化编辑器、十个源、自定义字段类型、国际化（无限语言/地区）、资产管理器（最多 2500 个资产）、图像优化服务、搜索查询、Webhook+250GB 流量/月包含在内。
  * [WPJack](https://wpjack.com)——在不到 5 分钟的时间内在任何云平台上设置 WordPress！免费层级包括 1 个服务器、2 个网站、免费 SSL 证书和无限 cron 作业。没有时间限制或过期——您的网站，您做主。
...
## 代码生成
  ...
  * [Cody AI](https://sourcegraph.com/cody)——Cody 是一个编码 AI 助手，它使用 AI 和对代码库的深入理解来帮助您更快地编写和理解代码。Cody 为开发人员提供了对 LLM 的选择（包括本地推理），支持各种 IDE，支持所有流行的编程语言，并提供免费计划。免费计划每月为开发人员提供 20 条聊天消息（使用 Claude 3 Sonnet 作为 LLM）和 500 次自动完成（使用 Starcoder 16b）。
  ...
  * [Fern](https://buildwithfern.com)——编写 API 定义，并使用它们在 TypeScript、Python、Java、Go 等流行语言中生成 SDK/client 库。完全支持 OpenAPI。免费层最多可生成 20 个端点的代码。
  ...
  * [v0.dev](https://v0.dev/)——v0 使用 AI 模型根据简单的文本提示生成代码。它根据 shadcn/ui 和 Tailwind CSS 生成可复制粘贴的友好 React 代码，人们可以在项目中使用。每次生成至少需要 30 个学分。您一开始有 1200 个学分，并且每月会获得 200 个免费学分。
...
## 代码质量
  ...
  * [browserling.com](https://www.browserling.com/) - 实时交互式跨浏览器测试，免费仅 3 分钟会话，在 Vista 下分辨率为 1024 x 768 的 MS IE 9
  ...
  * [codeclimate.com](https://codeclimate.com/) - 自动化代码审查，对于开源和组织拥有的私有存储库（最多 4 个协作者）免费。也对学生和机构免费。
  ...
  * [CodSpeed](https://codspeed.io) - 在您的 CI 管道中自动跟踪性能。由于精确和一致的指标，在部署前捕捉性能回归。对于开源项目免费永久。
  * [coveralls.io](https://coveralls.io/) - 显示测试覆盖率报告，对于开源免费
  * [dareboost](https://dareboost.com) - 每月免费提供 5 份针对网络性能、可访问性和安全性的分析报告
  * [deepcode.ai](https://www.deepcode.ai) - DeepCode 基于人工智能发现错误、安全漏洞、性能和 API 问题。DeepCode 的分析速度允许我们在您的 IDE 中保存按钮时实时分析您的代码并提供结果。支持的语言是 Java、C/C++、JavaScript、Python 和 TypeScript。与 GitHub、BitBucket 和 GitLab 集成。对于开源和私有存储库以及最多 30 个开发人员免费。
  * [deepscan.io](https://deepscan.io/) - 用于自动查找 JavaScript 代码中运行时错误的高级静态分析，对于开源免费
  * [DeepSource](https://deepsource.io/) - DeepSource 持续分析源代码更改，查找并修复分类为安全、性能、反模式、错误风险、文档和样式的问题。与 GitHub、GitLab 和 Bitbucket 原生集成。
  ...
  * [Moderne.io](https://app.moderne.io) - 自动源代码重构。Moderne 提供框架迁移、代码分析和修复以及无与伦比的大规模代码转换，因此开发人员可以将时间花在构建新事物上，而不必维护旧事物。对于开源免费。
  * [reviewable.io](https://reviewable.io/) - GitHub 存储库的代码审查，对于公共或个人存储库免费。
  * [parsers.dev](https://parsers.dev/) - 作为服务的抽象语法树解析器和中间表示编译器
  * [scan.coverity.com](https://scan.coverity.com/) - Java、C/C++、C#和 JavaScript 的静态代码分析，对于开源免费
  ...
  * [sonarcloud.io](https://sonarcloud.io) - Java、JavaScript、C/C++、C#、VB.NET、PHP、Objective-C、Swift、Python、Groovy 等语言的自动化源代码分析，对于开源免费
...
## 代码搜索和浏览
  ...
  * [libraries.io](https://libraries.io/)——搜索 32 种不同包管理器的依赖更新通知，对开源免费
  * [Namae](https://namae.dev/)——在 GitHub、Gitlab、Heroku、Netlify 等各种网站上搜索项目名称的可用性。
  * [searchcode.com](https://searchcode.com/)——全面的基于文本的代码搜索，对开源免费
  * [tickgit.com](https://www.tickgit.com/)——将`TODO`注释（和其他标记）表面化，以确定值得改进的代码区域。
...
## 持续集成和持续部署（CI和CD）
  ...
  * [AccessLint](https://github.com/marketplace/accesslint)——AccessLint 将自动化的网络可访问性测试带入您的开发工作流程。对于开源和教育目的是免费的。
  * [appcircle.io](https://appcircle.io)——一个企业级移动 DevOps 平台，可自动构建、测试和发布移动应用程序，以实现更快、更高效的发布周期。免费，最长 30 分钟的构建时间，每月 20 次构建和 1 次并发构建。
  * [appveyor.com](https://www.appveyor.com/)——适用于 Windows 的 CD 服务，开源免费
  * [Argonaut](https://argonaut.dev/)——在您的云平台上几分钟内部署应用程序和基础架构。支持在 Kubernetes 和 Lambda 环境中自定义和第三方应用程序部署。免费层允许无限制的应用程序和部署，最多 5 个域和 2 个用户。
  * [bitrise.io](https://www.bitrise.io/)——适用于移动应用程序的 CI/CD，无论是本机还是混合应用程序。每月 200 次免费构建，10 分钟构建时间和 2 名团队成员。OSS 项目获得 45 分钟构建时间，+1 并发性和无限团队规模。
  * [buddy.works](https://buddy.works/)——具有 5 个免费项目和 1 个并发运行（每月 120 次执行）的 CI/CD
  * [Buildkite](https://buildkite.com)CI 管道免费供 3 个用户和 5k 作业分钟/月。测试分析免费开发人员层包括每月 100 万次测试执行，对于开源项目还有更多免费功能。
  * [bytebase.com](https://www.bytebase.com/)——数据库 CI/CD 和 DevOps。免费，最多 20 个用户和 10 个数据库实例
  * [CircleCI](https://circleci.com/)——全面的免费计划，包含在托管 CI/CD 服务中针对 GitHub、GitLab 和 BitBucket 存储库的所有功能。多个资源类、Docker、Windows、Mac OS、ARM 执行器、本地运行器、测试拆分、Docker 层缓存和其他高级 CI/CD 功能。免费，最多 6000 分钟/月执行时间，无限制的协作者，私有项目中的 30 个并行作业，以及开源项目的 80,000 个免费构建分钟。
  ...
  * [drone](https://cloud.drone.io/)——Drone Cloud 使开发人员能够在多个体系结构（包括 x86 和 Arm（32 位和 64 位））上运行持续交付管道——全部在一个地方
  ...
  * [Mergify](https://mergify.io)——用于 GitHub 的工作流程自动化和合并队列——适用于公共 GitHub 存储库
  * [Make](https://www.make.com/en)——工作流程自动化工具，允许您使用 UI 连接应用程序并自动化工作流程。它支持许多应用程序和最流行的 API。适用于公共 GitHub 存储库，以及免费层，包括 100 Mb、1000 次操作和 15 分钟的最小间隔。
  * [Spacelift](https://spacelift.io/)——基础设施即代码的管理平台。免费计划功能：IaC 协作、Terraform 模块注册表、ChatOps 集成、与 Open Policy Agent 的持续资源合规性、与 SAML 2.0 的单点登录以及对公共工作者池的访问：最多 200 分钟/月
  ...
  * [Nx Cloud](https://nx.dev/ci)——Nx Cloud 通过远程缓存、任务在机器上的分布甚至 e2e 测试运行的自动拆分等功能，加快您的 monorepos 在 CI 上的速度。它提供了一个免费计划，最多可容纳 30 名贡献者，并包含慷慨的 150k 信用额度。
  * [blacksmith](https://www.blacksmith.sh/)——用于 GitHub Actions 的托管性能运行器，每月提供 3000 分钟的免费时间，无需信用卡。
  * [Terramate](https://terramate.io/)——Terramate 是一个用于基础设施即代码（IaC）工具（如 Terraform、OpenTofu 和 Terragrunt）的编排和管理平台。免费，最多 2 个用户，包括所有功能。

**[⬆️ 返回顶部](#目录)**

## 测试

  * [Applitools.com](https://applitools.com/)——智能视觉验证工具，适用于网络、原生移动和桌面应用程序。与几乎所有自动化解决方案（如 Selenium 和 Karma）和远程运行器（Sauce Labs、Browser Stack）集成。开源免费，为单个用户提供每周有限检查点的免费层。
  ...
  * [BugBug](https://bugbug.io/)——适用于 Web 应用程序的轻量级测试自动化工具。易于学习，无需编码。您可以在自己的计算机上免费运行无限数量的测试。您还可以获得云监控和 CI/CD 集成，额外收取月费。
  ...
  * [checkbot.io](https://www.checkbot.io/)——浏览器扩展，用于测试您的网站是否遵循 50 多个 SEO、速度和安全最佳实践。较小的网站有免费层。
  ...
  * [Gremlin](https://www.gremlin.com/gremlin-free-software)——Gremlin 的混沌工程工具允许您安全地将故障注入系统，以在它们导致面向客户的问题之前找到弱点。Gremlin Free 提供对多达 5 个主机或容器的关闭和 CPU 攻击的访问权限。
  * [gridlastic.com](https://www.gridlastic.com/)——具有免费计划的 Selenium 网格测试，最多可同时使用 4 个 Selenium 节点/10 个网格启动/4000 个测试分钟/月
  * [katalon.com](https://katalon.com)——提供测试平台，可帮助不同测试成熟度级别的各种规模的团队，包括 Katalon Studio、TestOps（+免费视觉测试）、TestCloud 和 Katalon Recorder。
  ...
  * [preflight.com](https://preflight.com)——无代码自动化网络测试。在您的浏览器上记录对 UI 更改有弹性的测试，并在 Windows 计算机上运行它们。可以与您的 CI/CD 集成吗？免费计划包括 50 个每月测试运行，带有视频、HTML 会话等。
  * [Argos](https://argos-ci.com)——面向开发人员的开源视觉测试。无限制项目，每月 5000 张屏幕截图。开源项目免费。
  * [percy.io](https://percy.io)——为任何网络应用程序、静态站点、样式指南或组件库添加视觉测试。无限团队成员，演示应用程序，无限项目，每月 5000 个快照。
  * [lost-pixel.com](https://lost-pixel.com)——Storybook、Ladle、Histoire 故事和 Web Apps 的整体视觉回归测试。无限团队成员，完全免费开源，每月 7000 个快照。
  * [Repeato](https://repeato.app/)——基于计算机视觉和人工智能的无代码移动应用程序测试自动化工具。适用于原生应用程序、Flutter、React Native、Web、Ionic 等众多应用程序框架。免费计划限制为每个 iOS 10 个测试和每个 Android 10 个测试，但包括付费计划的大多数功能，包括无限测试运行。
  * [Requestly](https://requestly.com/)——开源 Chrome 扩展，用于拦截、重定向和模拟 HTTP 请求。具有[调试器](https://requestly.com/products/web-debugger/)、[模拟服务器](https://requestly.com/products/mock-server/)、[API 客户端](https://requestly.com/products/api-client/)和[会话记录](https://requestly.com/products/session-book/)功能。重定向 URL、修改 HTTP 标头、模拟 API、注入自定义 JS、修改 GraphQL 请求、生成模拟 API 终结点、记录带有网络和控制台日志的会话。免费层可创建最多 10 个规则。开源免费。
  * [seotest.me](https://seotest.me/)——免费的页面内 SEO 网站测试器。每天 10 次免费网站抓取。有关如何提高任何网站页面内 SEO 结果的有用 SEO 学习资源和建议，无论技术如何。
  * [snippets.uilicious.com](https://snippets.uilicious.com)——它就像 CodePen 但用于跨浏览器测试。UI-licious 允许您像用户故事一样编写测试，并提供一个免费平台——UI-licious Snippets——允许您在 Chrome 上无限制地进行测试，无需注册，每次测试运行最长可达 3 分钟。发现错误了吗？您可以复制测试的唯一 URL 并将其提供给您的开发人员，以确切地向他们展示如何重现该错误。
  ...
  * [qase.io](https://qase.io)——用于 Dev 和 QA 团队的测试管理系统。管理测试用例、组成测试运行、执行测试、跟踪缺陷并衡量影响。免费层包括所有核心功能，可用于附件的 500MB 和最多 3 个用户。

  * [UseWebhook.com](https://usewebhook.com) - 在浏览器中捕获和检查 Webhooks。转发到本地主机，或从历史记录中重放。免费使用。
  * [webhook.site](https://webhook.site) - 使用自定义 URL 验证 Webhooks、出站 HTTP 请求或电子邮件。临时 URL 和电子邮件地址始终是免费的。
...
## 安全和公钥基础设施（PKI）
  ...
  * [aikido.dev](https://www.aikido.dev) - 一体化的应用程序安全平台，涵盖 SCA、SAST、CSPM、DAST、Secrets、IaC、Malware、容器扫描、EOL 等。免费计划包括两个用户，10 个存储库、1 个云、2 个容器和 1 个域的扫描。
  * [alienvault.com](https://www.alienvault.com/open-threat-exchange/reputation-monitor) - 揭示网络中被入侵的系统
  * [Altcha.org](https://altcha.org/anti-spam) - 一个基于自然语言处理和机器学习的网站和 API 垃圾邮件过滤器。免费计划包括每个域名每天 200 次请求。
  * [atomist.com](https://atomist.com/) - 一种更快捷、更方便的自动化各种开发任务的方式。现在处于测试阶段。
  ...
  * [Public Cloud Threat Intelligence](https://cloudintel.himanshuanand.com/) - 针对公共云基础设施的高置信度指标 (IOC)，一部分可在 github（https://github.com/unknownhad/AWSAttacks）上获得。完整列表可通过 API 获取
  * [CodeNotary.io](https://www.codenotary.io/) - 具有不可磨灭证明的开源平台，用于对代码、文件、目录或容器进行公证
  * [crypteron.com](https://www.crypteron.com/) - 面向开发者友好的云优先安全平台，防止.NET 和 Java 应用程序中的数据泄露
  * [CyberChef](https://gchq.github.io/CyberChef/) - 一个简单直观的网络应用程序，用于分析和解码/编码数据，无需处理复杂的工具或编程语言。就像一把瑞士军刀的加密和加密。所有功能均可免费使用，无限制。如果您希望自行托管，可以使用开源版本。
  * [DAS](https://signup.styra.com/) - Styra DAS 免费，完整的生命周期策略管理，用于创建、部署和管理 Open Policy Agent (OPA) 授权
  ...
  * [Dotenv](https://dotenv.org/) - 快速安全地同步您的.env 文件。停止通过不安全的渠道（如 Slack 和电子邮件）共享您的.env 文件，再也不会丢失重要的.env 文件。最多可供 3 名队友免费使用。
  * [GitGuardian](https://www.gitguardian.com) - 使用自动化秘密检测和修复功能，防止秘密进入您的源代码。为您的 git 存储库扫描 350 多种类型的秘密和敏感文件-个人和 25 名开发人员或更少的团队免费。
  ...
  * [Infisical](https://infisical.com/) - 开源平台，可让您在整个团队和基础架构中管理开发人员的秘密：从本地开发到登台/生产第三方服务。免费提供给最多 5 名开发人员。
  ...
  * [letsencrypt.org](https://letsencrypt.org/) - 受所有主要浏览器信任的免费 SSL 证书颁发机构
  * [meterian.io](https://www.meterian.io/) - 监控 Java、Javascript、.NET、Scala、Ruby 和 NodeJS 项目中的安全漏洞。免费提供一个私有项目，开源项目不限数量。
  * [Mozilla Observatory](https://observatory.mozilla.org/) - 在您的网站上查找并修复安全漏洞。
  ...
  * [pyup.io](https://pyup.io) - 监控 Python 依赖项的安全漏洞并自动更新它们。免费提供一个私有项目，开源项目不限数量。
  ...
  * [seclookup.com](https://www.seclookup.com/) - Seclookup API 可以丰富 SIEM 中的域名威胁指标，提供有关域名的全面信息，并提高威胁检测和响应能力。在此处获取 50K 次查找免费[here](https://account.seclookup.com/)。
  * [snyk.io](https://snyk.io) - 可以找到并修复您的开源依赖项中的已知安全漏洞。对开源项目的测试和修复是无限的。对于您的私有项目，每月限制为 200 次测试。
  * [ssllabs.com](https://www.ssllabs.com/ssltest/) - 对任何 SSL Web 服务器配置的深入分析
  * [SOOS](https://soos.io) - 免费的开源项目 SCA 扫描，无限次。在发布前检测和修复安全威胁。使用简单有效的解决方案保护您的项目。
  * [StackHawk](https://www.stackhawk.com/) 在整个管道中自动扫描应用程序，以在生产中发现和修复安全漏洞。单个应用程序的无限制扫描和环境。
  ...
  * [Ubiq Security](https://ubiqsecurity.com/) - 使用三行代码加密和解密数据，并自动进行密钥管理。免费提供一个应用程序和每月最多 1,000,000 次加密。
  * [Virgil Security](https://virgilsecurity.com/) - 在您的数字解决方案中实现端到端加密、数据库保护、物联网安全等的工具和服务。免费提供给最多 250 个用户的应用程序。
  * [Vulert](https://vulert.com) - Vulert 持续监控您的开源依赖项以获取新漏洞，并推荐修复方法，无需安装或访问您的代码库。开源项目免费。

  * [HasMySecretLeaked](https://gitguardian.com/hasmysecretleaked) - 在公共 GitHub 存储库、gist、问题和注释中搜索 2000 万个公开泄露的秘密，免费
...
## 身份验证、授权和用户管理
  ...
  * [asgardeo.io](https://wso2.com/asgardeo) - 无缝集成单点登录 (SSO)、多因素身份验证 (MFA)、无密码身份验证等。包括适用于前端和后端应用程序的 SDK。免费使用，最高可达 1000 MAUs 和五个身份提供商。
  * [Auth0](https://auth0.com/) — 托管式单点登录。最多 7000 个活跃用户和两个社交身份提供商。
  * [Authgear](https://www.authgear.com) - 在几分钟内为您的应用带来无密码、OTP、2FA、SSO 等功能。全前端包括在内。免费使用，最高可达 5000 MAUs。
  * [Authress](https://authress.io/) — 身份验证登录和访问控制，适用于任何项目的无限身份提供商。Facebook、Google、Twitter 等。前 1000 次 API 调用免费。
  * [Authy](https://authy.com) - 在多个设备上进行双因素身份验证 (2FA)，并提供备份。可替代 Google Authenticator。免费使用，最多可进行 100 次成功的身份验证。
  * [Cerbos Hub](https://www.cerbos.dev/product-cerbos-hub) - 用于编写、测试和部署访问策略的完整授权管理系统。细粒度授权和访问控制，免费使用，最高可达 100 个每月活跃的主体。
  * [Clerk](https://clerk.com) — 用户管理、身份验证、2FA/MFA、用于登录、注册、用户个人资料等的预制 UI 组件。免费使用，最高可达 10,000 个每月活跃用户。
  * [Cloud-IAM](https://www.cloud-iam.com/) — Keycloak 身份和访问管理即服务。免费使用，最高可达 100 个用户和一个领域。
  * [Corbado](https://www.corbado.com/) — 为新应用或现有应用添加密码优先身份验证。免费使用，无限制的 MAUs。
  * [Descope](https://www.descope.com/) — 高度可定制的身份验证流程，同时提供无代码和 API/SDK 方法，免费使用，每月活跃用户 7500 个，租户 50 个（最多 5 个 SAML/SSO 租户）。
  * [duo.com](https://duo.com/) — 网站或应用的双因素身份验证 (2FA)。免费使用，最多 10 个用户，所有身份验证方法、无限制、集成、硬件令牌。
  * [Kinde](https://kinde.com/) - 简单、强大的身份验证，您可以在几分钟内集成到您的产品中。开始使用所需的一切，免费获得 7500 个 MAU。
  * [logintc.com](https://www.logintc.com/) — 通过推送通知进行双因素身份验证 (2FA)，免费使用，最多 10 个用户，VPN、网站和 SSH
  ...
  * [Ory](https://ory.sh/) - 身份验证/授权/OAuth2.0/零信任管理的安全平台。具有所有安全功能的永久免费开发者帐户，无限团队成员，每天 200 个活跃用户，每月 25k/权限检查。
  * [Phase Two](https://phasetwo.io) - Keycloak 开源身份和访问管理。免费领域，最多 1000 个用户，最多 10 个 SSO 连接，利用 Phase Two 的 Keycloak 增强容器，其中包括 [Organization](https://phasetwo.io/product/organizations/) 扩展。
  * [Stytch](https://www.stytch.com/) - 具有强大密码、无密码登录流程、MFA、SSO 等功能的灵活身份验证 API 和 SDK。内置电子邮件/短信发送+故障转移和欺诈保护。提供 5,000 个每月活跃用户免费（B2C）或 1,000 个每月活跃用户和 25 个组织免费（B2B）。
  * [Stack Auth](https://stack-auth.com) — 开源身份验证，不会让人感到厌烦。最适合开发人员的解决方案，只需五分钟即可入门。可免费自托管，或提供带有 10k 免费每月活跃用户的托管 SaaS 版本。
  * [SuperTokens](https://supertokens.com/) - 开源用户身份验证，可本机集成到您的应用程序中 - 使您能够快速入门，同时控制用户和开发人员体验。免费使用，最高可达 5000 MAUs。
  * [Warrant](https://warrant.dev/) — 为您的应用提供托管企业级授权和访问控制服务。免费层包括 100 万个每月 API 请求和 1,000 个授权规则。
  * [ZITADEL Cloud](https://zitadel.com) — 一个即插即用的用户和访问管理系统，适用于您和支持多租户 (B2B) 用例。免费使用，最高可达 25,000 个经过身份验证的请求，具有所有安全功能（OTP、无密码、策略等无付费墙）。
  * [PropelAuth](https://propelauth.com) — 立即向任何规模的公司销售，只需几行代码，免费使用，最高可达 200 个用户和 10k 封交易电子邮件（带有水印品牌：“由 PropelAuth 提供支持”）。
  * [Logto](https://logto.io/) - 开发、保护和管理您产品的用户身份，用于身份验证和授权。免费使用，最高可达 5,000 MAUs，提供开源自托管选项。
...
## 管理系统
  ...
  * [bitnami.com](https://bitnami.com/) - 在 IaaS 上部署准备好的应用程序。免费管理 1 AWS 微实例
  * [Esper](https://esper.io) - 用于 Android 设备的 MDM 和 MAM，带有 DevOps。一个用户许可证和 25MB 应用程序存储可免费使用一百个设备。
  * [jamf.com](https://www.jamf.com/) - iPad、iPhone 和 Mac 的设备管理，免费提供三个设备
  * [Miradore](https://miradore.com) - 设备管理服务。随时了解您的设备车队并免费安全保护无限数量的设备。免费计划提供基本功能。
  * [moss.sh](https://moss.sh) - 帮助开发人员部署和管理他们的 Web 应用程序和服务器。每月免费高达 25 次 git 部署
  * [runcloud.io](https://runcloud.io/) - 主要关注 PHP 项目的服务器管理。免费最多 1 台服务器
  * [ploi.io](https://ploi.io/) - 服务器管理工具，可轻松管理和部署您的服务器和站点。免费提供一个服务器

**[⬆️ 返回顶部](#table-of-contents)**

## 消息和流

  * [Ably](https://www.ably.com/) - 具有存在性、持久性和消息传递保证的实时消息传递服务。免费计划包括每月 300 万条消息、100 个峰值连接和 100 个峰值通道。
  * [cloudamqp.com](https://www.cloudamqp.com/) - 即 RabbitMQ 服务。小狐猴计划：每月最多 100 万条消息，最多 20 个并发连接，最多 100 个队列，最多 10,000 条排队消息，不同 AZ 中的多个节点
  ...
  * [HiveMQ](https://www.hivemq.com/mqtt-cloud-broker/) - 将您的 MQTT 设备连接到云原生 IoT 消息代理。免费连接最多 100 个设备（无需信用卡）永久。
  * [knock.app](https://knock.app) - 开发人员的通知基础设施。使用单个 API 调用将消息发送到多个渠道，如应用内、电子邮件、SMS、Slack 和推送。免费计划包括每月 10,000 条消息。
  * [NotificationAPI.com](https://www.notificationapi.com/) - 在 5 分钟内将用户通知添加到任何软件中。免费计划包括每月 10,000 条通知+100 条 SMS 和自动呼叫。
  * [Novu.co](https://novu.co) - 开发人员的开源通知基础架构。用于在一个地方管理所有通信渠道（电子邮件、SMS、直接、应用内和推送）的简单组件和 API。免费计划包括每月 30,000 条通知，保留期为 90 天。
  * [pusher.com](https://pusher.com/) - 实时消息传递服务。免费用于最多 100 个同时连接和 200,000 条消息/天
  * [scaledrone.com](https://www.scaledrone.com/) - 实时消息传递服务。免费用于最多 20 个同时连接和 100,000 个事件/天
  * [synadia.com](https://synadia.com/ngs) - 即服务的 [NATS.io](https://nats.io)。全球、AWS、GCP 和 Azure。免费永久，4k 消息大小，50 个活动连接，每月 5GB 数据。
  ...
  * [webpushr](https://www.webpushr.com/) - Web 推送通知 - 免费最多 10k 订阅者，无限推送通知，浏览器内消息传递
...
## 日志管理
  ...
  * [logzab.com](https://logzab.com/) - 审计跟踪管理系统。免费提供每月 1000 个用户活动日志，保留时间为 1 个月，最多可用于 5 个项目
...
## 翻译管理
  ...
  * [gitlocalize.com](https://gitlocalize.com)——免费且对私有和公共存储库都没有限制
  ...
  * [Localeum](https://localeum.com)——免费最多 1000 个字符串，1 个用户，不限语言，不限项目
  * [localizely.com](https://localizely.com/)——开源免费
  * [Loco](https://localise.biz/)——免费最多 2000 次翻译，不限翻译人员，每个项目 10 种语言，1000 个可翻译资产/项目
  ...
  * [Tolgee](https://tolgee.io)——免费 SaaS 产品，有限的翻译量，永久免费的自托管版本
  * [transifex.com](https://www.transifex.com/)——开源免费
  * [Translation.io](https://translation.io)——开源免费
  * [Translized](https://translized.com)——免费最多 1000 个字符串，1 个用户，不限语言，不限项目
  * [webtranslateit.com](https://webtranslateit.com/)——免费最多 500 个字符串
  * [weblate.org](https://weblate.org/)——对于免费项目是免费的，免费层的字符串源最多为 10,000，对于自有托管的本地部署是无限的
...
## 监控
  ...
  * [UptimeObserver.com](https://uptimeobserver.com/) - 获得 20 个具有 5 分钟间隔的监控器和可定制的状态页面-甚至可用于商业用途。通过电子邮件和 Telegram 享受无限的实时通知。无需信用卡即可开始使用。
  * [Pingmeter.com](https://pingmeter.com/) - 5 个具有 10 分钟间隔的监控器。监控 SSH、HTTP、HTTPS 和任何自定义 TCP 端口。
  * [alerty.ai](https://www.alerty.ai) - 为你的 FE、BE、DB 等提供免费的 APM 和监控+免费的代理运行。
  ...
  * [appspector.com](https://appspector.com/) - 远程 iOS/Android/Flutter 调试的任务控制。对于小流量使用（64MB 日志）免费。
  ...
  * [checklyhq.com](https://checklyhq.com/) - 开发人员的开源端到端/合成监控和深度 API 监控。免费计划有 5 个用户和 50k+的检查运行。
  ...
  * [cronitor.io](https://cronitor.io/) - 对 cron 作业、网站、API 等的性能洞察和监控。免费层有 5 个监视器。
  * [datadoghq.com](https://www.datadoghq.com/) - 最多 5 个节点免费
  * [deadmanssnitch.com](https://deadmanssnitch.com/) - 对 cron 作业的监控。一个免费的监控器（监视器），如果您推荐其他人注册，还可以获得更多。
  * [downtimemonkey.com](https://downtimemonkey.com/) - 60 个监控器，5 分钟间隔。电子邮件、Slack 警报。
  ...
  * [Grafana Cloud](https://grafana.com/products/cloud/) - Grafana Cloud 是一个可组合的观测平台，它将指标和日志与 Grafana 集成在一起。免费：3 个用户，10 个仪表板，100 个警报，Prometheus 和 Graphite 中的指标存储（10,000 个系列，14 天保留），Loki 中的日志存储（50GB 的日志，14 天保留）
  ...
  * [inspector.dev](https://www.inspector.dev) - 使用免费的永久层，在不到一分钟的时间内创建完整的实时监控仪表板。
  * [instrumentalapp.com](https://instrumentalapp.com/) - 具有高达 500 个指标和 3 小时数据可见性的免费应用程序和服务器监控，美观且易于使用。
  ...
  * [linkok.com](https://linkok.com/) - 在线断链检查程序，免费适用于小型网站（最多 100 页），完全免费适用于开源项目。
  ...
  * [Middleware.io](https://middleware.io/) - 中间件观测平台提供对应用程序和堆栈的完整可见性，以便您可以大规模监控和诊断问题。他们为开发人员社区提供免费的永久计划，允许日志监控最多 1M 个日志事件，基础设施监控和 APM 最多 2 个主机。
  * [nixstats.com](https://nixstats.com/) - 免费 1 台服务器。电子邮件通知，公共状态页面，60 秒间隔等。
  * [OnlineOrNot.com](https://onlineornot.com/) - OnlineOrNot 为网站和 API 提供监控，为 cron 作业和计划任务提供监控。还提供状态页面。免费层的前五个检查间隔为 3 分钟。免费层通过 Slack、Discord 和电子邮件发送警报。
  * [OntarioNet.ca CN 测试](https://cntest.ontarionet.ca) - 检查网站是否被中国的防火长城阻止。它通过比较由中国服务器和美国服务器检测到的 DNS 结果和 ASN 信息来识别 DNS 污染。
  ...
  * [pagecrawl.io](https://pagecrawl.io/) - 监控网站更改，免费最多 6 个监视器，每天检查。
  * [syagent.com](https://syagent.com/) - 免费的非商业服务器监控服务，提供警报和指标。
  ...
  * [pingbreak.com](https://pingbreak.com/) - 现代的监控服务。通过 Discord、Slack 或电子邮件检查无限数量的 URL，并获得停机通知。
  * [pingpong.one](https://pingpong.one/) - 具有监控功能的高级状态页面平台。免费层包括一个公共可定制状态页面和一个 SSL 子域。Pro 计划免费提供给开源项目和非营利组织。
  * [robusta.dev](https://home.robusta.dev/) - 基于 Prometheus 的强大 Kubernetes 监控。自带 Prometheus 或安装一体机捆绑包。免费层包括最多 20 个 Kubernetes 节点。通过 Slack、Microsoft Teams、Discord 等接收警报。与 PagerDuty、OpsGenie、VictorOps、DataDog 等许多其他工具集成。
  ...
  * [stathat.com](https://www.stathat.com/) - 免费开始，共 10 个统计数据，无过期限制
  * [statuscake.com](https://www.statuscake.com/) - 网站监控，免费提供无限测试，但有限制
  ...
  * [uptimerobot.com](https://uptimerobot.com/)——网站监控，免费 50 个监视器
  * [uptimetoolbox.com](https://uptimetoolbox.com/)——免费监控五个网站，间隔 60 秒，提供公共状态页
  ...
  * [Squadcast.com](https://squadcast.com)——Squadcast 是一款端到端事件管理软件，旨在帮助您推广 SRE 最佳实践。免费永久计划最多可供 10 个用户使用
  * [RoboMiri.com](https://robomiri.com/)——RoboMiri 是一个稳定的正常运行时间监视器，提供广泛的监视器：cronjob、关键字、网站、端口、ping。免费提供 25 次正常运行时间检查，间隔 3 分钟检查一次。通过电话呼叫、短信、电子邮件和 Webhooks 发出警报
  * [Better Stack](https://betterstack.com/better-uptime)——在单个产品中进行正常运行时间监控、事件管理、值班安排/警报和状态页面。免费计划包括 10 个监视器，检查频率为 3 分钟，状态页面
  * [Pulsetic.com](https://pulsetic.com)——10 个监视器，6 个月历史正常运行时间/日志，无限状态页面和自定义域！免费无限时间和无限电子邮件警报。您不需要信用卡
...
## Crash and Exception Handling
  ...
  * [bugsnag.com](https://www.bugsnag.com/) - 初始试用后，每月免费 2000 个错误
  * [elmah.io](https://elmah.io/) - 网络开发人员的错误日志记录和正常运行时间监控。开源项目的免费小型企业订阅。
  * [Embrace](https://embrace.io/) - 移动应用监控。免费供每年每个用户 100 万用户会话以下的小型团队使用。
  ...
  * [honeybadger.io](https://www.honeybadger.io) - 异常、正常运行时间和 cron 监控。免费供小型团队和开源项目使用（每月 12000 个错误）。
  * [memfault.com](https://memfault.com) - 云设备可观察性和调试平台。免费提供[Nordic](https://app.memfault.com/register-nordic)、[NXP](https://app.memfault.com/register-nxp)和[Laird](https://app.memfault.com/register-laird)设备 100 个。
  * [rollbar.com](https://rollbar.com/) - 异常和错误监控，每月免费 5000 个错误，无限制用户，保留 30 天。
  * [sentry.io](https://sentry.io/) - Sentry 实时跟踪应用程序异常，并提供一个小型免费计划。每月免费 5000 个错误/1 个用户，自行托管则无限制使用。
  * [Axiom](https://axiom.co/) - 存储长达 30 天的日志，最大 0.5TB。包括与 Vercel 等平台的集成以及通过电子邮件/Discord 通知进行高级数据查询。
  * [Semaphr](https://semaphr.com) - 移动应用的免费一体化Kill Switch。
  * [Jam](https://jam.dev) - 一键式开发者友好的错误报告。免费计划，无限制的 Jams。
  * [Whitespace](https://whitespace.dev) - 在浏览器中一键式错误报告。免费计划，个人使用无限录制。

**[⬆️ 返回顶部](#table-of-contents)**

## 搜索

  * [algolia.com](https://www.algolia.com/) - 具有容错性、相关性和 UI 库的托管搜索解决方案，可轻松创建搜索体验。免费的“Build”计划包括 100 万份文档和 10K 次搜索/月。还提供免费的[开发者文档搜索](https://docsearch.algolia.com/)。
  * [bonsai.io](https://bonsai.io/) - 免费 1GB 内存和 1GB 存储空间
  * [CommandBar](https://www.commandbar.com/) - 统一搜索栏即服务，基于网络的 UI 小部件/插件，允许用户在产品中搜索内容、导航、功能等，有助于提高可发现性。对于最多 1000 名每月活跃用户免费，无限制命令。
  * [Magny](https://magny.io) - SaaS 服务，可帮助实现命令调色板（例如应用内搜索），显著减少用户在应用中查找任何内容的时间，利用用户体验和效率。
...
## 教育和职业发展
  ...
  * [The Odin Project](https://www.theodinproject.com/) - 免费、开源的平台，课程专注于 JavaScript 和 Ruby 网络开发。
  * [Free Professional Resume Templates & Editor](https://www.overleaf.com/latex/templates/tagged/cv) - 免费平台，提供大量经验丰富的专业人士的简历模板，可完全克隆、编辑并下载，符合 ATS 优化。
  ...
  * [Cisco Networking Academy, Skills for All](https://skillsforall.com/) - 提供免费的与认证相关的课程，涵盖网络安全、网络和 Python 等主题。
  * [MIT OpenCourseWare](https://ocw.mit.edu/) - MIT OpenCourseWare 是来自 2500 多门 MIT 课程的材料的在线出版物，与世界各地的学习者和教育工作者免费分享知识。Youtube 频道可在 [@mitocw](https://www.youtube.com/@mitocw/featured) 找到。

**[⬆️ 返回顶部](#目录)**

## 电子邮件

  * [10 分钟邮箱](https://10minutemail.com) - 用于测试的免费、临时电子邮件。
  * [AhaSend](https://ahasend.com) - 交易电子邮件服务，每月免费 1000 封电子邮件，免费计划中无限制域、团队成员、Webhooks 和消息路由。
  * [AnonAddy](https://anonaddy.com) - 开源匿名电子邮件转发，可免费创建无限电子邮件别名。
  * [Antideo](https://www.antideo.com) - 免费层每小时可进行 10 次 API 请求，用于电子邮件验证、IP 和电话号码验证。不需要信用卡。
  ...
  * [CloudMailin](https://www.cloudmailin.com/) - 通过 HTTP POST 接收电子邮件和进行事务性出站 - 每月免费 10,000 封电子邮件
  ...
  * [EmailJS](https://www.emailjs.com/) - 这不是完整的电子邮件服务器；这只是一个电子邮件客户端，您可以使用它从客户端发送电子邮件，而无需暴露您的凭据，免费层有 200 个每月请求，2 个电子邮件模板，请求高达 50KB，联系人历史记录有限。
  ...
  * [Temp-Mail.org](https://temp-mail.org/en/) - 临时/一次性邮件生成实用程序，使用多种域名。每次重新加载页面时，电子邮件地址都会刷新。完全免费，不包括任何服务费用。
  ...
  * [FakeMailGenerator.com](https://www.fakemailgenerator.com/) - 德国临时/一次性邮件生成器。支持 10 个域名，同时让您自由创建无限地址。（包含广告）但服务中不包含任何定价，完全免费。
  * [forwardemail.net](https://forwardemail.net) - 免费自定义域名电子邮件转发。创建并转发您域名下的无限数量的电子邮件地址（**注意**：如果您使用.casa、.cf、.click、.email、.fit、.ga、.gdn、.gq、.lat、.loan、.london、.men、.ml、.pl、.rest、.ru、.tk、.top、.work TLD，则需要付费）
  ...
  * [Inboxes App](https://inboxesapp.com) - 每天最多创建 3 个临时电子邮件，完成后可以在方便的 Chrome 扩展中删除它们。非常适合测试注册流程。
  ...
  * [Maildroppa](https://maildroppa.com) - 最多 100 个订阅者和无限电子邮件以及免费的自动化功能。
  ...
  * [Mail7.io](https://www.mail7.io/) - 免费的 Temp Email 地址，用于 QA 开发人员。使用 Web 界面或 API 立即创建电子邮件地址。
  ...
  * [Resend](https://resend.com) - 用于开发人员的事务性电子邮件 API。每月 3000 封电子邮件，每天 100 封电子邮件，免费，一个自定义域名。
  ...
  * [SimpleLogin](https://simplelogin.io/) - 开源、可自托管的电子邮件别名/转发解决方案。免费 5 个别名，无限带宽，无限回复/发送。免费提供给教育工作者（学生、研究人员等）。
  ...
  * [Touchlead](https://touchlead.app)——多功能营销自动化工具，具有潜在客户管理、表单构建和自动化功能。对于有限数量的潜在客户和自动化操作是免费的
  ...
  * [Verifalia](https://verifalia.com/email-verification-api)——实时电子邮件验证 API，具有邮箱确认和一次性电子邮件地址检测器；每天免费 25 次电子邮件验证。
  ...
  * [Zoho](https://www.zoho.com)——最初是作为电子邮件提供商，但现在提供了一系列服务，其中一些提供免费计划。提供免费计划的服务列表：
     ...
     - [Zoho Assist](https://www.zoho.com/assist)——Zoho Assist 的永久免费计划包括一个并发远程支持许可证，并可无限期访问 5 个无人参与的计算机许可证，供专业和个人使用。
     ...
     - [Meeting](https://zoho.com/meeting)——会议，最多可容纳 3 个会议参与者和 10 个网络研讨会参与者。
     - [Vault](https://zoho.com/vault)——个人可访问密码管理。
     - [Showtime](https://zoho.com/showtime)——另一个用于培训的会议软件，最多可容纳 5 名与会者。
     ...
     - [Subscriptions](https://zoho.com/subscriptions)—— recurring计费管理免费供 20 个客户/订阅和 1 个用户，所有支付由 Zoho 托管。最后 40 个订阅指标存储
     - [Checkout](https://zoho.com/checkout)——产品计费管理，有 3 个页面和最多 50 笔付款。
     - [Desk](https://zoho.com/desk)——客户支持管理，有三个代理、私人知识库和电子邮件票证。与[Assist](https://zoho.com/assist)集成，用于一个远程技术人员和 5 台无人值守的计算机。
...
## 功能标志管理平台
  ...
  * [Molasses](https://www.molasses.app) - 强大的功能标志和 A/B 测试。免费最多 3 个环境，每个环境最多 5 个功能标志。
  * [Toggled.dev](https://www.toggled.dev) - 企业级、可扩展的多区域功能标志管理平台。免费计划最多 10 个标志、两个环境、无限请求。SDK、分析仪表板、发布日历、Slack 通知和所有其他功能都包含在无尽的免费计划中。
...
## 字体
  ...
  * [dafont](https://www.dafont.com/) - 该网站上提供的字体是其作者的财产，包括免费软件、共享软件、演示版或公共领域。
  * [Everything Fonts](https://everythingfonts.com/) - 提供多种工具；@font-face、单位换算器、字体隐藏和字体提交。
  * [Font Squirrel](https://www.fontsquirrel.com/) - 免费字体，可用于商业工作。精心挑选这些字体并以易于使用的格式呈现。
  * [Google Fonts](https://fonts.google.com/) - 许多免费字体可以通过下载或指向 Google 的 CDN 轻松安装在网站上。
  * [FontGet](https://www.fontget.com/) - 有多种字体可供下载，并通过标签整齐排序。
  ...
  * [fonts.xz.style](https://fonts.xz.style/) 使用 CSS 将字体系列交付到网站的免费和开源服务。
...
## 表单
  ...
  * [Feathery](https://feathery.io) - 功能强大、对开发者友好的表单构建器。可构建注册/登录、用户引导、支付流程、复杂金融应用等。免费计划允许每月最多提交 250 次，并且有五个有效表单。
  ...
  * [FabForm](https://fabform.io/) - 智能开发者的表单后端平台。免费计划每月允许 250 次表单提交。友好的现代图形用户界面。与 Google Sheets、Airtable、Slack、电子邮件等集成。
  * [Form.taxi](https://form.taxi/) - HTML 表单提交的端点。具有通知、垃圾邮件阻止器和符合 GDPR 的数据处理功能。免费计划用于基本使用。
  * [Formcarry.com](https://formcarry.com) - HTTP POST 表单端点，免费计划允许每月 100 次提交。
  * [formingo.co](https://www.formingo.co/) - 适用于静态网站的简单 HTML 表单。无需注册帐户即可开始免费使用。免费计划允许每月 500 次提交和可自定义的回复电子邮件地址。
  * [FormKeep.com](https://www.formkeep.com/) - 无限表单，每月 50 次提交，垃圾邮件保护，电子邮件通知，以及可拖放的设计器，可导出 HTML。其他功能包括自定义字段规则、团队和与 Google Sheets、Slack、ActiveCampaign、Zapier 的集成。
  ...
  * [Formsubmit.co](https://formsubmit.co/) - HTML 表单的简单表单端点。免费永久。无需注册。
  ...
  * [HeroTofu.com](https://herotofu.com/) - 具有机器人检测和加密存档的表单后端。通过用户界面将提交内容转发到电子邮件、Slack 或 Zapier。使用自己的前端。不需要服务器代码。免费计划每月提供无限表单和 100 次提交。
  * [HeyForm.net](https://heyform.net/) - 拖放式在线表单构建器。免费层允许创建无限表单并收集无限提交。附带预制模板、反垃圾邮件和 100MB 文件存储。
  ...
  * [Kwes.io](https://kwes.io/) - 功能丰富的表单端点。与静态站点配合得很好。免费计划包括最多 1 个网站和每月 50 次提交。
  * [Pageclip](https://pageclip.co/) - 免费计划允许一个网站、一个表单和每月 1000 次提交。
  * [Qualtrics Survey](https://qualtrics.com/free-account) - 使用此一流工具创建专业表单和调查。50 多个专家设计的调查模板。免费帐户的限制为：1 个活动调查、100 次响应/调查和 8 种响应类型。
  ...
  * [Survicate](https://survicate.com/) - 从各个来源收集反馈并使用一个工具发送后续调查。使用 AI 自动分析反馈并提取见解。免费电子邮件、网站、应用内或移动调查、AI 调查创建者和每月 25 次响应。
  ...
  * [Typeform.com](https://www.typeform.com/) - 在网站上包含精美的表单。免费计划每个表单允许 10 个字段，每月允许 100 次响应。
  ...
  * [Formester.com](https://formester.com) - 在您的网站上共享和嵌入独特外观的表单-不受计划限制的表单数量或功能的限制。每月免费获得高达 100 次提交。
  * [SimplePDF.eu](https://simplepdf.eu/embed) - 在您的网站上嵌入 PDF 编辑器，并将任何 PDF 转换为可填写的表单。免费计划允许每个 PDF 有无限个 PDF 和三次提交。
  * [forms.app](https://forms.app/) - 使用强大功能（如条件逻辑、自动评分计算器和 AI）创建在线表单。免费计划可收集高达 100 次响应，可嵌入网站，或使用链接使用。
  * [Qualli](https://usequalli.com) - 应用内调查，专为移动设备设计。使用 Qualli AI 打造完美问题。您可以在我们的免费计划中试用，高达 500 MAU，创建无限表单和触发器。
  * [Sprig](https://sprig.com/) - 每月一次产品内调查或调查，带有 GPT 驱动的 AI 分析。
...
## 生成式人工智能（GenerativeAI）
  ...
  * [Clair](https://askclair.ai/) - 临床 AI 参考。学生可以免费访问专业工具套件，其中包括 Open Search、临床摘要、Med Review、药物相互作用、ICD-10 代码和管理。此外，还提供专业套件的免费试用。
...
## 内容分发网络（CDN）和防护
  ...
  * [developers.google.com](https://developers.google.com/speed/libraries/)——谷歌托管库是一个内容分发网络，用于最流行的开源 JavaScript 库
  ...
  * [Microsoft Ajax](https://docs.microsoft.com/en-us/aspnet/ajax/cdn/overview)——微软 Ajax CDN 托管流行的第三方 JavaScript 库，如 jQuery，并使您可以轻松将其添加到您的 Web 应用程序中
  ...
  * [section.io](https://www.section.io/)——一种启动和管理完整 Varnish 缓存解决方案的简单方法。据称对于一个站点来说是免费的永远
...
## 平台即服务（PaaS）
  ...
  * [anvil.works](https://anvil.works) - 使用 Python 进行 Web 应用开发。免费层提供无限数量的应用和 30 秒超时。
  ...
  * [codenameone.com](https://www.codenameone.com/)——开源、跨平台的移动应用开发工具链，适用于 Java/Kotlin 开发人员。免费供商业使用，无项目数量限制
  ...
  * [domcloud.co](https://domcloud.co)——提供与 GitHub、SSH 和 MariaDB/Postgres 数据库的 CI/CD 的 Linux 托管服务。免费版本有 1GB 存储和 1GB 网络/月限制，且仅限于免费域名。
  * [encore.dev](https://encore.dev/)——使用静态分析提供自动基础设施、无样板代码等的后端框架。包括免费云托管，适用于业余项目。
  ...
  * [gigalixir.com](https://gigalixir.com/)——Gigalixir 提供一个永不休眠的免费实例和一个免费的 PostgreSQL 数据库，限制为 2 个连接、10,000 行且不提供备份，适用于 Elixir/Phoenix 应用。
  * [Glitch](https://glitch.com/)——具有代码共享和实时协作功能的免费公共托管。免费计划有每月 1000 小时的限制。
  * [Lade](https://www.lade.io/)——Lade 是为开发人员构建的云平台。免费层包括三个服务，既可以是应用程序，也可以是数据库。每个服务都包括 128MB RAM 和 1GB 存储。
  ...
  * [ampt.dev](https://getampt.com/)——Ampt 让团队能够在 AWS 上构建、部署和扩展 JavaScript 应用程序，无需复杂的配置或管理基础架构。免费预览计划包括每小时 500 次调用、每天 2500 次调用和每月 50,000 次调用。自定义域仅在付费计划中允许。
  * [Koyeb](https://www.koyeb.com)——Koyeb 是一个面向开发者的无服务器平台，可在全球范围内部署应用程序。通过基于 git 的部署、本机自动缩放、全球边缘网络和内置的服务网格和发现，无缝运行 Docker 容器、Web 应用程序和 API。免费实例可让您在德国法兰克福或美国华盛顿特区部署 Web 服务。免费托管的 PostgreSQL 数据库可在德国法兰克福（德国）、美国华盛顿特区（美国）和新加坡使用。512MB 内存、2GB 存储和 0.1 CPU。无需信用卡即可开始使用。
  * [Napkin](https://www.napkin.io/)——具有 500Mb 内存、默认超时时间为 15 秒和每月 5000 次免费 API 调用的 FaaS，速率限制为每秒 5 次调用。
  * [Meteor Cloud](https://www.meteor.com/cloud)——Galaxy 托管。Meteor 的平台即服务适用于 Meteor 应用程序，包括免费的 MongoDB 共享托管和自动 SSL。
  ...
  * [WunderGraph](https://cloud.wundergraph.com)——一个开源平台，允许您快速构建、交付和管理现代 API。内置 CI/CD、GitHub 集成和自动 HTTPS。免费计划在[免费计划](https://wundergraph.com/pricing)上最多可使用 3 个项目、1GB 出口、300 分钟构建时间。
  ...
  * [genezio.com](https://genezio.com/)——一个无服务器功能提供程序，为非商业或学术用途免费提供 100 万个功能调用、100GB 带宽和 10 个 cron 作业。

**[⬆️ 返回顶部](#table-of-contents)**

## 后端即服务（BaaS）

  * [Activepieces](https://www.activepieces.com) - 构建自动化流程，将多个应用在您的应用后端连接在一起。例如，当您的应用中发生事件时，发送一条 Slack 消息或在 Google 表格中添加一行。每月免费使用 5000 个任务。
  * [back4app.com](https://www.back4app.com) - Back4App 是一个易于使用、灵活且可扩展的后端，基于 Parse 平台。
  * [backendless.com](https://backendless.com/) - 移动和网络 Baas，免费提供 1GB 文件存储、每月 50,000 次的推送通知和表中的 1000 个数据对象。
  * [bismuth.cloud](https://www.bismuth.cloud/) - 我们的人工智能将在我们的函数运行时和托管存储上引导您的 Python API，在我们的在线编辑器或本地使用您喜欢的工具免费构建和托管。
  * [BMC Developer Program](https://developers.bmc.com/site/global/bmc_helix_platform/program/overview/index.gsp) - BMC Developer Program 提供文档和资源，以帮助您为企业构建和部署数字创新。访问全面的个人沙盒，其中包括平台、SDK 和可用于构建和定制应用的组件库。
  * [connectycube.com](https://connectycube.com) - 无限聊天消息、p2p 语音和视频通话、文件附件和推送通知。对于最多 1000 个用户的应用免费。
  * [convex.dev](https://convex.dev/) - 作为服务的反应式后端，托管您的数据（具有关系和可序列化 ACID 事务的文档）、无服务器功能和 WebSockets，以将更新流式传输到各个客户端。小型项目免费-最多 100 万条记录，每月 500 万次功能调用。
  * [darklang.com](https://darklang.com/) - 托管语言结合了编辑器和基础架构。在测试版期间可访问，计划在测试版后提供慷慨的免费层。
  * [Firebase](https://firebase.com) - Firebase 帮助您构建和运行成功的应用。免费 Spark 计划提供身份验证、托管、Firebase ML、实时数据库、云存储、Testlab。A/B 测试、分析、应用分发、应用索引、云消息（FCM）、崩溃分析、动态链接、应用内消息、性能监控、预测和远程配置始终免费。
  * [Flutter Flow](https://flutterflow.io) - 无需编写一行代码即可构建您的 Flutter App UI。还具有 Firebase 集成。免费计划包括对 UI Builder 和免费模板的完全访问。
  * [getstream.io](https://getstream.io/) - 在几个小时内而不是几周内构建可扩展的应用内聊天、消息传递、视频和音频以及源。
  * [hasura.io](https://hasura.io/) - Hasura 扩展了您在任何地方托管的现有数据库，并提供了一个即时 GraphQL API，可安全访问网络、移动和数据集成工作负载。免费 1GB/月的数据通过量。
  ...
  * [onesignal.com](https://onesignal.com/) - 无限免费推送通知。每月 10,000 封电子邮件发送，无限制的联系人访问权限和自动预热功能。
  ...
  * [pushcrew.com](https://pushcrew.com/) - 推送通知服务。无限通知适用于最多 2000 个订阅者
  * [pusher.com](https://pusher.com/beams) - 免费、无限的推送通知，适用于每月 2000 名活跃用户。适用于 iOS 和 Android 设备的单个 API。
  ...
  * [Salesforce Developer Program](https://developer.salesforce.com/signup) - 使用拖放工具快速构建、测试和部署应用程序。自定义数据模型只需点击即可。使用 Apex 代码更进一步。使用强大的 API 与任何内容集成。使用企业级安全性进行保护。使用点击或任何领先的 Web 框架自定义 UI。免费开发者计划可访问完整的 Lightning 平台。
  * [ServiceNow Developer Program](https://developer.servicenow.com/) - 快速构建、测试和部署使您的组织工作更出色的应用程序。免费实例和早期预览访问权限。
  * [simperium.com](https://simperium.com/) - 立即在各个平台上随时随地自动移动数据，多平台，无限制地发送和存储结构化数据，每月最多 2500 个用户。
  ...
  * [stackstorm.com](https://stackstorm.com/) - 应用程序、服务和工作流的事件驱动自动化，免费使用，无需流程、访问控制、LDAP
  ...
  * [zapier.com](https://zapier.com/) - 将您使用的应用程序连接起来以自动执行任务。每 15 分钟五个 zaps 和每月 100 个任务
  ...
  * [LeanCloud](https://leancloud.app/) - 移动后端。1GB 数据存储、256MB 实例、每天 3K API 请求和 10K 推送是免费的。（API 非常类似于 Parse 平台）
...
## 低代码平台
  ...
  * [ReTool](https://retool.com/)——用于构建内部应用程序的低代码平台。Retool 非常易于定制。如果您可以使用 JavaScript 和 API 编写它，那么您可以在 Retool 中实现它。免费套餐允许每个月最多有 5 个用户，无限制的应用程序和 API 连接。
  ...
  * [outsystems.com](https://www.outsystems.com/)——企业 Web 开发 PaaS，适用于内部部署或云，免费的“个人环境”提供无限代码和最多 1GB 数据库
  * [UI Bakery](https://uibakery.io)——一个低代码平台，能够更快地构建自定义 Web 应用程序。支持使用拖放构建 UI，并通过 JavaScript、Python 和 SQL 进行高度定制。提供云和自托管解决方案。免费提供给最多 5 个用户。
...
## 虚拟主机
  ...
  * [Fenix Web Server](https://preview.fenixwebserver.com)——用于在本地托管站点并公开共享（实时）的开发者桌面应用程序。使用其美观的用户界面、API 和/或 CLI 按照您喜欢的方式工作。
  * [Fern](https://buildwithfern.com)——在 Fern 的免费计划上构建和托管基于 Markdown 的文档站点。您甚至可以从 API 定义文件为您的站点自动生成 API 参考。该站点托管在_yoursite_.docs.buildwithfern.com。
  ...
  * [HelioHost](https://heliohost.org)——非盈利性免费网络托管，带有 Plesk 控制面板，支持 PHP、Node.js、Python、Django、Flask、.NET、Perl、CGI、MySQL、PostgreSQL、SQLite、IMAP/POP3/SMTP 电子邮件、无限带宽、免费子域、1000MB 存储空间，可选择升级。
  * [Kinsta Static Site Hosting](https://kinsta.com/static-site-hosting/)——免费部署多达 100 个静态站点，支持自定义域名和 SSL，100GB 月带宽，260+Cloudflare CDN 位置。
  ...
  * [surge.sh](https://surge.sh/)——面向前端开发人员的静态 Web 发布。无限制的站点支持自定义域名。
  * [telegra.ph](https://telegra.ph/)——使用 Quill 轻松创建网页。
  * [tilda.cc](https://tilda.cc/)——一个站点，50 页，50MB 存储，170 多个可用的主要预定义块中，没有字体，没有 favicon，也没有自定义域名。
  * [Vercel](https://vercel.com/)——使用免费 SSL、全球 CDN 和每次`git push`时独特的预览 URL 构建、部署和托管 Web 应用程序。非常适合 Next.js 和其他静态站点生成器。
  * [Versoly](https://versoly.com/)——专注于 SaaS 的网站构建器-无限制的网站，70 多个块，五个模板，自定义 CSS，favicon，SEO 和表单。不支持自定义域名。
  * [Qoddi](https://qoddi.com)——类似 Heroku 的 PaaS 服务，采用以开发人员为中心的方法和全面的功能。免费层适用于静态资产、暂存和开发人员应用程序。
  * [FreeFlarum](https://freeflarum.com/)——社区驱动的免费 Flarum 托管，最多支持 250 个用户（捐赠以去除页脚的水印）。
...
## 域名系统（DNS）
  ...
  * [1.1.1.1](https://developers.cloudflare.com/1.1.1.1/) - 由 Cloudflare 提供的免费公共 DNS 解析器，快速且安全（加密 DNS 查询）。可用于绕过互联网提供商的 DNS 阻塞、防止 DNS 查询监视以及[阻止成人和恶意软件内容](https://developers.cloudflare.com/1.1.1.1/1.1.1.1-for-families)。也可以通过[API 使用](https://developers.cloudflare.com/1.1.1.1/encrypted-dns/dns-over-https/make-api-requests)。注意：只是一个 DNS 解析器，不是 DNS 主机。
  ...
  * [freedns.afraid.org](https://freedns.afraid.org/)—免费 DNS 托管。此外，还基于众多公共用户[贡献的域](https://freedns.afraid.org/domain/registry/)提供免费子域。注册后从“子域”菜单中获取免费子域。
  ...
  * [noip.at](https://noip.at/)—免费 DDNS 服务，无需注册、跟踪、记录或广告。对域没有限制。
  * [noip](https://www.noip.com/)—动态 DNS 服务，允许免费使用最多 3 个主机名，每 30 天需要确认一次
  * [sslip.io](https://sslip.io/)—免费 DNS 服务，当用主机名查询嵌入的 IP 地址时，返回该 IP 地址。
  * [zilore.com](https://zilore.com/en/dns)—免费 DNS 托管，可托管 5 个域。
  * [zoneedit.com](https://www.zoneedit.com/free-dns/)—免费 DNS 托管，支持动态 DNS
  * [zonewatcher.com](https://zonewatcher.com)—自动备份和 DNS 更改监控。免费 1 个域
  * [huaweicloud.com](https://www.huaweicloud.com/intl/en-us/product/dns.html)–由华为提供的免费 DNS 托管
  * [Hetzner](https://www.hetzner.com/dns-console)–来自 Hetzner 的免费 DNS 托管，支持 API
  * [Glauca](https://docs.glauca.digital/hexdns/)—最多可托管 3 个域并支持 DNSSEC 的免费 DNS 托管
...
## 基础设施即服务（IaaS）
  ...
  * [backblaze.com](https://www.backblaze.com/b2/) - Backblaze B2 云存储。无限时间免费 10GB（类似亚马逊 S3）对象存储
  * [filebase.com](https://filebase.com/) - 基于区块链的 S3 兼容对象存储。无限时长 5GB 免费存储
  ...
  * [Spheron](https://spheron.network/) - 从去中心化云存储和网络托管到应用程序和开发人员的去中心化计算，在一个平台下，免费计划提供 5GB 存储、100GB 带宽、无限域名和项目，5 美元的计算资源（相对于 AWS 价值 50 美元）。

**[⬆️ 返回顶部](#table-of-contents)**

## 托管数据服务

  * [Aiven](https://aiven.io/) - Aiven 为其开源数据平台提供免费的 PostgreSQL、MySQL 和 Redis 计划。单节点，1 个 CPU，1GB RAM，对于 PostgreSQL 和 MySQL，5GB 存储。易于迁移到更广泛的计划或跨云。
  ...
  * [codehooks.io](https://codehooks.io/) — 易于使用的 JavaScript 无服务器 API/后端和 NoSQL 数据库服务，具有功能、类似于 Mongdb 的查询、键/值查找、作业系统、实时消息、工作队列、强大的 CLI 和基于网络的数据管理器。免费计划有 5GB 存储和每分钟 60/API 调用。包含 2 名开发人员。无需信用卡。
  ...
  * [Upstash](https://upstash.com/) — 无服务器 Redis，免费层每天最多 10,000 个请求，最大数据库大小 256MB，最大 20 个并发连接
  ...
  * [scalingo.com](https://scalingo.com/) — 主要是一个 PaaS，但提供 MySQL、PostgreSQL 或 MongoDB 的 128MB 到 192MB 免费层
  ...
  * [Turso by ChiselStrike](https://chiselstrike.com/) - Turso 是边缘数据库中的 SQLite 开发者体验。Turso 提供免费永久的入门计划，总存储量为 9GB，最多可容纳 500 个数据库，最多可位于 3 个位置，每月读取 10 亿行数据，并提供本地开发支持和 SQLite。
  * [InfluxDB](https://www.influxdata.com/) — 时间序列数据库，免费使用，写入最多 3MB/5 分钟，读取最多 30MB/5 分钟， cardinality 系列最多 10,000 个
  * [restdb.io](https://restdb.io/) - 快速且直接的 NoSQL 云数据库服务。使用 restdb.io，您可以获得模式、关系、自动 REST API（类似于 MongoDB 的查询）以及高效的多用户管理 UI，用于处理数据。免费计划允许 3 个用户、2500 条记录和每秒 1 个 API 请求。
  ...
  * [Neo4j Aura](https://neo4j.com/cloud/aura/) — 管理本机图形数据库管理系统/分析平台，具有 Cypher 查询语言和 REST API。对图形大小的限制（50k 个节点，175k 个关系）。
  * [Neon](https://neon.tech/) — 托管 PostgreSQL，总存储量为 0.5GB，1 个项目，10 个分支，无限制的数据库，始终可用的主分支（非主分支计算后 5 分钟自动暂停），每月活动时间为 20 小时
  * [Dgraph Cloud](https://cloud.dgraph.io/pricing?type=free) — 管理本机图形数据库管理系统，具有 GraphQL API。每天数据传输限制为 1MB。
  ...
  * [TigerGraph Cloud](https://www.tigergraph.com/cloud/) — 管理本机图形数据库管理系统/分析平台，具有类似 SQL 的图形查询语言和 REST API。一个免费实例，两个 vCPU，8GB 内存，50GB 存储，闲置 1 小时后睡眠。
  * [TerminusCMS](https://terminusdb.com/pricing) — TerminusDB 的托管免费服务，TerminusDB 是一种用 Prolog 和 Rust 编写的文档和图形数据库。免费用于开发，付费用于企业部署和支持。
  ...
  * [xata.io](https://xata.io) - Xata 是一个无服务器数据库，内置强大的搜索和分析功能。一个 API，多个类型安全的客户端库，并且针对您的开发工作流程进行了优化。免费永久层对于业余开发者来说已经足够，其中包括三个 Xata 单位，请参考网站了解单位定义。
  ...
  * [Nile](https://www.thenile.dev/) — 一个用于 B2B 应用程序的 Postgres 平台。无限制的数据库，始终可用，无停机，总存储量为 1GB，5000 万个查询令牌，自动缩放，无限向量嵌入
...
## 隧道、WebRTC、WebSocket服务器和其他路由器
  ...
  * [Hamachi](https://www.vpn.net/)——LogMeIn Hamachi 是一种托管的 VPN 服务，允许你使用免费计划创建无限个网络，每个网络最多可容纳 5 人，将类似 LAN 的网络扩展到分布式团队。
  * [Mirna Sockets](https://mirna.cloud/)——免费的套接字即服务平台，当你部署 WebSocket 服务器代码时，它会提供一个 wss://URL，并且还允许你监控其性能。
  * [localhost.run](https://localhost.run/)——通过隧道将本地运行的服务器暴露到公共 URL。
  * [localtunnel](https://theboroer.github.io/localtunnel-www/)——通过隧道将本地运行的服务器暴露到公共 URL。免费的托管版本，并且是[开源的](https://github.com/localtunnel/localtunnel)。
  ...
  * [Radmin VPN](https://www.radmin-vpn.com/)——通过 VPN 启用类似 LAN 的网络将多台计算机连接在一起。无限的对等方。（Hamachi 替代品）
  * [segment.com](https://segment.com/)——将事件转换并路由到其他第三方服务的中心。免费提供 100,000 个事件/月。
  * Google STUN——[stun:stun.l.google.com:19302](stun:stun.l.google.com:19302)
  * Twilio STUN——[stun:global.stun.twilio.com:3478?transport=udp](stun:global.stun.twilio.com:3478?transport=udp)
  * [Tailscale](https://tailscale.com/)——使用开放源代码的 WireGuard 协议的零配置 VPN。可在 MacOS、iOS、Windows、Linux 和 Android 设备上安装。个人使用的免费计划可容纳 100 个设备和 3 个用户。
  * [webhookrelay.com](https://webhookrelay.com)——管理、调试、分流和代理所有你的 Webhook 到公共或内部（即 localhost）目的地。此外，通过获取公共 HTTP 终结点（`https://yoursubdomain.webrelay.io <----> http://localhost:8080`），可以将在私有网络中运行的服务器暴露到隧道中。
  * [Hookdeck](https://hookdeck.com/pricing)——在任何地方开发、测试和监控你的 Webhook。每月 100K 请求和 100K 尝试，保留期为三天。
  * [Xirsys](https://www.xirsys.com/pricing/)——无限的 STUN 使用+500MB 每月 TURN 带宽，限制带宽，单个地理区域。
  * [ZeroTier](https://www.zerotier.com)——FOSS 管理的虚拟以太网即服务。免费计划可在一个网络中容纳 25 个客户端的端到端加密网络。客户端适用于桌面/移动/NA；Web 界面可用于配置自定义路由规则和批准私有网络上的新客户端节点。
  * [LocalXpose](https://localxpose.io)——反向代理，可让你将本地服务器暴露到互联网。免费计划的隧道生存期为 15 分钟。
  * [Traefik-Hub](https://traefik.io/traefik-hub/)——通过隧道将本地运行的服务发布到公共自定义 URL 并使用访问控制进行保护。一个集群中免费提供 5 个服务。
...
## 问题跟踪和项目管理
  ...
  * [asana.com](https://asana.com/)——与协作者一起免费用于私人项目
  ...
  * [clickup.com](https://clickup.com/)——项目管理。免费，带有云存储的高级版本。移动应用程序和 Git 集成可用。
  * [Clockify](https://clockify.me)——时间跟踪和时间表应用程序，可让您跨项目跟踪工作时间。无限用户，永久免费。
  * [Cloudcraft](https://cloudcraft.co/)——使用 Cloudcraft 可视化设计器在几分钟内设计专业架构图，针对 AWS 进行优化，具有智能组件，可显示实时数据。免费计划为单个用户提供无限私人图表。
  * [Codegiant](https://codegiant.io)——项目管理和存储库托管及 CI/CD。免费计划提供 5 个团队成员的无限存储库、项目和文档。每月 500 分钟的 CI/CD 分钟数。每月 30000 个无服务器代码运行分钟数 1GB 存储库存储空间。
  ...
  * [Ilograph](https://www.ilograph.com/)——允许用户从多个角度和详细级别查看其基础设施的交互式图表。图表可以用代码表示。免费层提供无限的私人图表，最多可容纳 3 个查看者。
  ...
  * [Kiter.app](https://www.kiter.app/)——让任何人组织他们的求职并跟踪面试、机会和联系。功能强大的网络应用程序和 Chrome 扩展程序。完全免费。
  * [Kumu.io](https://kumu.io/)——具有动画、装饰、过滤器、聚类、电子表格导入等功能的关系图。免费层允许无限的公共项目。图形大小不受限制。免费的私人项目供学生使用。如果您不想将文件公开在线（上传、编辑、下载、丢弃），则可以使用沙盒模式。
  * [Linear](https://linear.app/)——界面简洁的问题跟踪器。免费版供无限成员使用，文件上传大小最大为 10MB，问题数量为 250（不包括存档）
  * [leiga.com](https://www.leiga.com/)——Leiga 是一款使用 AI 自动管理项目的 SaaS 产品，可帮助您的团队集中注意力并释放巨大潜力，确保项目按计划推进。免费版供最多 10 个用户使用，20 个自定义字段，2GB 存储空间，AI 限制的视频录制最多 5 分钟/视频，自动化运行次数为 20/用户/月。
  * [Lucidchart](https://www.lucidchart.com/)——具有协作功能的在线图表工具。免费计划有三个可编辑文档、100 个专业模板和基本协作功能。
  * [MeisterTask](https://www.meistertask.com/)——面向团队的在线任务管理。免费版最多可用于 3 个项目和无限数量的项目成员。
  * [MeuScrum](https://www.meuscrum.com/en)——免费的在线 Scrum 工具，带有看板
  * [nTask](https://www.ntaskmanager.com/)——项目管理软件，可让您的团队协作、计划、分析和管理日常任务。Essential 计划永久免费，提供 100MB 存储空间和 5 个用户/团队。无限工作空间、会议、任务、时间表和问题跟踪。
  * [Ora](https://ora.pm/)——敏捷任务管理和团队协作。免费版供最多 3 个用户使用，文件限制为 10MB。
  * [pivotaltracker.com](https://www.pivotaltracker.com/)——免费版供无限数量的公共项目和两个私人项目使用，每个项目最多有三个活跃用户（读写）和无限数量的被动用户（只读）。
  * [plan.io](https://plan.io/)——具有存储库托管和更多选项的项目管理。免费版供两个用户使用，最多有十个客户和 500MB 存储空间
  * [Plane](https://plane.so/)——Plane 是一个简单、可扩展、开源的项目和产品管理工具。免费版供无限成员使用，文件上传大小最大为 5MB，问题数量为 1000。
  * [planitpoker.com](https://www.planitpoker.com/)——免费在线规划扑克（估算工具）
  * [point.poker](https://www.point.poker/)——在线规划扑克（基于共识的估算工具）。免费版供无限用户、团队、会话、轮次和投票使用。无需注册。
  * [ScrumFast](https://www.scrumfast.com)——具有非常直观界面的 Scrum 看板，免费版最多供 5 个用户使用。

  * [Shortcut](https://shortcut.com/) - 项目管理平台。免费版最多可供 10 名用户永久使用。
  ...
  * [Tara AI](https://tara.ai/)——简单的冲刺管理服务。免费版无用户限制，任务、冲刺和工作区数量不限。
  * [targetprocess.com](https://www.targetprocess.com/)——可视化项目管理，从看板和 Scrum 到几乎任何运营流程。免费版无用户限制，最多可容纳 1,000 个数据实体 [{更多细节](https://www.targetprocess.com/pricing/) }
  * [taskade.com](https://www.taskade.com/)——实时协作任务列表和团队大纲。免费版有一个工作区，任务和项目不限；1GB 文件存储；项目历史记录为 1 周；视频会议每次可容纳 5 名参会者。
  ...
  * [teamwork.com](https://teamwork.com/)——项目管理和团队聊天。免费版可供 5 名用户和 2 个项目使用。提供高级计划。
  * [teleretro.com](https://www.teleretro.com/)——简单有趣的回顾工具，带有破冰游戏、动图和表情符号。免费版包括 3 次回顾和无限成员。
  * [testlio.com](https://testlio.com/)——问题跟踪、测试管理和 Beta 测试平台。仅供私人使用免费
  * [terrastruct.com](https://terrastruct.com/)——专门用于软件架构的在线图表制作工具。免费版每个图表最多 4 层。
  * [todoist.com](https://todoist.com/)——协作和个人任务管理。免费版有：5 个活动项目、项目中的 5 个用户、上传文件最大 5MB、3 个过滤器和一周的活动历史。
  ...
  * [vabotu](https://vabotu.com/) - 用于项目管理的协作工具。提供免费和其他计划。自由职业者计划可供 10 名用户使用，包括消息传递、任务看板、5GB 在线存储、工作区和导出数据。
  * [Wikifactory](https://wikifactory.com/)——具有项目、VCS 和问题的产品设计服务。免费版提供无限项目和协作者以及 3GB 存储空间。
  * [Yodiz](https://www.yodiz.com/)——敏捷开发和问题跟踪。免费版最多可供 3 名用户使用，无限制项目。
  * [YouTrack](https://www.jetbrains.com/youtrack/buy/#edition=incloud)——免费托管的 YouTrack（InCloud）适用于 FOSS 项目和私人项目（免费供 3 名用户使用）。包括时间跟踪和敏捷看板
  ...
  * [Zube](https://zube.io)——具有免费计划的项目管理，最多可供 4 个项目和 4 名用户使用。支持 GitHub 集成。
  * [Toggl](https://toggl.com/)——提供两个免费的生产力工具。[Toggl Track](https://toggl.com/track/)用于时间管理和跟踪应用程序，免费版提供了专为自由职业者设计的无缝时间跟踪和报告功能。它具有无限的跟踪记录、项目、客户、标签、报告等。和[Toggl Plan](https://toggl.com/plan/)用于任务规划，免费版供独奏开发人员使用，任务、里程碑和时间线不限。
  * [Sflow](https://sflow.io)——sflow.io 是一款专为敏捷软件开发、营销、销售和客户支持而构建的项目管理工具，特别适用于外包和跨组织协作项目。免费版最多可容纳 3 个项目和 5 名成员。
...
## 存储和媒体处理
  ...
  * [sirv.com](https://sirv.com/) — 带有即时图像优化和调整大小功能的智能图像 CDN。免费层包括 500MB 存储空间和 2GB 带宽。
  * [cloudimage.io](https://www.cloudimage.io/en/home) — 具有全球 1500 多个存在点的完整图像优化和 CDN 服务。提供各种图像调整大小、压缩和水印功能。提供响应式图像、360 度图像制作和图像编辑的开源插件。免费计划包括每月 25GB 的 CDN 流量、25GB 的缓存存储和无限转换。
  * [cloudinary.com](https://cloudinary.com/) — 用于网站和应用程序的图像上传、强大的操作、存储和交付，提供 Ruby、Python、Java、PHP、Objective-C 等更多库。免费层包括 25 个每月信用额度。一个信用额度等于 1000 次图像转换、1GB 存储空间或 1GB CDN 使用量。
  * [embed.ly](https://embed.ly/) — 提供在网页中嵌入媒体、响应式图像缩放和从网页中提取元素的 API。免费使用，每月最多可处理 5000 个 URL，每秒 15 个请求
  * [filestack.com](https://www.filestack.com/) — 文件选择、转换和交付，免费使用 250 个文件、500 次转换和 3GB 带宽
  ...
  * [GoFile.io](https://gofile.io/) - 免费的文件共享和存储平台，可通过基于网络的 UI 和 API 使用。无文件大小、带宽、下载数量等限制。但文件在不活动（10 天以上没有下载）时会被删除。
  * [gumlet.com](https://www.gumlet.com/) — 通过 CDN 进行图像和视频托管、处理和流式传输。提供慷慨的免费层，每月视频 250GB，每月图像 30GB。
  ...
  * [ImgBB](https://imgbb.com/) — ImgBB 是一个无限图像托管服务。将图像拖放到屏幕上的任何位置。图像限制为 32MB。上传图像后接收直接图像链接、BBCode 和 HTML 缩略图。登录以查看上传历史记录。
  ...
  * [nitropack.io](https://nitropack.io/) - 通过全面的前端优化（缓存、图像和代码优化、CDN）自动提高网站速度。免费计划适用于每月最多 5000 次页面浏览量
  ...
  * [piio.co](https://piio.co/) — 适用于每个网站的响应式图像优化和交付。免费计划适用于开发人员和个人网站。包括免费的 CDN、WebP 和即时加载。
  * [Pinata IPFS](https://pinata.cloud) — Pinata 是上传和管理 IPFS 上文件的最简单方法。我们友好的用户界面和 IPFS API 使 Pinata 成为平台、创作者和收藏家最容易使用的 IPFS 钉扎服务。免费提供 1GB 存储以及 API 访问权限。
  * [placekitten.com](https://placekitten.com/) — 一个快速简单的服务，用于获取小猫图片作为占位符
  * [plot.ly](https://plot.ly/) — 绘制和共享您的数据。免费层包括无限公共文件和十个私有文件
  * [podio.com](https://podio.com/) — 您可以与最多五个人使用 Podio，并试用基本计划的功能，但不包括用户管理
  * [QuickChart](https://quickchart.io) — 生成可嵌入的图像图表、图形和 QR 码
  * [redbooth.com](https://redbooth.com) — P2P 文件同步，最多供 2 个用户使用
  * [resmush.it](https://resmush.it) — reSmush.it 是一个免费的 API，提供图像优化。reSmush.it 已在 WordPress、Drupal 或 Magento 等常见 CMS 上实现。reSmush.it 是使用最广泛的图像优化 API，已经处理了超过 70 亿张图像，而且仍然是免费的。
  ...
  * [twicpics.com](https://www.twicpics.com) - 响应式图像即服务。它提供图像 CDN、媒体处理 API 和前端库，可自动优化图像。服务免费使用，每月最多 3GB 流量。
  ...
  * [internxt.com](https://internxt.com) - Internxt Drive 是基于绝对隐私和无妥协安全的零知识文件存储服务。注册并免费获得 10GB，永久有效！
  * [degoo.com](https://degoo.com/) - 基于人工智能的云存储，免费提供 20GB，三个设备，5GB 推荐奖金（90 天账户不活动）。

  * [ImageEngine](https://imageengine.io/)——ImageEngine 是一个易于使用的全球图像 CDN。设置时间少于 60 秒。支持 AVIF 和 JPEGXL，有 WordPress、Magento、React、Vue 等插件，还有更多。在此[申请](https://imageengine.io/developer-program/)免费开发者账号。
  * [DocsParse](https://docsparse.com/)——GPT 驱动的 AI 处理 PDF、图像，将结构化数据转换为 JSON、CSV、EXCEL 格式。每月免费 30 个积分。
...
## 设计和用户界面（UI）
  ...
  * [Float UI](https://floatui.com/) - 一个免费的 Web 开发工具，用于快速创建具有现代感和响应式的网站，即使对于非设计师也是如此。
  * [Ant Design Landing Page](https://landing.ant.design/) - Ant Design Landing Page 提供了一个由 Ant Motion 的动画组件构建的模板。它有一个丰富的主页模板，下载模板代码包，并可以快速使用。您还可以使用编辑器快速构建自己的专用页面。
  * [Backlight](https://backlight.dev/) - 一款完整的编码平台，旨在促进开发人员和设计师之间的合作，让团队能够构建、记录、发布、扩展和维护设计系统。免费计划允许最多 3 名编辑在一个设计系统上工作，并且没有 viewer 数量限制。
  ...
  * [figma.com](https://www.figma.com/) - 在线团队协作设计工具；免费层包括无限文件和查看器，最大有 2 名编辑器和 3 个项目。
  * [Flyon UI](https://flyonui.com/) - 适用于 Tailwind CSS 的最简单组件库。
  * [framer.com](https://www.framer.com/) - Framer 帮助您为下一个应用、网站或产品迭代和动画界面创意——从强大的布局开始。对于将 Framer 视为专业原型工具的任何人：无限制的查看者，最多 2 名编辑器和最多 3 个项目。
  ...
  * [landen.co](https://www.landen.co) - 为您的初创公司生成、编辑和发布美丽的网站和登录页面。无需代码。免费层允许您拥有一个完全可定制的网站，并在网络上发布。
  * [Quant Ux](https://quant-ux.com/) - Quant Ux 是一个原型制作和设计工具。- 它完全免费，也是开源的。
  * [lensdump.com](https://lensdump.com/) - 免费云图像托管。
  * [Lorem Picsum](https://picsum.photos/) - 一个免费的工具，易于使用，时尚的占位符。在我们的 URL 后，添加您想要的图像大小（宽度和高度），您将获得一张随机图片。
  * [LottieFiles](https://lottiefiles.com/) - 全球最大的设计师、开发人员等使用的世界上最小的动画格式在线平台。访问适用于 Android、iOS 和 Web 的 Lottie 动画工具和插件。
  ...
  * [Mindmup.com](https://www.mindmup.com/) - 无限的思维导图免费存储在云中。您的思维导图随时随地都可以在任何设备上使用。
  * [Mockplus iDoc](https://www.mockplus.com/idoc) - Mockplus iDoc 是一款强大的设计协作和交接工具。免费计划包括三个用户和五个项目，所有功能均可使用。
  * [mockupmark.com](https://mockupmark.com/create/free) - 创建逼真的 T 恤和服装模型，用于社交媒体和电子商务，有 40 个免费模型。
  ...
  * [pixlr.com](https://pixlr.com/) - 功能相当于商业编辑器的免费在线浏览器编辑器。
  ...
  * [Proto.io](https://www.proto.io) - 创建无需编码的完全交互式 UI 原型。免费层在免费试用结束后可用。免费层包括一个用户、一个项目、五个原型、100MB 在线存储和 proto.io 应用程序的预览。
  * [resizeappicon.com](https://resizeappicon.com/) - 一个简单的服务，用于调整和管理您的应用程序图标。
  * [Rive](https://rive.app) - 创建并将美丽的动画发送到任何平台。个人用户永久免费。该服务是一个编辑器，也在其服务器上托管所有图形。他们还为许多平台提供运行时，以运行使用 Rive 创建的表示形式。
  * [storyset.com](https://storyset.com/) - 使用此工具为您的项目创建令人难以置信的免费定制插图。
  * [smartmockups.com](https://smartmockups.com/) - 创建产品模型，有 200 个免费模型。
  * [tabler-icons.io](https://tabler-icons.io/) - 超过 1500 个可复制和粘贴的免费 SVG 可编辑图标。
  ...
  * [unsplash.com](https://unsplash.com/) - 免费的商业和非商业用途库存照片（您可以随意使用的许可证）。

  * [walkme.com](https://www.walkme.com/)——企业级指导和参与平台，免费计划可进行三个最多 5 步/步的引导。
  ...
  * [xLayers](https://xlayers.dev)——预览和将 Sketch 设计文件转换为 Angular、React、Vue、LitElement、Stencil、Xamarin 等（免费和开源，网址为 [https://github.com/xlayers/xlayers]）
  * [Grapedrop](https://grapedrop.com/)——基于 GrapesJS 框架的响应式、强大、SEO 优化的网页构建器。免费前 5 页，无限自定义域名，所有功能，简单使用。
  * [Mastershot](https://mastershot.app)——完全免费的基于浏览器的视频编辑器。无水印，最高 1080p 导出选项。
  * [Unicorn Platform](https://unicornplatform.com/)——无代码落地页构建器，提供托管。免费一个网站。
  * [react-favicon.com](https://react-favicon.com/)——使用 React 和 JSX 使用任何字体和图标库为您的网站生成 favicons。
  * [SVGmix.com](https://www.svgmix.com/)——拥有 30 多万个免费 SVG 图标、集合和品牌徽标的大型资源库。它在浏览器中提供了一个简单的向量编辑程序，可快速编辑文件。
  * [svgrepo.com](https://www.svgrepo.com/)——使用各种向量库探索、搜索和找到最适合您项目的图标或向量。下载免费的 SVG 向量供商业使用。
  ...
  * [Superdesigner](https://superdesigner.co)——一个免费的设计工具集合，可通过几次点击创建独特的背景、图案、形状、图像等。
  * [TeleportHQ](https://teleporthq.io/)——低代码前端设计和开发平台。TeleportHQ 是一个协作前端平台，可立即创建和发布无后端静态网站。三个免费项目，无限协作者，免费代码导出。
  ...
  * [okso.app](https://okso.app)——极简在线绘图应用程序。允许创建快速草图和视觉笔记。将草图导出为 PNG、JPG、SVG 和 WEBP。也可作为 PWA 安装。免费供所有人使用（无需注册）。
  * [Wdrfree SVG](https://wdrfree.com/free-svg)——黑白免费 SVG 切割文件。
  * [Lucide](https://lucide.dev)——免费可定制和一致的 SVG 图标工具包。
  * [Logo.dev](https://www.logo.dev)——拥有 4400 多万个品牌的公司徽标 API，就像调用 URL 一样简单。前 10,000 次 API 调用是免费的。
  * [MDBootstrap](https://mdbootstrap.com/)——免费用于个人和商业使用的 Bootstrap、Angular、React 和 Vue UI 工具包，拥有 700 多个组件、精美的模板、1 分钟安装、广泛的教程和庞大的社区。
  ...
  * [Scrollbar.app](https://scrollbar.app)——用于设计自定义滚动条的简单免费网络应用程序。
  * [css.glass](https://css.glass/)——使用 CSS 创建玻璃形态设计的免费网络应用程序。
  * [hypercolor.dev](https://hypercolor.dev/)——Tailwind CSS 颜色渐变的精选集合，还提供各种生成器来创建自己的渐变。
  * [iconify.design](https://icon-sets.iconify.design/)——一个超过 100 个图标的集合，具有统一的界面。允许您在包中搜索图标并将单个图标导出为 SVGs 或用于流行的 Web 框架。
  ...
  * [Webstudio](https://webstudio.is/)——Webflow 的开源替代方案。免费计划在其域名上提供无限数量的网站。五个网站使用自定义域名。每月十万次页面浏览量。2GB 资产存储。
...
## 设计灵感
  ...
  * [Landings](https://landings.dev/) - [网页截图]根据你的喜好，找到最适合你设计灵感的最佳着陆页。
  * [Lapa Ninja](https://www.lapa.ninja/) - [着陆页/UI 套件/网页截图]Lapa Ninja 是一个画廊，展示了最好的 6025 个着陆页示例，为设计师提供免费书籍和免费的 UI 套件。
  * [LovelyLanding.net](https://www.lovelylanding.net/) - [着陆页设计]经常更新的着陆页屏幕截图。包括桌面、平板电脑和移动设备的屏幕截图。
  ...
  * [Screenlane](https://screenlane.com/) - [移动屏幕截图]获取灵感并跟上最新的网络和移动应用程序 UI 设计趋势。可按模式和应用程序进行筛选。
  * [scrnshts](https://scrnshts.club/) - [移动屏幕截图]精心挑选的最佳应用商店设计屏幕截图集合。
  * [UI Garage](https://uigarage.net/) - [移动/网络屏幕截图]设计师和开发人员寻找灵感、工具以及项目最佳资源的日常 UI 灵感和模式。
  * [Refero](https://refero.design/) - [网络屏幕截图]从优秀的网络应用程序中标记和可搜索的设计参考集合。
...
## 地图上的数据可视化
  ...
  * [IP 地理定位](https://ipgeolocation.io/)——提供免费的开发者计划，每月有 30K 次请求。
  ...
  * [developers.arcgis.com](https://developers.arcgis.com)——用于地图、地理空间数据存储、分析、地理编码、路由等的 API 和 SDK，适用于网络、桌面和移动设备。每月免费提供 200 万张基础地图瓦片、20,000 个未存储的地理编码、20,000 条简单路线、5,000 次驾车时间计算以及 5GB 免费的图块+数据存储。
  * [Foursquare](https://developer.foursquare.com/)——从 Places API 和 Pilgrim SDK 中获取位置发现、场地搜索和上下文感知内容。
  * [geoapify.com](https://www.geoapify.com/)——提供矢量和光栅地图瓦片、地理编码、地点、路由、等距线 API。每天免费请求 3,000 次。
  * [geocod.io](https://www.geocod.io/)——通过 API 或 CSV 上传进行地理编码。每天免费查询 2,500 次。
  ...
  * [locationiq.com](https://locationiq.com/)——地理编码、地图和路由 API。每天免费 5,000 次请求。
  ...
  * [nextbillion.ai](https://nextbillion.ai/)——与地图相关的服务：地理编码、导航（方向、路由、路线优化、距离矩阵）、地图 SDK（矢量、静态、移动 SDK）。[免费提供指定配额](https://nextbillion.ai/pricing)给每个服务。
  * [opencagedata.com](https://opencagedata.com)——地理编码 API，聚合了 OpenStreetMap 和其他开放地理源。每天免费查询 2,500 次。
  * [osmnames](https://osmnames.org/)——地理编码，根据相关维基百科页面的受欢迎程度对搜索结果进行排名。
  * [positionstack](https://positionstack.com/)——免费对全球地点和坐标进行地理编码。每月个人使用的请求为 25,000 次。
  * [stadiamaps.com](https://stadiamaps.com/)——地图瓦片、路由、导航和其他地理空间 API。每天非商业使用和测试的免费地图视图和 API 请求为 2,500 次。
...
## 集成开发环境（IDE）和代码编辑
  ...
  * [AndroidIDE](https://m.androidide.com/) - 在 Android 设备上开发真正基于 Gradle 的 Android 应用程序的开源 IDE。
  * [Apache Netbeans](https://netbeans.apache.org/) - 开发环境、工具平台和应用程序框架。
  * [apiary.io](https://apiary.io/) - 具有即时 API 模拟和生成文档的协作式设计 API（对于一个管理员帐户和托管文档，免费提供无限的 API 蓝图和无限用户）。
  * [BBEdit](https://www.barebones.com/) - BBEdit 是一款适用于 macOS 的流行且可扩展的编辑器。免费模式提供了强大的核心功能集[https://www.barebones.com/products/bbedit/comparison.html]和升级到高级功能的路径。
  * [Binder](https://mybinder.org/) - 将 Git 存储库转换为一组交互式笔记本。这是一项免费的公共服务。
  * [BlueJ](https://bluej.org) - 一款免费的 Java 开发环境，专为初学者设计，全球有数百万用户使用。由甲骨文提供支持，具有简单的 GUI 可帮助初学者。
  ...
  * [Cody](https://sourcegraph.com/cody) - 免费的人工智能编码助手，可以编写（代码块、自动完成、单元测试）、理解（整个代码库的知识）、修复和查找代码。适用于 VS Code、JetBrains 和在线使用。
  * [codiga.io](https://codiga.io/) - 编码助手，可让您在 IDE 中直接搜索、定义和重用代码片段。个人和小组织免费使用。
  * [codesnip.com.br](https://codesnip.com.br) - 具有类别、搜索和标签的简单代码片段管理器。免费且无限。
  * [cocalc.com](https://cocalc.com/) - （以前在 cloud.sagemath.com 上的 SageMathCloud）- 云协作计算。浏览器访问带有内置协作功能的完整 Ubuntu，以及大量免费的数学、科学、数据科学软件，预安装：Python、LaTeX、Jupyter Notebooks、SageMath、scikitlearn 等。
  * [code.cs50.io](https://code.cs50.io/) - 适用于 CS50 的 Visual Studio Code 是 code.cs50.io 上的网络应用程序，它适用于学生和教师的 GitHub Codespaces。
  * [codepen.io](https://codpen.io/) - CodePen 是前端网络的游乐场。
  ...
  * [Eclipse Che](https://www.eclipse.org/che/) - 适用于开发团队的基于 Web 和 Kubernetes 的多语言 IDE。开源且由社区驱动。红帽提供的在线实例可在[https://workspaces.openshift.com](https://workspaces.openshift.com/)上使用。
  * [fakejson.com](https://fakejson.com/) - FakeJSON 通过其 API 帮助您快速生成虚假数据。发送描述您想要的内容和方式的 API 请求。API 以 JSON 格式返回所有内容。加快创意的推向市场进程，先假后真。
  * [GetVM](https://getvm.io) - 即时免费的 Linux 和 IDE 铬边栏。免费层包括每天 5 个 VM。
  * [GitPod](https://www.gitpod.io) - 用于 GitHub 项目的即时、随时可用的开发环境。免费层包括每月 50 小时。
  ...
  * [jsbin.com](https://jsbin.com) - JS Bin 是前端网络（HTML、CSS 和 JavaScript）的另一个游乐场和代码共享网站。它还支持 Markdown、Jade 和 Sass。
  * [jsfiddle.net](https://jsfiddle.net/) - JS Fiddle 是前端网络的游乐场和代码共享网站，支持协作。
  ...
  * [mockable.io](https://www.mockable.io/) - 一个简单的可配置服务，用于模拟 RESTful API 或 SOAP Web 服务。此在线服务允许您快速定义 REST API 或 SOAP 端点，并让它们返回 JSON 或 XML 数据。
  * [mockaroo](https://mockaroo.com/) - Mockaroo 允许您以 CSV、JSON、SQL 和 Excel 格式生成逼真的测试数据。您还可以为后端 API 创建模拟。
  * [Mocklets](https://mocklets.com) - 基于 HTTP 的模拟 API 模拟器，可帮助模拟 API 以实现更快的并行开发和更全面的测试，具有免费终身层。
  * [Paiza](https://paiza.cloud/en/) - 在浏览器中开发 Web 应用程序，无需设置任何内容。免费计划提供一个服务器，具有 24 小时的生命周期，每天运行 4 小时，具有 2 个 CPU 内核、2GB RAM 和 1GB 存储。
  * [Prepros](https://prepros.io/) - Prepros 可以开箱即用编译 Sass、Less、Stylus、Pug/Jade、Haml、Slim、CoffeeScript 和 TypeScript，刷新浏览器，使开发和测试您的网站变得容易，这样您就可以专注于使它们变得完美。您还可以通过点击几下添加自己的工具。
  * [Replit](https://replit.com/) - 用于各种编程语言的云编码环境。
  * [SoloLearn](https://code.sololearn.com) - 适合运行代码片段的云编程游乐场。支持各种编程语言。运行代码不需要注册，但在其平台上保存代码时需要注册。还为初学者和中级编码人员提供免费课程。
  ...
  * [WebComponents.dev](https://webcomponents.dev/) - 在浏览器中隔离编写 Web 组件的 IDE，提供 58 个可用模板，支持故事和测试。
  * [PHPSandbox](https://phpsandbox.io/) - PHP 的在线开发环境
  * [WebDB](https://webdb.app) - 免费高效的数据库 IDE。具有服务器发现、ERD、数据生成器、人工智能、NoSQL 结构管理器、数据库版本控制等众多功能。
...
## 分析、事件和统计
  ...
  * [Avo](https://avo.app/)——简化的分析发布工作流程。单一来源的跟踪计划、类型安全的分析跟踪库、应用内调试器和数据可观测性，可在发布前捕获所有数据问题。免费提供给两个工作区成员和 1 小时的数据可观测性回溯。
  ...
  * [Clicky](https://clicky.com)——网站分析平台。免费计划适用于一个网站，每月有 3000 次分析。
  * [Databox](https://databox.com)——通过结合其他分析和 BI 平台提供业务洞察和分析。免费计划提供 3 个用户、仪表板和数据源。1100 万条历史数据记录。
  * [Hitsteps.com](https://hitsteps.com/)——每月 2000 次页面浏览量，适用于一个网站
  * [amplitude.com](https://amplitude.com/)——每月 100 万次事件，最多 2 个应用
  * [GoatCounter](https://www.goatcounter.com/)——GoatCounter 是一个开源的网络分析平台，可作为托管服务（免费供非商业使用）或自托管应用程序使用。它旨在提供易于使用和有意义的隐私友好型网络分析，作为 Google Analytics 或 Matomo 的替代方案。免费层适用于非商业用途，包括无限网站、六个月的数据保留和每月 10 万次页面浏览量。
  * [Google Analytics](https://analytics.google.com/)——Google Analytics
  * [MetricsWave](https://metricswave.com)——面向开发人员的隐私友好型 Google Analytics 替代方案。免费计划允许每月 20k 页面浏览量，无需信用卡。
  ...
  * [Hotjar](https://hotjar.com)——网站分析和报告。免费计划允许每天 2000 次页面浏览量。每天一百个快照（最大容量：300）。可以存储三个快照热图 365 天。无限的团队成员。还包括应用内调查和带有屏幕截图的反馈小部件。免费层允许创建 3 个调查和 3 个反馈小部件，每月收集 20 次响应。
  ...
  * [Mixpanel](https://mixpanel.com/)——每月 10 万跟踪用户，无限数据历史和席位，美国或欧盟数据驻留
  ...
  * [Microsoft PowerBI](https://powerbi.com)——由 Microsoft 提供的业务洞察和分析。免费计划提供有限使用，用户许可证为 100 万。
  * [quantcast.com](https://www.quantcast.com/products/measure-audience-insights/)——无限免费分析
  * [Row Zero](https://rowzero.io) - 快速连接的电子表格。直接连接到数据库、S3 和 API。导入、分析、绘制和共享数百万行数据。三个免费（永久）工作簿。
  * [sematext.com](https://sematext.com/cloud/)——每月最多 50K 次操作，1 天数据保留，无限仪表板、用户等。
  ...
  * [Statsig](https://statsig.com) - 涵盖分析、功能标志和 A/B 测试的一体化平台。免费提供高达每月 100 万次计量事件。
  ...
  * [counter.dev](https://counter.dev)——简单易用的网络分析，注重隐私。免费或按您的意愿通过捐赠支付。
  * [PostHog](https://posthog.com) - 完整的产品分析套件，每月最多 100 万次跟踪事件免费。还提供每月 250 次响应的无限应用内调查。
  * [Uptrace](https://uptrace.dev) - 分布式跟踪工具，可帮助开发人员找出故障并找到性能瓶颈。有免费计划，为开源项目提供免费的个人订阅，并且有开源版本。
  * [Microsoft Clarity](https://clarity.microsoft.com/) - Microsoft 易于使用的工具，用于捕获真实用户如何使用您的网站。
  * [Beampipe.io](https://beampipe.io) - 简单、注重隐私的网络分析。免费适用于最多 5 个域和每月 10k 次页面浏览量。
  * [Aptabase](https://aptabase.com)——开源、隐私友好且简单的移动和桌面应用分析。适用于 Swift、Kotlin、React Native、Flutter、Electron 等的 SDK。免费提供每月最多 20,000 次事件。
  * [Trackingplan](https://www.trackingplan.com/)——自动检测数字分析、营销数据和像素问题，维护最新的跟踪计划，并促进无缝协作。可以将其部署到您的生产环境中，也可以在不编写代码的情况下向回归测试添加分析覆盖范围。
  * [LogSpot](https://logspot.io) - 完整统一的网络和产品分析平台，包括可嵌入的分析小部件和自动化机器人（slack、telegram 和 webhooks）。免费计划包括每月 10,000 次事件。
  * [Umami](https://umami.is/)——简单、快速、注重隐私的开源替代方案，适用于 Google Analytics。
  * [TrackWith Dicloud](https://dicloud.net/trackwith-privacy-focused-analytics/) - Google Analytics 的免费轻量级隐私关注替代方案。无限制的页面浏览量，无限制的访问者，无限制的页面热点图和目标跟踪。免费适用于最多 3 个域和每个域 600 次会话回放。
  * [AppFit](https://appfit.io) - AppFit 是一个全面的分析和产品管理工具，旨在促进跨平台管理分析和产品更新的无缝连接。免费计划包括每月 10,000 次事件、产品日记和每周洞察。

**[⬆️ 返回顶部](#目录)**

## 访客会话记录

  * [Reactflow.com](https://www.reactflow.com/) - 按站点：每天 1000 页浏览量，三个热图，三个小部件，免费错误跟踪
  * [OpenReplay.com](https://www.openreplay.com) - 开源会话重放，具有用于错误重现的开发工具，实时会话支持，以及产品分析套件。每月一千个会话，访问所有功能，保留七天。
  * [LogRocket.com](https://www.logrocket.com) - 每月一千个会话，保留三十天，错误跟踪，实时模式
  ...
  * [hotjar.com](https://www.hotjar.com/) - 按站点：每月 1050 页浏览量，无限制热图，数据存储三个月
  ...
  * [smartlook.com](https://www.smartlook.com/) - 网络和移动应用的免费套餐（每月 1500 次会话），三个热图，一个漏斗，一个月的数据历史
...
## 支付和计费集成
  ...
  * [Qonversion](http://qonversion.io/)——一体化跨平台订阅管理平台，提供分析、A/B 测试、Apple Search Ads、远程配置和增长工具，用于优化应用内购买和货币化。与 iOS、Android、React Native、Flutter、Unity、Cordova、Stripe 和网络兼容。每月跟踪收入免费至$10k。
  * [ParityVend](https://www.ambeteco.com/ParityVend/)——根据访问者的位置自动调整价格，以扩大您的全球业务并进入新市场（购买力平价）。免费计划包括 7,500 个 API 请求/月。
  * [Glassfy](https://glassfy.io/)——应用内订阅基础架构，实时订阅事件和即开即用的货币化工具，适用于 iOS、Android、Stripe 和 Paddle。每月免费收入最高可达$10k。
  * [Adapty.io](https://adapty.io/)——用于移动应用内订阅集成到 iOS、Android、React Native、Flutter、Unity 或网络应用的一站式解决方案，带有开源 SDK。每月免费收入最高可达$10k。
  * [CoinMarketCap](https://coinmarketcap.com/api/)——提供加密货币市场数据，包括最新的加密和法定货币汇率。免费层提供 10K 调用信用/月。
  * [CurrencyFreaks](https://currencyfreaks.com/)——提供当前和历史货币汇率。免费的 DEVELOPER 计划可用，每月有 1000 个请求。
  * [CoinGecko](https://www.coingecko.com/en/api)——提供加密货币市场数据，包括最新的加密货币汇率和历史数据。演示 API 提供稳定的每分钟 30 次调用限制和每月 10,000 次调用上限。
  * [CurrencyApi](https://currencyapi.net/)——用于物理和加密货币的实时货币汇率，以 JSON 和 XML 形式提供。免费层提供每月 1,250 个 API 请求。
  * [currencylayer](https://currencylayer.com/)——为您的企业提供可靠的汇率和货币转换，每月免费 100 个 API 请求。
  * [exchangerate-api.com](https://www.exchangerate-api.com)——易于使用的货币转换 JSON API。免费层每天更新一次，每月限制为 1,500 个请求。
  ...
  * [Moesif API 货币化](https://www.moesif.com/)——通过基于使用的计费从 API 产生收入。连接到 Stripe、Chargebee 等。免费层每月提供 30,000 个事件。
  * [Nami ML](https://www.namiml.com/)——适用于 iOS 和 Android 的应用内购买和订阅的完整平台，包括无代码支付墙、CRM 和分析。免费用于运行 IAP 业务的所有基本功能。
  * [RevenueCat](https://www.revenuecat.com/)——应用内购买和订阅的托管后端（iOS 和 Android）。免费至每月跟踪收入$2.5k。
  * [vatlayer](https://vatlayer.com/)——即时 VAT 号码验证和欧盟 VAT 税率 API，每月免费 100 个 API 请求。
...
## 开发博客网站
  ...
  * [BearBlog](https://bearblog.dev/) - 一款简洁的、基于 Markdown 的博客和网站构建工具。
...
## 评论平台
  ...
  * [Remarkbox](https://www.remarkbox.com/) - 开源托管评论平台，你可以为“在几个域上有一位管理员，完全控制行为和外观”支付你所能承受的费用
...
## 屏幕截图API
  ...
  * [ApiFlash](https://apiflash.com) - 一个基于 Aws Lambda 和 Chrome 的截图 API。可处理整页截图、捕捉时间和viewport 尺寸。
  * [microlink.io](https://microlink.io/) - 它将任何网站转换为数据，例如元标记规范化、美化链接预览、抓取功能或截图服务。每天免费提供 250 次请求。
  ...
  * [PhantomJsCloud](https://PhantomJsCloud.com) - 浏览器自动化和页面渲染。免费层每天最多提供 500 页。自 2017 年以来一直提供免费层。
  * [Webshrinker.com](https://webshrinker.com) - Web Shrinker 提供网站截图和域名智能 API 服务。每月免费 100 次请求。
  * [Httpic.com](https://httpic.com) - 将任何网站转换为 jpg、png 或 pdf。捕获整页截图，调整viewport，并注入自定义代码。免费层每月 150 张图像。
...
## 与Flutter相关和无需Mac即可构建IOS应用程序
  ...
  * [CodeMagic](https://codemagic.io/) - CodeMagic 是一个完全托管和管理的移动应用程序持续集成/持续部署（CI/CD）服务。您可以使用基于图形界面的 CI/CD 工具进行构建、测试和部署。免费套餐提供 500 分钟/月的免费时长和一个配备 2.3GHz 处理器和 8GB 内存的 Mac Mini 实例。
...
## 隐私管理
  ...
  * [Bearer](https://www.bearer.sh/) - 通过审计和持续工作流程帮助实现隐私设计，使组织符合 GDPR 等法规。免费层限于较小的团队，SaaS 版本也是如此。
  * [Osano](https://www.osano.com/) - 包含从 GDPR 代表到 cookie 横幅的同意管理和合规平台。免费层提供基本功能。
  * [Iubenda](https://www.iubenda.com/) - 隐私和 cookie 政策及同意管理。免费层提供有限的隐私和 cookie 政策以及 cookie 横幅。
...
## 杂项
  ...
  * [Carbon.now.sh](https://carbon.now.sh) - 以美学屏幕截图类似的图像格式创建和分享代码片段。通常用于在 Twitter 或博客文章上美观地分享/炫耀代码片段。
  ...
  * [fullcontact.com](https://www.fullcontact.com/developer/pricing/) — 通过向您的应用添加社交个人资料，帮助您的用户更多地了解他们的联系人。500 个免费个人 API 匹配/月
  ...
  * [kandi](https://kandi.openweaver.com/) — 加速应用程序开发：通过代码片段和开源库的重用，更快地构建自定义函数、用例和完整的应用程序。
  * [Base64 解码器/编码器](https://devpal.co/base64-decode/) — 在线免费工具，用于解码/编码数据。
  ...
  * [QuickType.io](https://quicktype.io/) - 从 JSON、模式和 GraphQL 快速自动生成任何编程语言中数据的模型/类/类型/接口和序列化程序。将 JSON 转换为任何语言的漂亮、类型安全的代码。
  * [RandomKeygen](https://randomkeygen.com/) - 一个免费的移动友好工具，提供各种随机生成的密钥和密码，可用于保护任何应用程序、服务或设备。
  * [ray.so](https://ray.so/) - 创建代码片段的美丽图像。
  * [readme.com](https://readme.com/) — 易于使用的精美文档，开源免费。
  ...
  * [Versionfeeds](https://versionfeeds.com) — 您喜爱的软件版本的自定义 RSS 饲料。拥有您编程语言、库或喜爱工具的最新版本在一个饲料中。（前 3 个饲料是免费的）
...
## 远程桌面工具
  ...
  * [Getscreen.me](https://getscreen.me)——免费供 2 台设备使用，对会话数量和时长没有限制
...
## 游戏开发
  ...
  * [LoSpec](https://lospec.com/)——用于创建像素艺术和其他限制性数字艺术的在线工具，有很多教程/调色板列表可供选择，用于您的游戏。
  * [ArtStation](https://www.artstation.com/)——免费/付费的 2D、3D 资产和音频、图标、平铺集、游戏工具包的市场。也可以用于展示您的艺术作品集。
...
## 其他免费资源
  ...
  * [get.localhost.direct](https://get.localhost.direct) - 更好的`*.localhost.direct`通配符公共 CA 签名的 SSL 证书，用于支持子域的本地主机开发。
  ...
  * [GitHub 教育](https://education.github.com/pack) - 学生免费使用的一系列服务。需要注册。
  * [Markdown 工具](https://markdowntools.com) - 将 HTML、CSVs、PDF、JSON 和 Excel 文件转换为和从 Markdown 的工具。
  * [微软 365 开发者计划](https://developer.microsoft.com/microsoft-365/dev-program) - 获得免费沙盒、工具和其他资源，以构建适用于微软 365 平台的解决方案。该订阅是 90 天的[微软 365 E5 订阅](https://www.microsoft.com/microsoft-365/enterprise/e5)（不包括 Windows），可续订。如果您积极参与开发（通过遥测数据和算法衡量），则会续订。
  ...
  * [SimpleBackups.com](https://simplebackups.com/) - 直接存储到云存储提供商（AWS、DigitalOcean 和 Backblaze）的服务器和数据库（MySQL、PostgreSQL、MongoDB）的备份自动化服务。提供一个免费计划，可进行 1 次备份。
  * [SnapShooter](https://snapshooter.com/) - 适用于 DigitalOcean、AWS、LightSail、Hetzner 和 Exoscale 的备份解决方案，支持直接对数据库、文件系统和应用程序进行备份到基于 s3 的存储。提供一个免费计划，每天备份一个资源。
  * [Themeselection](https://themeselection.com/) - 精选高质量、现代设计、专业且易于使用的免费管理仪表板模板、HTML 主题和 UI 工具包，以更快地创建应用程序！
  * [Web.Dev](https://web.dev/measure/) - 这是一个免费工具，可让您查看网站的性能并改善 SEO，以在搜索引擎中获得更高的排名。
  * [SmallDev.tools](https://smalldev.tools/) - 一款免费的开发者工具，允许您对各种格式进行编码/解码、HTML/CSS/Javascript 压缩、美化、生成假/测试数据集（JSON/CSV 等）以及许多其他功能。具有令人愉快的界面。
  * [UseCSV by Layercode](https://layercode.com/usecsv) - 在几分钟内将 CSV 和 Excel 导入您的网络应用程序。为您的用户提供愉快且强大的数据导入体验。免费开始，无需任何信用卡详细信息，今天就开始集成 UseCSV。您可以创建无限的导入器并上传最大 100Mb 的文件。
  ...
  * [360Converter](https://www.360converter.com/) - 免费层级有用网站，可转换：视频转文本&&音频转文本&&语音转文本&&实时音频转文本&&YouTube 视频转文本&&添加视频字幕。在短视频转换或简短的 youtube 教程中可能会有所帮助：)
  * [QRCodeBest](https://qrcode.best/) - 使用 13 个模板创建自定义 QR 码，具有完全隐私和个人品牌。功能包括跟踪像素、项目分类和无限团队座位。
  * [PostPulse](https://post-pulse.io) - 通过每月 AI 制作的帖子提升在线存在，增强 SEO 和网站排名，优化到 SEO 优化的域。免费计划允许您每月在我们的网站上手动发布一篇帖子。
  * [PageTools](https://pagetools.co/) - 提供一套永久免费的人工智能驱动工具，帮助您生成基本的网站政策，使用简单的一键界面创建社交媒体个人资料、帖子和网页。
  * [MySQL Visual Explain](https://mysqlexplain.com) - 易于理解和免费的 MySQL EXPLAIN 输出可视化工具，可优化慢速查询。
  * [Killer Coda](https://killercoda.com/) - 在您的浏览器中进行交互的游乐场，用于学习 Linux、Kubernetes、容器、编程、DevOps、网络
