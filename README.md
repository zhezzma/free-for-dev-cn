...
开发人员和开源作者现在有很多提供免费层级的服务，但找到它们都需要时间来做出明智的决策。

这是一个包含免费开发者层级的软件（SaaS、PaaS、IaaS 等）和其他产品的列表。

这个特定列表的范围仅限于基础设施开发人员（系统管理员、DevOps 从业者等）可能会发现有用的东西。我们喜欢那里所有的免费服务，但保持主题不变会很好。有时候这是一条灰色的线，所以这是有倾向性的；如果我不接受你的贡献，请不要感到冒犯。

这份清单是通过拉取请求、评论、想法和 1600 多人的工作得出的。你也可以通过发送[拉取请求](https://github.com/ripienaar/free-for-dev)来添加更多服务或删除那些提供的产品已经更改或已退役的服务。

[![跟踪精彩列表](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/ripienaar/free-for-dev)

**注意**：此列表仅适用于即服务产品，不适用于自托管软件。要符合条件，服务必须提供免费层级，而不仅仅是免费试用。如果是时间限制的免费层级，必须至少为一年。我们还从安全角度考虑免费层级，因此单点登录是可以的，但我不会接受将 TLS 限制为仅付费层级的服务。
...
## 主要云服务提供商的免费服务限制
  ...
  * [Oracle Cloud](https://www.oracle.com/cloud/)
    * 计算
       ...
       - 实例在被视为空闲时将被回收[](https://docs.oracle.com/en-us/iaas/Content/FreeTier/freetier_topic-Always_Free_Resources.htm#compute__idleinstances)
    * 块卷 - 2 个卷，总计 200GB（用于计算）
    * 对象存储 - 10GB
    * 负载均衡器 - 1 个实例，带宽为 10Mbps
  ...
  * [Cloudflare](https://www.cloudflare.com/)
    ...
    * [Pages](https://developers.cloudflare.com/pages/) - 在 Cloudflare 的快速、安全的全球网络上开发和部署您的 Web 应用程序。每月五百次构建，100 个自定义域，集成 SSL，无限可访问席位，无限预览部署，以及通过 Cloudflare Workers 集成的全栈功能。
...
## 云管理解决方案
  ...
  * [Brainboard](https://www.brainboard.co) - 用于可视化构建和管理端到端云基础架构的协作解决方案。
  * [Cloud 66](https://www.cloud66.com/) - 个人项目免费（包括一个部署服务器，一个静态站点），Cloud 66 为您提供在任何云上构建、部署和扩展应用程序所需的一切，而无需头疼“服务器相关问题”。
  ...
  * [deployment.io](https://deployment.io) - Deployment.io 帮助开发人员在 AWS 上自动化部署。在我们的免费层中，开发人员（单个用户）可以免费部署无限数量的静态站点、Web 服务和环境。我们每月提供 20 次免费的作业执行，其中包括预览和自动部署。
...
## 源代码存储库
  ...
  * [Codeberg](https://codeberg.org/)——无限数量的公共和私人 Git 存储库，免费且适用于开源项目（无限制协作者）。由[Forgejo](https://forgejo.org/)提供支持。提供静态网站托管[Codeberg Pages](https://codeberg.page/)。提供 CI/CD 托管[Codeberg 的 CI](https://docs.codeberg.org/ci/)。提供翻译托管[Codeberg Translate](https://translate.codeberg.org/)。包括包和容器托管、项目管理和问题跟踪
  ...
  * [gitlab.com](https://about.gitlab.com/)——无限数量的公共和私人 Git 存储库，最多可容纳 5 名协作者。包括 CI/CD、静态托管、容器注册表、项目管理和问题跟踪
  ...
  * [NotABug](https://notabug.org)——NotABug.org 是一个免费的软件协作平台，适用于自由许可的项目，基于 Git
  ...
  * [pijul.com](https://pijul.com/)——无限数量的免费和开源分布式版本控制系统。其独特之处在于基于可靠的补丁理论，易于学习、使用和分发。解决了 git/hg/svn/darcs 的许多问题。
  ...
  * [savannah.gnu.org](https://savannah.gnu.org/)——作为免费软件项目（适用于 GNU 项目）的协作软件开发管理系统
  * [savannah.nongnu.org](https://savannah.nongnu.org/)——作为免费软件项目（适用于非 GNU 项目）的协作软件开发管理系统
...
## API、数据和ML
  ...
  * [Zerosheets](https://zerosheets.com) - 将 Google 表格电子表格转换为强大的 API，以快速开发原型、网站、应用程序等。每月免费提供 500 次请求。
  ...
  * [Apify](https://www.apify.com/) - 网络抓取和自动化平台，可为任何网站创建 API 并提取数据。提供即用型抓取程序、集成代理和自定义解决方案。每月包含 5 美元平台信用额度的免费计划。
  ...
  * [APIVerve](https://apiverve.com) - 免费获得超过 120 个 API，注重质量、一致性和可靠性。免费计划每月覆盖最多 50 个 API 令牌。
  * [Arize AI](https://arize.com/) - 用于模型监控和根本原因分析的机器学习可观测性，例如数据质量和性能漂移。免费最多两个模型。
  * [Atlas toolkit](https://atlastk.org/) - 用于开发单页 Web 应用程序的轻量级库，可立即访问。适用于 Java、Node.js、Perl、Python 和 Ruby。
  * [Beeceptor](https://beeceptor.com) - 在几秒钟内模拟 REST API，伪造 API 响应等。每天免费 50 次请求，公共仪表板，开放端点（任何拥有仪表板链接的人都可以查看提交和答案）。
  * [bigml.com](https://bigml.com/) - 托管机器学习算法。开发免费，无限制的任务，数据/任务限制为 16MB。
  * [Browse AI](https://www.browse.ai) - 网络上的数据提取和监控。每月免费 50 个积分。
  ...
  * [Cloudmersive](https://cloudmersive.com/) - 实用 API 平台，可全面访问包括文档转换、病毒扫描等在内的广泛 API 库，每月 800 次调用。
  ...
  * [Coupler](https://www.coupler.io/) - 用于在应用程序之间同步数据的集成工具。它可以创建实时仪表板和报告，转换和操作值，并收集和备份见解。免费计划具有无限用户，每月 100 次运行，每次运行 1000 行，以及无限集成。
  ...
  * [Geekflare API](https://geekflare.com/api)——Geekflare API 允许您抓取屏幕截图、审核网站、TLS 扫描、DNS 查找、测试 TTFB 等。免费计划提供 3,000 次 API 请求。
  ...
  * [Glitterly](https://glitterly.app/)——从基础模板动态生成图像的程序。Restful API 和无代码集成。免费层每月提供 50 张图像和五个模板。
  * [GoodData](https://www.gooddata.com/)——数据即服务——创建互动和有洞察力的仪表板。免费层包含五个工作区和 100MB/工作区。
  * [Hex](https://hex.tech/)——一个用于笔记本、数据应用程序和知识库的协作数据平台。免费社区版最多可容纳 3 位作者和 5 个项目。每位作者一个计算配置文件，内存为 4GB。
  * [Hook0](https://www.hook0.com/)——Hook0 是一个开源的 Webhooks-as-a-service (WaaS)，它使在线产品提供 Webhooks 变得容易。免费提供 7 天历史记录保留，每月最多可调度 3,000 个事件。
  ...
  * [Invantive Cloud](https://cloud.invantive.com/)——访问超过 70 个（云）平台，如 Exact Online、Twinfield、ActiveCampaign 或 Visma，使用 Invantive SQL 或 OData4（通常是 Power BI 或 Power Query）。包括数据复制和交换。开发人员和实施顾问的免费计划。对于特定平台，免费使用，但数据量有限制。
  ...
  * [IP2Location.io](https://www.ip2location.io/)——免费增值、快速可靠的 IP 地理定位 API，可确定城市、坐标、ISP 等地理定位数据。免费计划每月提供 30k 信用。订阅付费计划以获得更多高级功能或联系我们获取个性化计划。
  * [ipapi](https://ipapi.co/)——由 Kloudend, Inc 提供的 IP 地址位置 API——基于 AWS 的可靠地理定位 API，受到 Fortune 500 的信任。免费层提供每月 30k 次查找（每天 1k 次），无需注册。
  * [ipapi.is](https://ipapi.is/)——适用于开发人员的可靠 IP 地址 API——具有最佳托管检测功能的开发人员的免费计划，每月提供 1000 次查找，无需注册。
  * [IPinfo](https://ipinfo.io/)——快速、准确和免费（每月最多 50k）的 IP 地址数据 API。提供有关地理位置、公司、运营商、IP 范围、域、滥用联系人等的 API。所有付费 API 都可以免费试用。
  * [BigDataCloud](https://www.bigdatacloud.com/)——提供快速、准确和免费（无限或每月 10K-50K）的现代网络 API，如 IP 地理定位、反向地理编码、网络洞察、电子邮件和电话验证、客户端信息等。
  ...
  * [JSON Serve](https://jsonserve.com/)——一个免费的服务，帮助开发人员存储 JSON 对象，并在其应用中使用该 JSON 作为 REST API。
  ...
  * [Meteosource 天气 API](https://www.meteosource.com/)——全球天气 API，提供当前和预测天气数据。预测基于机器学习对多个天气模型的组合，以提高准确性。免费计划每天提供 400 次调用。
  ...
  * [Duply.co](https://duply.co)——从 API 和 URL 创建动态图像，设计模板一次并重复使用。免费层每月提供 70 个 API 和 URL 创建的图像以及最多 100 个通过表单创建的图像。
  ...
  * [Postman](https://postman.com)——用于设计和测试 API 的协作平台，可简化工作流程并加快速度。免费使用 Postman 应用程序。Postman 云功能也免费提供，并有一定的限制。
  ...
  * [Crawlbase](https://crawlbase.com/)——无需代理、基础设施或浏览器即可抓取和抓取网站。我们为您解决验证码问题，并防止您被阻止。前 1000 次调用免费。
  ...
  * [QuickMocker](https://quickmocker.com/)——管理自己子域下的在线虚假 API 端点，将请求转发到本地主机 URL 进行 Webhooks 开发和测试，使用 RegExp 和多种 HTTP 方法进行 URL 路径，对端点进行优先级排序，每个端点超过 100 个短代码（动态或虚假响应值）用于响应模板，从 OpenAPI（Swagger）规范以 JSON 格式导入，代理请求，根据 IP 地址和授权标头限制端点。免费帐户提供一个随机子域、十个端点、5 个 RegExp URL 路径、每个端点 50 个短代码、每天 100 个请求和请求日志中的 50 个历史记录。
  * [Rapidapi](https://rapidapi.com/)——世界上最大的 API 中心数百万开发人员查找并连接到数千个 API，使用有趣的挑战（和解决方案！）和交互式示例进行 API 开发。
  ...
  * [Scraper's Proxy](https://scrapersproxy.com)——简单的 HTTP 代理 API，用于抓取。匿名抓取，无需担心限制、阻止或验证码。每月前 100 次成功抓取免费，包括 JavaScript 渲染（如果您联系支持人员，更多可用）。
  * [ScrapingAnt](https://scrapingant.com/)——无头 Chrome 抓取 API 和免费检查的代理服务。JavaScript 渲染、优质旋转代理、验证码回避。提供免费计划。
  * [ScraperBox](https://scraperbox.com/)——使用真实的 Chrome 浏览器和代理轮换进行不可检测的网络抓取 API。使用简单的 API 调用抓取任何网页。免费计划每月有 1000 次请求。
  * [ScrapingDog](https://scrapingdog.com/)——Scrapingdog 处理数百万个代理、浏览器和验证码，为您提供任何网页的 HTML，只需一个 API 调用。它还包括适用于 Chrome 和 Firefox 的 Web Scraper 和用于即时抓取需求的软件。提供免费计划。
  ...
  * [Select Star](https://www.selectstar.com/)——是一个智能数据发现平台，可自动分析和记录您的数据。免费轻量级版，包含 1 个数据源、最多 100 个表和 10 个用户。
  * [Sheetson](https://sheetson.com)——立即将任何 Google Sheets 转换为 RESTful API。提供免费计划。
  * [Shipyard](https://www.shipyardapp.com)——用于云的低代码数据编排平台。使用混合的低代码模板和您的代码（Python、Node.js、Bash、SQL）构建。我们的免费开发者计划为每个用户每月提供 10 小时的运行时间——足以自动化多个工作流程。
  ...
  * [Sofodata](https://www.sofodata.com/)——从 CSV 文件创建安全的 RESTful API。上传 CSV 文件并通过其 API 立即访问数据，从而加快应用程序开发速度。免费计划包括 2 个 API 和每月 2500 次 API 调用。您无需信用卡。
  ...
  * [huggingface.co](https://huggingface.co)——用于 Pytorch、TensorFlow 和 JAX 的 NLP 模型的构建、训练和部署。免费高达 30k 输入字符/月。
  ...
  * [ERD Lab](https://www.erdlab.io)——免费的基于云的开发人员实体关系图 (ERD) 工具。
  ...
  * [Zuplo](https://zuplo.com/)——在任何 API 中添加 API 密钥身份验证、速率限制和开发人员文档，只需几分钟。免费计划提供最多 10 个项目、无限的生产边缘环境、250 个 API 密钥、100K 每月请求和 1GB 出口。
...
## 工件存储库
  ...
  * [Artifactory](https://jfrog.com/start-free/) - 一个支持多种包格式的工件存储库，如 Maven、Docker、Cargo、Helm、PyPI、CocoaPods 和 GitLFS。它包含包扫描工具 XRay 和 CI/CD 工具 Pipelines（以前称为 Shippable），每月有 2,000 分钟的免费 CI/CD 分钟数。
...
## 团队和协作工具
  ...
  * [Braid](https://www.braidchat.com/) - 专为团队设计的聊天应用程序。公共访问组免费，无限用户、历史记录和集成。它还提供了一个自托管的开源版本。
  * [cally.com](https://cally.com/) - 找到会议的完美时间和日期。简单易用，适用于大小群组。
  * [Calendly](https://calendly.com) - Calendly 是连接和安排会议的工具。免费计划为每个用户提供 1 个日历连接，并且不限会议次数。还提供桌面和移动应用程序。
  ...
  * [Duckly](https://duckly.com/) - 与团队实时交谈和协作。支持 IDE 中的结对编程、终端共享、语音、视频和屏幕共享。免费供小团队使用。
  * [Dyte](https://dyte.io) - 最适合开发者的实时视频和音频 SDK，具有协作插件，可提高生产力和参与度。免费层包括每月 10,000 分钟的实时视频/音频使用。
  * [evernote.com](https://evernote.com/) - 组织信息的工具。与他人分享笔记并共同工作。
  * [Fibery](https://fibery.io/) - 连接工作区平台。免费供单个用户使用，最多 2GB 磁盘空间。
  ...
  * [Gather](https://www.gather.town/) - 在线见面的更好方式。围绕完全可定制的空间，Gather 使与您的社区共度时光就像现实生活一样容易。免费最多 10 个并发用户。
  * [gokanban.io](https://gokanban.io) - 基于语法的、无需注册的看板，可快速使用。免费无限制。
  * [flat.social](https://flat.social) - 用于团队会议和欢乐时光社交活动的交互式可定制空间。无限会议，免费最多 8 个并发用户。
  ...
  * [Hackmd.io](https://hackmd.io/) - 用于 markdown 格式文档/文件的实时协作和编写工具。就像 Google Docs 但适用于 markdown 文件。免费无限数量的“笔记”，但私人笔记和模板的协作者（邀请者）数量[将受到限制](https://hackmd.io/pricing)。
  ...
  * [ideascale.com](https://ideascale.com/) - 允许客户提交想法和投票，1 个社区中免费 25 个成员
  * [Igloo](https://www.igloosoftware.com/) - 用于共享文档、博客、日历等的内部门户。免费最多 10 个用户。
  * [Keybase](https://keybase.io/) - Keybase 是 Slack 的开源替代方案；它从家庭到社区到公司，保护每个人的聊天和文件安全。
  ...
  * [Nuclino](https://www.nuclino.com) - 一个轻量级且协作的 wiki，适用于您团队的所有知识、文档和笔记。免费计划包含所有基本功能，最多 50 个项目和 5GB 存储空间。
  ...
  * [PageShare.dev](https://www.pageshare.dev) - 在 GitHub Pull 请求中添加视觉审查功能，无需部署网站。免费最多每月 10 页和总共 100MB 存储。
  ...
  * [element.io](https://element.io/) - 基于 Matrix 的去中心化和开源通信工具。群聊、直接消息、加密文件传输、语音和视频聊天，以及与其他服务的轻松集成。
  ...
  * [Slab](https://slab.com/) - 一个现代的团队知识管理服务。免费供最多 10 个用户使用。
  ...
  * [Stickies](https://stickies.app/) - 用于头脑风暴、内容策展和笔记的可视化协作应用程序。免费供最多 3 个墙、无限用户和 1GB 存储空间使用。
  * [talky.io](https://talky.io/) - 免费的小组视频聊天。匿名。点对点。无需插件、注册或支付。
  * [Teamhood](https://teamhood.com/) - 免费的项目、任务和问题跟踪软件。支持带有泳道和完整 Scrum 实现的看板。集成了时间跟踪功能。免费供五个用户和三个项目组合使用。
  * [Teamplify](https://teamplify.com) - 通过团队分析和智能每日站立会议提高团队开发流程。包括远程优先团队的全功能假期管理。免费供最多 5 个用户的小团体使用。
  ...
  * [TimeCamp](https://www.timecamp.com/) - 免费的无限制用户时间跟踪软件。轻松与 Jira、Trello、Asana 等 PM 工具集成。
  * [Teamcamp](https://www.teamcamp.app) - 用于软件开发公司的一体化项目管理应用程序。
  * [twist.com](https://twist.com/) - 一种异步友好的团队通信应用程序，其中对话保持组织有序且主题相关。提供免费和无限制计划。有资格的团队可享受折扣。
  ...
  * [whereby.com](https://whereby.com/) - 一键式视频对话，免费（原名 appear.in）
  * [windmill.dev](https://windmill.dev/) - 一个开放源代码的开发者平台，用于从最小的 Python 和 Typescript 脚本快速构建生产级多步骤自动化和内部应用程序。作为免费用户，您最多可以创建和成为三个非高级工作空间的成员。
  * [vadoo.tv](https://vadoo.tv/) - 简单的视频托管和营销。一键上传视频。记录、管理、共享等。免费层提供多达 10 个视频、1GB 存储空间和 10GB 带宽/每月
  * [userforge.com](https://userforge.com/) - 相互关联的在线角色、用户故事和上下文映射。有助于保持设计和开发的同步，最多免费供 3 个角色和两个协作者使用。
  ...
  * [Wormhole](https://wormhole.app/) - 使用端到端加密共享文件，长达 24 小时。对于大于 5GB 的文件，它使用点对点传输直接发送您的文件。
  * [zoom.us](https://zoom.us/) - 提供安全的视频和网络会议附加组件。免费计划限制为 40 分钟。
  * [Zulip](https://zulip.com/) - 具有独特电子邮件式线程模型的实时聊天。免费计划包括 10,000 条消息搜索历史和高达 5GB 的文件存储。它还提供了一个可自托管的开源版本。
  * [robocorp.com](https://robocorp.com) - 用于推动自动化运营的开源堆栈。免费试用云功能并实施简单自动化。机器人工作 240 分钟/月，10 个助手运行，存储 100MB。
  ...
  * [Webvizio](https://webvizio.com) - 用于在直接在实时网站和网络应用程序、图像、PDF 和设计文件上进行任务的网站反馈工具、网站审查软件和错误报告工具。
  * [Pullflow](https://pullflow.com) - 在 GitHub、Slack 和 VS Code 上提供 AI 增强的代码审查协作平台。
  * [Webex](https://www.webex.com/) - 提供免费计划的视频会议，每个会议提供 40 分钟，最多 100 名与会者。
  ...
  * [Tencent RTC](https://trtc.io/) - 腾讯实时通信 (TRTC) 提供组音频/视频通话解决方案。第一年每月提供 10,000 分钟的免费分钟数。
...
## 内容管理系统（CMS）
  ...
  * [Cosmic](https://www.cosmicjs.com/) — 无头 CMS 和 API 工具包。开发者的个人计划免费。
  ...
  * [FrontAid](https://frontaid.io/) — 无头 CMS，直接将 JSON 内容存储在你的 Git 存储库中。无限制。
  ...
  * [GatsbyjsCMS](https://www.gatsbyjs.com/) - Gatsby 是快速灵活的框架，使使用任何 CMS、API 或数据库构建网站再次变得有趣。构建和部署无头网站，以增加流量、提高转化率和增加收入！
  * [Hygraph](https://hygraph.com/) - 为小型项目提供免费层级。GraphQL 优先 API。摆脱遗留解决方案，采用 GraphQL 原生无头 CMS - 并首先提供多渠道内容 API。
  * [Squidex](https://squidex.io/) - 为小型项目提供免费层级。API / GraphQL 优先。开源，基于事件源（自动处理每次更改）。
  * [InstaWP](https://instawp.com/) - 在几秒钟内启动 WordPress 网站。免费层级包括 5 个活动网站、500MB 空间、48 小时网站过期。
  * [Storyblok](https://www.storyblok.com) - 为开发人员和营销人员提供的无头 CMS，适用于所有现代框架。社区（免费）层级提供管理 API、可视化编辑器、十个源、自定义字段类型、国际化（无限语言/地区）、资产管理器（最多 2500 个资产）、图像优化服务、搜索查询、Webhook + 250GB 流量/月包括在内。
  * [WPJack](https://wpjack.com) - 在不到 5 分钟的时间内在任何云平台上设置 WordPress！免费层级包括 1 个服务器、2 个网站、免费 SSL 证书和无限 cron 作业。没有时间限制或过期 - 你的网站，你的方式。
...
## 代码生成
  ...
  * [Cody AI](https://sourcegraph.com/cody)——Cody 是一个编码 AI 助手，它使用 AI 和对代码库的深入理解来帮助你更快地编写和理解代码。Cody 为开发人员提供了 LLMs（包括本地推理）的选择，支持各种 IDE，支持所有流行的编程语言，并提供免费计划。免费计划每月为开发人员提供 20 条聊天消息（使用 Claude 3 Sonnet 作为 LLM）和 500 次自动完成（使用 Starcoder 16b）。
  * [DhiWise](https://www.dhiwise.com/)——借助 DhiWise 的创新代码生成技术，将 Figma 设计无缝转换为动态的 Flutter 和 React 应用程序，优化工作流程，帮助您以前所未有的速度打造出色的移动和 Web 体验。
  ...
  * [Fern](https://buildwithfern.com)——编写 API 定义并使用它们在流行语言（如 TypeScript、Python、Java、Go 等）中生成 SDK/client 库。完全支持 OpenAPI。免费层为最多 20 个端点生成代码。
  * [Metalama](https://www.postsharp.net/metalama)——仅适用于 C#。Metalama 在编译时动态生成代码的样板，从而保持源代码的整洁。它对开源项目是免费的，其商业友好的免费层包括三个方面。
  ...
  * [v0.dev](https://v0.dev/)——v0 使用 AI 模型根据简单的文本提示生成代码。它基于 shadcn/ui 和 Tailwind CSS 生成可复制粘贴的友好 React 代码，人们可以在项目中使用。每次生成至少需要 30 个学分。您一开始有 1200 个学分，并且每月可以获得 200 个免费学分。
...
## 代码质量
  ...
  * [Codeac.io](https://www.codeac.io/infrastructure-as-code.html?ref=free-for-dev) - 用于 DevOps 的自动化基础架构即代码审查工具，与 GitHub、Bitbucket 和 GitLab 集成（甚至可以自托管）。除了标准语言，它还分析 Ansible、Terraform、CloudFormation、Kubernetes 等。（开源免费）
  * [CodeBeat](https://codebeat.co) - 适用于多种语言的自动化代码审查平台。免费版永久适用于公共存储库，并与 Slack 和电子邮件集成。
  * [codeclimate.com](https://codeclimate.com/) - 自动化代码审查，对于开源免费，并且对于组织拥有的私有存储库（最多 4 个协作者）也免费。对于学生和机构也是免费的。
  * [codecov.io](https://codecov.io/) - 代码覆盖率工具（SaaS），对于开源免费，并且对于一个免费的私有存储库免费
  ...
  * [CodSpeed](https://codspeed.io) - 在您的 CI 管道中自动跟踪性能。由于精确和一致的指标，在部署前捕获性能回归。对于开源项目永久免费。
  ...
  * [DeepSource](https://deepsource.io/) - DeepSource 持续分析源代码更改，查找并修复归类为安全、性能、反模式、错误风险、文档和样式的问题。与 GitHub、GitLab 和 Bitbucket 原生集成。
...
## 代码搜索和浏览
  ...
  * [libraries.io](https://libraries.io/)——搜索和依赖项更新通知，适用于 32 个不同的包管理器，开源免费
  * [Namae](https://namae.dev/)——在 GitHub、Gitlab、Heroku、Netlify 等多个网站上搜索您的项目名称的可用性。
  * [searchcode.com](https://searchcode.com/)——全面的基于文本的代码搜索，开源免费
  * [tickgit.com](https://www.tickgit.com/)——将`TODO`注释（和其他标记）表面化，以识别值得返回改进的代码区域。
...
## 持续集成和持续部署（CI和CD）
  ...
  * [AccessLint](https://github.com/marketplace/accesslint)——AccessLint 将自动化的网页可访问性测试带入您的开发工作流程。对于开源和教育目的是免费的。
  * [appcircle.io](https://appcircle.io)——一个企业级移动 DevOps 平台，可自动构建、测试和发布移动应用程序，以实现更快、更高效的发布周期。对于 30 分钟的最大构建时间、20 个每月构建和 1 个并发构建，免费。
  * [appveyor.com](https://www.appveyor.com/)——适用于 Windows 的 CD 服务，开源免费。
  * [Argonaut](https://argonaut.dev/)——在您的云平台上几分钟内部署应用程序和基础架构。支持在 Kubernetes 和 Lambda 环境中自定义和第三方应用程序部署。免费层允许在 5 个域和 2 个用户的情况下无限制的应用程序和部署。
  * [bitrise.io](https://www.bitrise.io/)——适用于移动应用程序的 CI/CD，无论是原生的还是混合的。每月有 200 次免费构建、10 分钟构建时间和两个团队成员。OSS 项目获得 45 分钟构建时间、+1 并发性和无限团队规模。
  ...
  * [bytebase.com](https://www.bytebase.com/)——数据库 CI/CD 和 DevOps。免费使用人数在 20 人以下，数据库实例在 10 个以下。
  * [CircleCI](https://circleci.com/)——全面的免费计划，包含在托管的 CI/CD 服务中适用于 GitHub、GitLab 和 BitBucket 存储库的所有功能。多个资源类、Docker、Windows、Mac OS、ARM 执行器、本地运行器、测试拆分、Docker 层缓存和其他高级 CI/CD 功能。免费使用时间为每月最多 6000 分钟，无限制的协作者，私有项目中的 30 个并行作业，以及开源项目的 80,000 个免费构建分钟。
  * [cirrus-ci.org](https://cirrus-ci.org)——适用于公共 GitHub 存储库。
  * [cirun.io](https://cirun.io/)——适用于公共 GitHub 存储库。
  * [codefresh.io](https://codefresh.io/)——免费终身计划：1 次构建、1 个环境、共享服务器、无限公共存储库。
  ...
  * [drone](https://cloud.drone.io/)——Drone Cloud 使开发人员能够在多个架构（包括 x86 和 Arm（32 位和 64 位））上运行持续交付管道——都在一个地方。
  ...
  * [Squash Labs](https://www.squash.io/)——为每个分支创建一个 VM，并使您的应用程序可从一个唯一的 URL 访问，无限的公共和私有存储库，最大 2GB VM 大小。
  * [styleci.io](https://styleci.io/)——仅限公共 GitHub 存储库。
  * [Mergify](https://mergify.io)——适用于 GitHub 的工作流程自动化和合并队列——适用于公共 GitHub 存储库免费。
  * [Make](https://www.make.com/en)——工作流程自动化工具，允许您使用 UI 连接应用程序并自动化工作流程。它支持许多应用程序和最流行的 API。适用于公共 GitHub 存储库，免费层包括 100 Mb、1000 次操作和 15 分钟的最小间隔。
  * [Spacelift](https://spacelift.io/)——适用于基础设施即代码的管理平台。免费计划功能：IaC 协作、Terraform 模块注册表、ChatOps 集成、使用 Open Policy Agent 进行持续资源合规性、使用 SAML 2.0 的单点登录以及访问公共工作器池：最多 200 分钟/月。
  ...
  * [Nx Cloud](https://nx.dev/ci)——Nx Cloud 通过远程缓存、任务在机器上的分布甚至自动拆分 e2e 测试运行等功能，加快您的 monorepos 在 CI 上的速度。它提供了一个免费计划，最多可容纳 30 名贡献者，并包含慷慨的 150k 信用额度。
  * [blacksmith](https://www.blacksmith.sh/)——适用于 GitHub Actions 的托管性能运行器，每月提供 3000 分钟的免费时间，无需信用卡。
  * [Terramate](https://terramate.io/)——Terramate 是适用于基础设施即代码（IaC）工具（如 Terraform、OpenTofu 和 Terragrunt）的编排和管理平台。免费使用人数最多为 2 人，包括所有功能。

**[⬆️ 返回顶部](#目录)**

## 测试

  * [Applitools.com](https://applitools.com/) - 智能视觉验证工具，适用于网络、原生移动和桌面应用程序。与几乎所有自动化解决方案（如 Selenium 和 Karma）和远程运行器（Sauce Labs、Browser Stack）集成。开源免费。为单个用户提供有限的每周检查点的免费层。
  * [Appetize](https://appetize.io) - 在这个基于云的 Android 手机/平板电脑模拟器和 iPhone/iPad 模拟器上测试您的 Android 和 iOS 应用程序，直接在您的浏览器中进行。免费层包括两个并发会话，每月使用 30 分钟。无应用程序大小限制。
  ...
  * [BugBug](https://bugbug.io/) - 用于 Web 应用程序的轻量级测试自动化工具。易于学习，不需要编码。您可以在自己的计算机上免费运行无限次测试。您还可以获得云监控和 CI/CD 集成，但需要额外支付月费。
  ...
  * [checkbot.io](https://www.checkbot.io/) - 浏览器扩展，用于测试您的网站是否遵循 50 多个 SEO、速度和安全最佳实践。较小的网站提供免费层。
  ...
  * [Cypress Recorder by Preflight](https://cypress.preflight.com/) - 在您的浏览器上创建基于人工智能的 Cypress 测试/POM 模型。它是开源的，人工智能部分除外。它在免费的五个月测试创建中提供自我修复脚本、电子邮件和视觉测试。
  ...
  * [Keploy](https://keploy.io/) - 用于开发人员的功能测试工具包。记录 API 调用为 API（KTests）和模拟或存根（KMocks）生成端到端测试。它对开源项目免费。
  ...
  * [preflight.com](https://preflight.com) - 无代码自动化网络测试。在您的浏览器上录制对 UI 更改具有弹性的测试，并在 Windows 计算机上运行它们。可以与您的 CI/CD 集成吗？免费计划包括 50 个每月测试运行，带有视频、HTML 会话等。
  ...
  * [Repeato](https://repeato.app/) 基于计算机视觉和人工智能的无代码移动应用程序测试自动化工具。适用于原生应用程序、Flutter、React Native、Web、Ionic 等众多应用程序框架。免费计划限制每个 iOS 进行 10 次测试，每个 Android 进行 10 次测试，但包括付费计划的大部分功能，包括无限次测试运行。
  * [Requestly](https://requestly.com/) 用于拦截、重定向和模拟 HTTP 请求的开源 Chrome 扩展。具有 [调试器](https://requestly.com/products/web-debugger/)、[模拟服务器](https://requestly.com/products/mock-server/)、[API 客户端](https://requestly.com/products/api-client/) 和 [会话记录](https://requestly.com/products/session-book/) 功能。重定向 URL、修改 HTTP 标头、模拟 API、注入自定义 JS、修改 GraphQL 请求、生成模拟 API 终结点、记录带有网络和控制台日志的会话。免费层可创建最多 10 个规则。对开源免费。
  * [seotest.me](https://seotest.me/) - 免费的页面 SEO 网站测试工具。每天 10 次免费网站抓取。有关如何提高任何网站的页面 SEO 结果的有用 SEO 学习资源和建议，无论技术如何。
  * [snippets.uilicious.com](https://snippets.uilicious.com) - 它就像 CodePen 但用于跨浏览器测试。UI-licious 允许您像用户故事一样编写测试，并提供免费平台 - UI-licious Snippets - 允许您在 Chrome 上进行无限次测试，无需注册，每次测试运行最多 3 分钟。发现错误？您可以复制测试的唯一 URL 并将其提供给开发人员，以确切地向他们展示如何重现该错误。
  ...
  * [Testspace.com](https://testspace.com/) - 使用 GitHub 实现手动测试的仪表板和框架。该服务[对开源免费](https://github.com/marketplace/testspace-com)，并为 450 个每月结果提供支持。
  ...
  * [qase.io](https://qase.io) - Dev 和 QA 团队的测试管理系统。管理测试用例、组合测试运行、执行测试、跟踪缺陷和衡量影响。免费层包括所有核心功能，可用于附件的 500MB 和最多 3 个用户。

  * [UseWebhook.com](https://usewebhook.com) - 在浏览器中捕获和检查 Webhook。可以转发到本地主机，也可以从历史记录中重放。免费使用。
...
## 安全和公钥基础设施（PKI）
  ...
  * [aikido.dev](https://www.aikido.dev)——一体化应用安全平台，涵盖 SCA、SAST、CSPM、DAST、Secrets、IaC、Malware、容器扫描、EOL 等。免费计划包括两个用户，对 10 个存储库、1 个云、2 个容器和 1 个域进行扫描。
  * [alienvault.com](https://www.alienvault.com/open-threat-exchange/reputation-monitor)——揭示网络中被入侵的系统
  * [Altcha.org](https://altcha.org/anti-spam)——基于自然语言处理和机器学习的网站和 API 垃圾邮件过滤器。免费计划包括每个域名每天 200 次请求。
  ...
  * [CyberChef](https://gchq.github.io/CyberChef/)——一个简单直观的网络应用程序，用于分析和解码/编码数据，无需处理复杂的工具或编程语言。就像一把瑞士军刀的密码学和加密工具。所有功能均可免费使用，无限制。如果愿意，可以自行托管。
  ...
  * [Dotenv](https://dotenv.org/)——快速安全地同步您的.env 文件。停止通过不安全的渠道（如 Slack 和电子邮件）共享您的.env 文件，再也不会丢失重要的.env 文件。最多可供 3 个队友免费使用。
  ...
  * [Infisical](https://infisical.com/)——开源平台，可让您在团队和基础设施中管理开发人员的秘密：从本地开发到登台/生产第三方服务的各个环节。最多可供 5 名开发人员免费使用。
  ...
  * [seclookup.com](https://www.seclookup.com/)——Seclookup APIs 可以丰富 SIEM 中的域名威胁指标，提供域名的全面信息，并提高威胁检测和响应能力。在此处获得 50K 次查找免费[here](https://account.seclookup.com/)。
  ...
  * [SOOS](https://soos.io)——免费的开源项目 SCA 扫描，无限次扫描。在发布前检测和修复安全威胁。使用简单有效的解决方案保护您的项目。
  * [StackHawk](https://www.stackhawk.com/)——在整个管道中自动扫描应用程序，以在安全漏洞进入生产环境之前找到并修复它们。单个应用程序的无限扫描和环境。
  ...
  * [Virgil Security](https://virgilsecurity.com/)——在您的数字解决方案中实现端到端加密、数据库保护、物联网安全等的工具和服务。免费供最多 25 个用户的应用程序使用。
  * [Vulert](https://vulert.com)——Vulert 持续监控您的开源依赖项以发现新的漏洞，并提供修复建议，无需安装或访问您的代码库。适用于开源项目。

  * [HasMySecretLeaked](https://gitguardian.com/hasmysecretleaked) - 在公共 GitHub 存储库、gist、问题和注释中搜索 2000 万个泄露的秘密，免费
...
## 身份验证、授权和用户管理
  ...
  * [Authgear](https://www.authgear.com) - 在数分钟内为您的应用带来无密码、一次性密码、双因素身份验证、单点登录等功能。所有前端均包含在内。免费使用额度为最多 5000 MAUs。
  ...
  * [Clerk](https://clerk.com) — 用户管理、身份验证、2FA/MFA、用于登录、注册、用户个人资料等的预构建 UI 组件。免费使用额度为每月 10,000 个活跃用户。
  ...
  * [duo.com](https://duo.com/) — 网站或应用的双因素身份验证 (2FA)。免费使用额度为十个用户，所有身份验证方法，无限制，集成，硬件令牌。
  * [Kinde](https://kinde.com/) - 简单、强大的身份验证，您可以在几分钟内集成到您的产品中。开始使用 7,500 免费 MAU 所需的一切。
  * [logintc.com](https://www.logintc.com/) — 通过推送通知进行双因素身份验证 (2FA)，免费使用额度为十个用户，VPN、网站和 SSH
  ...
  * [Ory](https://ory.sh/) - 身份验证/授权/OAuth2.0/零信任管理安全平台。所有安全功能的开发者账户永久免费，无限团队成员，每天 200 个活跃用户，每月 25k/次权限检查。
  * [Phase Two](https://phasetwo.io) - Keycloak 开源身份和访问管理。免费领域最多 1000 个用户，最多 10 个 SSO 连接，利用 Phase Two 的增强容器 Keycloak，其中包括 [Organization](https://phasetwo.io/product/organizations/) 扩展。
  * [Stytch](https://www.stytch.com/) - 具有强大抵御能力的密码、无密码登录流程、MFA、SSO 等功能的灵活身份验证 API 和 SDK。内置电子邮件/SMS 发送和故障转移以及欺诈保护。提供 5,000 个每月活跃用户免费（B2C）或 1,000 个每月活跃用户和 25 个组织免费（B2B）。
  * [Stack Auth](https://stack-auth.com) — 开源身份验证，不会让您失望。最适合开发者的解决方案，只需五分钟即可开始使用。可免费自托管，或提供具有 10k 免费每月活跃用户的托管 SaaS 版本。
  ...
  * [ZITADEL Cloud](https://zitadel.com) — 即开即用的用户和访问管理，适用于您和支持多租户 (B2B) 用例。免费使用额度为最多 25,000 次经过身份验证的请求，具有所有安全功能（OTP、无密码、策略等无付费墙）。
  * [PropelAuth](https://propelauth.com) — 只需几行代码即可立即向任何规模的公司销售，免费使用额度为最多 200 个用户和 10k 封交易电子邮件（带有水印品牌：“由 PropelAuth 提供支持”）。
  * [Logto](https://logto.io/) - 开发、保护和管理您产品的用户身份 - 包括身份验证和授权。免费使用额度为每月最多 5,000 MAUs，提供开源自托管选项。
  * [WorkOS](https://workos.com/) - 免费的用户管理和身份验证，最多可支持 100 万 MAUs。支持电子邮件+密码、社交身份验证、Magic Auth、MFA 等。
...
## 移动应用分发和反馈
  ...
  * [Loadly](https://loadly.io) - iOS 和 Android 测试版应用分发服务提供完全免费的服务，不限下载次数、高速下载和无限制上传。
  * [Diawi](https://www.diawi.com) - 直接将 iOS 和 Android 应用部署到设备上。免费计划：应用上传、密码保护链接、一天有效期、十个安装次数。
  * [InstallOnAir](https://www.installonair.com) - 通过空中分发 iOS 和 Android 应用。免费计划：无限制上传、私人链接、访客两天有效期、注册用户六十天有效期。
  * [GetUpdraft](https://www.getupdraft.com) - 分发移动应用进行测试。免费计划包括一个应用项目、三个应用版本、500MB 存储空间和每月 100 次应用安装次数。
...
## 管理系统
  ...
  * [Miradore](https://miradore.com) - 设备管理服务。随时了解您的设备车队，并免费安全保护无限数量的设备。免费计划提供基本功能。
  ...
  * [ploi.io](https://ploi.io/) - 服务器管理工具，可轻松管理和部署您的服务器和站点。免费 1 个服务器

**[⬆️ 返回顶部](#目录)**

## 消息传递和流

  * [Ably](https://www.ably.com/) - 具有在线状态、持久性和消息保证交付的实时消息服务。免费计划包括每月 300 万条消息、100 个峰值连接和 100 个峰值通道。
  * [cloudamqp.com](https://www.cloudamqp.com/) - RabbitMQ 即服务。小狐猴计划：每月最多 100 万条消息，最多 20 个并发连接，最多 100 个队列，最多 10,000 条排队消息，不同 AZ 中的多个节点
  ...
  * [HiveMQ](https://www.hivemq.com/mqtt-cloud-broker/) - 将您的 MQTT 设备连接到云原生物联网消息代理。免费连接最多 100 个设备（无需信用卡）永久。
  ...
  * [synadia.com](https://synadia.com/ngs) - [NATS.io](https://nats.io) 即服务。全球、AWS、GCP 和 Azure。免费无限，每月 4k 消息大小、50 个活动连接和 5GB 数据。
  ...
  * [eyeson API](https://developers.eyeson.team/) - 基于 WebRTC（SFU、MCU）的视频通信 API 服务，用于构建视频平台。允许实时数据注入、视频布局、录制、功能齐全的托管网络 UI（快速入门）或自定义 UI 的包。有一个[开发者免费层](https://apiservice.eyeson.com/api-pricing)，每月 1000 分钟会议。
  * [webpushr](https://www.webpushr.com/) - Web 推送通知 - 免费用于最多 10k 订户，无限推送通知，浏览器内消息传递
...
## 翻译管理
  ...
  * [crowdin.com](https://crowdin.com/) - 不限项目数量、不限字符串数量，并且对开源项目友好
  * [gitlocalize.com](https://gitlocalize.com) - 无论是私人还是公共存储库，都是免费且无限制的
  * [Lecto](https://lecto.ai/) - 具有免费层的机器翻译 API（30 个免费请求，每个请求 1000 个已翻译字符）。与 Loco Translate Wordpress 插件集成。
  * [lingohub.com](https://lingohub.com/) - 最多 3 个用户免费，对开源项目始终免费
  * [localazy.com](https://localazy.com/) - 免费 1000 个源语言字符串，不限语言，不限贡献者，适用于初创公司和开源项目
  * [Localeum](https://localeum.com) - 免费 1000 个字符串，1 个用户，不限语言，不限项目
  * [localizely.com](https://localizely.com/) - 对开源项目免费
  * [Loco](https://localise.biz/) - 免费 2000 次翻译，无限制的翻译人员，每个项目 10 种语言/项目，每个项目 1000 个可翻译资产
  * [oneskyapp.com](https://www.oneskyapp.com/) - 最多 5 个用户的有限免费版，对开源项目免费
  * [POEditor](https://poeditor.com/) - 免费 1000 个字符串
  * [SimpleLocalize](https://simplelocalize.io/) - 免费 100 个翻译键，不限字符串，不限语言，适用于初创公司
  * [Texterify](https://texterify.com/) - 单用户免费
  * [Tolgee](https://tolgee.io) - 提供有限翻译的免费 SaaS 产品，具有永远免费的自托管版本
  * [transifex.com](https://www.transifex.com/) - 对开源项目免费
  * [Translation.io](https://translation.io) - 对开源项目免费
  * [Translized](https://translized.com) - 免费 1000 个字符串，1 个用户，不限语言，不限项目
  * [webtranslateit.com](https://webtranslateit.com/) - 免费 500 个字符串
  * [weblate.org](https://weblate.org/) - 对于自由项目是免费的，免费层的字符串源数量最多为 10,000，对于自有托管的本地部署是无限制的
...
## 监控
  ...
  * [UptimeObserver.com](https://uptimeobserver.com/) - 获得 20 个监控器，监控间隔为 5 分钟，并可定制状态页面，甚至可用于商业用途。通过电子邮件和 Telegram 享受无限的实时通知。无需信用卡即可开始使用。
  ...
  * [appspector.com](https://appspector.com/) - 远程 iOS/Android/Flutter 调试的任务控制。对于小流量使用（64MB 的日志）免费。
  * [assertible.com](https://assertible.com) - 自动化 API 测试和监控。团队和个人的免费计划。
  * [bleemeo.com](https://bleemeo.com/) - 免费提供 3 台服务器、5 个监控器、不限用户、不限仪表板、不限警报规则。
  * [checklyhq.com](https://checklyhq.com/) - 开发人员的开源端到端/合成监控和深度 API 监控。免费计划有 5 个用户和 50,000+次检查运行。
  ...
  * [datadoghq.com](https://www.datadoghq.com/) - 免费最多 5 个节点
  * [deadmanssnitch.com](https://deadmanssnitch.com/) - 对 cron 作业进行监控。一个免费的监控器（监视器），如果其他人注册，还可以获得更多。
  * [downtimemonkey.com](https://downtimemonkey.com/) - 60 个监控器，监控间隔为 5 分钟。电子邮件、Slack 警报。
  * [economize.cloud](https://economize.cloud/) - 通过组织云资源进行优化并报告相同内容，帮助用户了解云基础设施成本。免费适用于每月在 Google Cloud Platform 上花费不超过 5,000 美元的情况。
  * [elastic.co](https://www.elastic.co/solutions/apm) - 为 JavaScript 开发人员提供即时性能洞察。免费，保留 24 小时数据。
  * [Grafana Cloud](https://grafana.com/products/cloud/) - Grafana Cloud 是一个可组合的观测平台，它将指标和日志与 Grafana 集成在一起。免费：3 个用户，10 个仪表板，100 个警报，在 Prometheus 和 Graphite 中存储指标（10,000 个系列，14 天保留），在 Loki 中存储日志（50GB 的日志，14 天保留）
  * [healthchecks.io](https://healthchecks.io/) - 监控 cron 作业和后台任务。免费最多 20 次检查。
  * [Hydrozen.io](https://hydrozen.io/) - 监控状态页面，免费计划：10 个监控器，5 个心跳监控器，1 个域名监控器和 1 个状态页面免费。
  * [inspector.dev](https://www.inspector.dev) - 在不到一分钟的时间内使用免费的永久层创建完整的实时监控仪表板。
  * [instrumentalapp.com](https://instrumentalapp.com/) - 具有高达 500 个指标和 3 小时数据可见性的免费应用程序和服务器监控，简单易用。
  * [keychest.net/speedtest](https://keychest.net/speedtest) - 针对 Digital Ocean 的独立速度测试和 TLS 握手延迟测试。
  * [letsmonitor.org](https://letsmonitor.org/) - SSL 监控，免费最多 5 个监控器
  * [linkok.com](https://linkok.com/) - 在线断链检查程序，免费适用于小型网站（最多 100 页），对开源项目完全免费。
  ...
  * [newrelic.com](https://www.newrelic.com) - 新的 Relic 观测平台，旨在帮助工程师创建更完美的软件。从单体到无服务器，您可以对所有内容进行仪器化，然后分析、排除故障和优化整个软件堆栈。免费层提供 100GB/月的免费数据摄入，一个免费的全访问用户和无限的免费主要用户。
  * [Middleware.io](https://middleware.io/) - 中间件观测平台提供对应用程序和堆栈的完整可见性，以便您可以大规模监控和诊断问题。他们为开发人员社区提供免费的永久计划，允许日志监控高达 100 万条日志事件，基础设施监控和 APM 最多 2 个主机。
  * [nixstats.com](https://nixstats.com/) - 免费适用于一台服务器。电子邮件通知、公共状态页面、60 秒间隔等。
  * [OnlineOrNot.com](https://onlineornot.com/) - 提供网站和 API 的监控，还提供 cron 作业和计划任务的监控。还提供状态页面。免费层的前五个检查间隔为 3 分钟。免费层通过 Slack、Discord 和电子邮件发送警报。
  ...
  * [pingbreak.com](https://pingbreak.com/) - 现代的监控服务，可监控无限数量的 URL，并通过 Discord、Slack 或电子邮件获取停机通知。
  ...
  * [sematext.com](https://sematext.com/) - 免费提供 24 小时指标，无限制的服务器，10 个自定义指标，500 万个自定义指标数据点，无限制的仪表板，用户等。
  * [sitemonki.com](https://sitemonki.com/) - 网站、域、Cron 和 SSL 监控，每个类别免费 5 个监控器
  * [sitesure.net](https://sitesure.net/) - 网站和 cron 监控-免费 2 个监控器
  * [skylight.io](https://www.skylight.io/) - 免费适用于前 100,000 个请求（仅限 Rails）
  * [speedchecker.xyz](https://probeapi.speedchecker.xyz/) - 性能监控 API，检查 Ping、DNS 等。
  * [stathat.com](https://www.stathat.com/) - 免费开始，提供 10 个统计数据，无过期限制
  ...
  * [zenduty.com](https://www.zenduty.com/) - 端到端事件管理、警报、值班管理和响应编排平台，适用于网络运营、站点可靠性工程和 DevOps 团队。免费提供给最多 5 个用户
  * [instatus.com](https://instatus.com) - 在 10 秒内获得漂亮的状态页面。无限子账户和无限团队永久免费
  * [Squadcast.com](https://squadcast.com) - Squadcast 是一款端到端事件管理软件，旨在帮助您推广 SRE 最佳实践。提供长达 10 个用户的永久免费计划
  * [RoboMiri.com](https://robomiri.com/) - RoboMiri 是一个稳定的正常运行时间监视器，提供广泛的监视器：cronjob、关键字、网站、端口、ping。免费提供 25 次正常运行时间检查，间隔 3 分钟。通过电话呼叫、短信、电子邮件和 Webhooks 进行警报
  * [Better Stack](https://betterstack.com/better-uptime) - 单一产品中包含正常运行时间监控、事件管理、值班安排/警报和状态页面。免费计划包括 10 个监视器，检查频率为 3 分钟，状态页面
  * [Pulsetic](https://pulsetic.com) - 10 个监视器，6 个月的历史正常运行时间/日志，无限状态页面和自定义域名！免费无限时间和无限电子邮件警报。您无需信用卡
...
## Crash and Exception Handling
  ...
  * [exceptionless](https://exceptionless.com) — 实时错误、功能、日志报告等。每月免费 3k 事件/1 个用户。开源且易于自行托管，无使用限制。
  ...
  * [rollbar.com](https://rollbar.com/) — 异常和错误监控，免费计划每月 5,000 个错误，无用户限制，保留 30 天。
  * [sentry.io](https://sentry.io/) — Sentry 实时跟踪应用程序异常，有一个小的免费计划。每月免费 5k 个错误/1 个用户，自托管则无限制使用。
  ...
  * [Whitespace](https://whitespace.dev) - 在您的浏览器中一键式错误报告。个人使用的免费计划无限录制。

**[⬆️ 返回顶部](#目录)**

## 搜索

  * [algolia.com](https://www.algolia.com/)——具有容错性、相关性和 UI 库的托管搜索解决方案，可轻松创建搜索体验。免费的“Build”计划包括 100 万份文档和 10,000 次搜索/月。还提供免费的[开发者文档搜索](https://docsearch.algolia.com/)。
  * [bonsai.io](https://bonsai.io/)——免费 1GB 内存和 1GB 存储空间
  * [CommandBar](https://www.commandbar.com/)——统一搜索栏即服务，基于网络的 UI 小部件/插件，允许用户在产品中搜索内容、导航、功能等，有助于提高可发现性。对于最多 1,000 名每月活跃用户免费，无限制命令。
...
## 教育和职业发展
  ...
  * [免费专业简历模板和编辑器](https://www.overleaf.com/latex/templates/tagged/cv) - 免费平台，有大量经验丰富的专业人士的简历模板，可完全克隆、编辑并下载，符合 ATS 优化。
...
## 电子邮件
  ...
  * [AhaSend](https://ahasend.com) - 交易邮件服务，每月免费 1000 封邮件，免费计划中无限制域、团队成员、Webhooks 和消息路由。
  ...
  * [Buttondown](https://buttondown.email/) - 新闻通讯服务。免费提供高达 100 名订阅者。
  * [CloudMailin](https://www.cloudmailin.com/) - 通过 HTTP POST 接收邮件和进行事务性出站 - 每月免费 10,000 封邮件。
  * [Contact.do](https://contact.do/) - 链接形式的联系表单（bitly 用于联系表单）。
  ...
  * [EmailOctopus](https://emailoctopus.com) - 免费提供最多 2500 名订阅者和每月 10,000 封邮件。
  * [EmailJS](https://www.emailjs.com/) - 这不是完整的电子邮件服务器；这只是一个电子邮件客户端，您可以使用它从客户端发送电子邮件，而无需暴露您的凭据，免费层每月有 200 个请求，2 个电子邮件模板，请求大小高达 50KB，联系人历史记录有限。
  ...
  * [Temp-Mail.org](https://temp-mail.org/en/) - 临时/一次性邮件生成实用程序，使用多种域名。每次重新加载页面时，电子邮件地址都会刷新。它完全免费，不包括任何服务费用。
  * [TempMailDetector.com](https://tempmaildetector.com/) - 免费每月验证多达 200 封电子邮件，并查看电子邮件是否为临时的。
  * [Emailvalidation.io](https://emailvalidation.io) - 每月 100 次免费电子邮件验证。
  * [FakeMailGenerator.com](https://www.fakemailgenerator.com/) - 德国临时/一次性邮件生成器。支持 10 个域名，同时允许您自由创建无限数量的地址。（包含广告）但该服务不包括任何定价，完全免费。
  * [forwardemail.net](https://forwardemail.net) - 自定义域名的免费电子邮件转发。可以使用您的域名创建和转发无限数量的电子邮件地址（**注意**：如果您使用.casa、.cf、.click、.email、.fit、.ga、.gdn、.gq、.lat、.loan、.london、.men、.ml、.pl、.rest、.ru、.tk、.top、.work TLD，则需要付费）。
  ...
  * [EForw](https://www.eforw.com) - 一个域的免费电子邮件转发。从您的域名接收和发送电子邮件。
  * [Inboxes App](https://inboxesapp.com/) - 每天最多创建 3 个临时电子邮件，完成后可以在方便的 Chrome 扩展中删除。非常适合测试注册流程。
  ...
  * [Mailchimp](https://mailchimp.com/) - 500 名订阅者和每月 1000 封邮件免费。
  * [Maildroppa](https://maildroppa.com) - 最多 100 名订阅者和无限封邮件以及免费的自动化功能。
  * [MailerLite.com](https://www.mailerlite.com) - 每月 1000 名订阅者，每月 12000 封邮件免费。
  ...
  * [Mailjet](https://www.mailjet.com/) - 每月 6000 封邮件免费（每天 200 封邮件发送限制）。
  ...
  * [Mailtrap.io](https://mailtrap.io/) - 用于开发的虚假 SMTP 服务器，免费计划包括一个收件箱，100 条消息，没有团队成员，每秒两封邮件，没有转发规则。
  * [Mail7.io](https://www.mail7.io/) - 免费的临时电子邮件地址，用于 QA 开发人员。使用 Web 界面或 API 即时创建电子邮件地址。
  ...
  * [Queuemail.dev](https://queuemail.dev) - 可靠的电子邮件交付 API。免费层（每月 10,000 封邮件）。异步发送。使用多个 SMTP 服务器。阻止列表、日志记录、跟踪、Webhooks 等。
  * [QuickEmailVerification](https://quickemailverification.com) - 在免费层免费每日验证 100 封电子邮件，以及其他免费 API，如 DEA 检测器、DNS 查找、SPF 检测器等。
  * [Resend](https://resend.com) - 开发人员的事务性电子邮件 API。每月 3000 封邮件，每天 100 封邮件免费，一个自定义域名。
  * [Sender](https://www.sender.net) - 每月最多 15000 封邮件，最多 2500 名订阅者。
  * [SendGrid](https://sendgrid.com/) - 每天 100 封邮件和 2000 个联系人免费。
  * [Sendpulse](https://sendpulse.com) - 每月 500 名订阅者，每月 15000 封邮件免费。
  ...
  * [Sweego](https://www.sweego.io/) - 欧洲开发人员的事务性电子邮件 API。每天免费 500 封邮件。
  ...
  * [Tutanota](https://tutanota.com/)——免费的安全电子邮件帐户服务提供商，内置端到端加密，无广告，无跟踪。免费 1GB 存储空间。部分也为[开源](https://github.com/tutao/tutanota)，因此您可以自己托管。
  ...
  * [Zoho](https://www.zoho.com)——最初是作为电子邮件提供商，但现在提供一系列服务，其中一些提供免费计划。提供免费计划的服务列表：
     - [电子邮件](https://zoho.com/mail)免费供 5 个用户使用。每个用户 5GB 和 25MB 附件限制，一个域。
     ...
     - [Subscriptions](https://zoho.com/subscriptions)——定期计费管理免费供 20 个客户/订阅和 1 个用户使用，所有支付由 Zoho 托管。存储最后 40 个订阅指标
     - [Checkout](https://zoho.com/checkout)——产品计费管理，最多 3 页和 50 笔付款。
     - [Desk](https://zoho.com/desk)——客户支持管理，有三个代理、私人知识库和电子邮件票证。与[Assist](https://zoho.com/assist)集成，用于一名远程技术人员和 5 台无人值守计算机。
...
## 功能切换管理平台
  ...
  * [GrowthBook](https://growthbook.io) - 开源功能标志和 A/B 测试提供程序，内置贝叶斯统计分析引擎。免费最多供 3 个用户使用，无限制的功能标志和实验。
  * [Hypertune](https://www.hypertune.com) - 类型安全的功能标志、A/B 测试、分析和应用程序配置，具有 Git 风格的版本控制以及同步、内存中、本地标志评估。免费最多供 5 名团队成员使用，无限制的功能标志和 A/B 测试。
  * [Molasses](https://www.molasses.app) - 强大的功能标志和 A/B 测试。免费最多提供 3 个环境，每个环境各有 5 个功能标志。
  * [Toggled.dev](https://www.toggled.dev) - 企业级、可扩展的多区域功能标志管理平台。免费计划最多支持 10 个标志、两个环境、无限制的请求。SDK、分析仪表板、发布日历、Slack 通知和其他所有功能都包含在无尽的免费计划中。
...
## 字体
  ...
  * [dafont](https://www.dafont.com/) - 该网站提供的字体是其作者的财产，要么是免费软件、共享软件、演示版或公共领域。
  ...
  * [fonts.xz.style](https://fonts.xz.style/) 使用 CSS 将字体家族交付到网站的免费和开源服务。
...
## 表单
  ...
  * [Feathery](https://feathery.io) - 功能强大、开发者友好的表单构建器。可构建注册/登录、用户引导、支付流程、复杂金融应用等。免费计划允许每月最多提交 250 次，且有五个活动表单。
  ...
  * [HeyForm.net](https://heyform.net/) - 拖放式在线表单构建器。免费版允许创建无限表单并收集无限提交。带有预构建模板、反垃圾邮件和 100MB 文件存储。
  * [Tally.so](https://tally.so/) - 99%的功能都是免费的。免费版允许：无限表单、无限提交、电子邮件通知、表单逻辑、收取付款、文件上传、自定义感谢页面等。
  * [Hyperforms.app](https://hyperforms.app/) - 无需后端代码即可在几秒钟内创建表单到电子邮件等内容。个人帐户每月为您提供最多 50 次表单提交。
  ...
  * [Qualtrics Survey](https://qualtrics.com/free-account) - 使用此一流工具创建专业表单和调查。50 多个专家设计的调查模板。免费帐户的限制为：1 个活跃调查、100 个响应/调查和 8 种响应类型。
  * [Screeb](https://screeb.app/) - 应用内调查和产品分析，用于解码用户行为。永久免费计划允许每月 500 个活跃用户、无限响应和事件、许多集成、导出和定期报告。
  * [smartforms.dev](https://smartforms.dev/) - 强大且易于使用的网站表单后端，永久免费计划每月允许 50 次提交，250MB 文件存储，Zapier 集成，CSV/JSON 导出，自定义重定向，自定义响应页面，Telegram 和 Slack 机器人，单个电子邮件通知。
  ...
  * [Typeform.com](https://www.typeform.com/) - 在网站上包含设计精美的表单。免费计划每个表单允许最多 10 个字段和每月 100 次响应。
  * [WaiverStevie.com](https://waiverstevie.com) - 具有 REST API 的电子签名平台。您可以使用 webhooks 接收通知。免费计划对已签名的文档加水印，但允许无限信封+签名。
  * [Web3Forms](https://web3forms.com) - 无需编写后端代码即可用于静态和 JAMStack 网站的联系表单。免费计划允许每月无限表单、无限域名和 250 次提交。
  * [WebAsk](https://webask.io) - 调查和表单构建器。免费计划每个帐户有三个调查，每月 100 次响应，每个调查有十个元素。
  * [Wufoo](https://www.wufoo.com/) - 在网站上使用的快速表单。免费计划每月限制为 100 次提交。
  * [formpost.app](https://formpost.app) - 免费、无限的表单到电子邮件服务。免费设置自定义重定向、自动回复、Webhooks 等。
  * [Formester.com](https://formester.com) - 在您的网站上分享和嵌入独特外观的表单-不受计划限制的表单创建数量或功能限制。每月免费获得高达 100 次提交。
  * [SimplePDF.eu](https://simplepdf.eu/embed) - 在您的网站上嵌入 PDF 编辑器，并将任何 PDF 转换为可填写的表单。免费计划允许每个 PDF 有无限个 PDF 和三次提交。
  * [forms.app](https://forms.app/) - 使用强大功能（如条件逻辑、自动评分计算器和 AI）创建在线表单。免费计划可收集最多 100 次响应，可嵌入网站或使用链接。
...
## 生成式人工智能（GenerativeAI）
  ...
  * [Pollinations.AI](https://pollinations.ai/) - 易于使用的免费图像生成 AI，提供免费 API。无需注册或 API 密钥，并且有几种集成到网站或工作流程的选项。[#opensource](https://github.com/pollinations/pollinations)
...
## 内容分发网络（CDN）和保护
  ...
  * [Microsoft Ajax](https://docs.microsoft.com/en-us/aspnet/ajax/cdn/overview)——Microsoft Ajax CDN 托管流行的第三方 JavaScript 库，如 jQuery，并使您可以轻松将它们添加到您的 Web 应用程序中
  ...
  * [UNPKG](https://unpkg.com/)——npm 上的一切的 CDN
  ...
  * [CacheFly](https://portal.cachefly.com/signup/free2023)——每月最多 5TB 的免费 CDN 流量，19 个核心 PoPs，1 个域名和通用 SSL。

**[⬆️ 返回顶部](#目录)**

## 平台即服务（PaaS）

  * [anvil.works](https://anvil.works) - 使用 Python 进行 Web 应用开发。免费层提供无限数量的应用程序和 30 秒的超时时间。
  ...
  * [deco.cx](https://www.deco.cx/en/dev) - 边缘原生前端平台，具有可视化 CMS，由 TypeScript 代码自动生成。内置 A/B 测试、内容分段和实时分析。非常适合内容丰富和企业电子商务网站。免费版每月可获得 5k 页面浏览量或开源/个人项目。
  * [Deno Deploy](https://deno.com/deploy) - 在全球边缘运行 JavaScript、TypeScript 和 WebAssembly 的分布式系统。免费层包括每天 100,000 次请求和每月 100 GiB 数据传输。
  * [domcloud.co](https://domcloud.co) - Linux 托管服务，提供与 GitHub、SSH 和 MariaDB/Postgres 数据库的 CI/CD。免费版本有 1GB 存储和 1GB 网络/月限制，并且仅限于免费域名。
  ...
  * [gigalixir.com](https://gigalixir.com/) - Gigalixir 提供一个永不休眠的免费实例和一个免费的 PostgreSQL 数据库，限制为 2 个连接、10,000 行且不提供备份，适用于 Elixir/Phoenix 应用程序。
  ...
  * [ampt.dev](https://getampt.com/) - Ampt 让团队可以在 AWS 上构建、部署和扩展 JavaScript 应用程序，无需复杂的配置或管理基础设施。免费预览计划包括每小时 500 次调用、每天 2500 次调用和每月 50,000 次调用。自定义域仅在付费计划中允许。
  * [Koyeb](https://www.koyeb.com) - Koyeb 是一个面向开发者的无服务器平台，可在全球范围内部署应用程序。通过基于 git 的部署、本机自动缩放、全球边缘网络和内置的服务网格和发现，无缝运行 Docker 容器、Web 应用程序和 API。免费实例可让您在德国法兰克福或美国华盛顿特区部署 Web 服务。免费的托管 PostgreSQL 数据库可在美国华盛顿特区（美国）、德国法兰克福（德国）和新加坡使用。512MB 内存、2GB 存储和 0.1 CPU。无需信用卡即可开始使用。
  ...
  * [WunderGraph](https://cloud.wundergraph.com) - 一个开源平台，允许您快速构建、交付和管理现代 API。内置 CI/CD、GitHub 集成和自动 HTTPS。免费计划包括 3 个项目、1GB 出站、每月 300 分钟构建时间[免费计划](https://wundergraph.com/pricing)
  ...
  * [genezio](https://genezio.com/) - 一个无服务器函数提供程序，每月提供 100 万个函数调用、100GB 带宽和 10 个 cron 作业，仅供非商业或学术用途免费使用。

**[⬆️ 返回顶部](#目录)**

## 后端即服务（BaaS）

  * [Activepieces](https://www.activepieces.com) - 构建自动化流程，将多个应用程序连接到你的应用程序的后端。例如，当你的应用程序中发生事件时，发送一条 Slack 消息或在 Google 表格中添加一行。每月免费使用高达 5000 个任务。
  * [back4app.com](https://www.back4app.com) - Back4App 是一个易于使用、灵活且可扩展的后端，基于 Parse 平台。
  * [backendless.com](https://backendless.com/) — 移动和网络 Baas，免费提供 1GB 文件存储、每月 50,000 次推送通知和表中的 1000 个数据对象。
  * [bismuth.cloud](https://www.bismuth.cloud/) — 我们的人工智能将在我们的函数运行时和托管存储上引导你的 Python API，在我们的在线编辑器或本地使用你最喜欢的工具免费构建和托管。
  * [BMC Developer Program](https://developers.bmc.com/site/global/bmc_helix_platform/program/overview/index.gsp) — BMC Developer Program 提供文档和资源，用于为你的企业构建和部署数字创新。访问全面的个人沙盒，其中包括平台、SDK 和可用于构建和定制应用程序的组件库。
  * [connectycube.com](https://connectycube.com) - 无限聊天消息、p2p 语音和视频通话、文件附件和推送通知。对于最多 1000 个用户的应用程序免费。
  * [convex.dev](https://convex.dev/) - 作为服务的反应式后端，托管你的数据（具有关系和可序列化 ACID 事务的文档）、无服务器函数和 WebSockets，以将更新流式传输到各个客户端。对于小项目免费 - 最多 1M 条记录，每月 5M 次函数调用。
  * [darklang.com](https://darklang.com/) - 托管语言结合了编辑器和基础架构。在测试版期间可访问，计划在测试版后提供慷慨的免费层。
  * [Firebase](https://firebase.com) - Firebase 帮助你构建和运行成功的应用程序。免费 Spark 计划提供身份验证、托管、Firebase ML、实时数据库、云存储、Testlab。A/B 测试、分析、应用分发、应用索引、云消息（FCM）、崩溃分析、动态链接、应用内消息、性能监控、预测和远程配置始终免费。
  * [Flutter Flow](https://flutterflow.io) - 无需编写一行代码即可构建你的 Flutter App UI。还具有 Firebase 集成。免费计划包括对 UI Builder 和免费模板的完全访问。
  * [getstream.io](https://getstream.io/) - 在几个小时内而不是几周内构建可扩展的应用内聊天、消息、视频和音频以及供稿。
  * [hasura.io](https://hasura.io/) - Hasura 扩展了你所在的任何位置的现有数据库，并提供即时 GraphQL API，可安全访问网络、移动和数据集成工作负载。免费提供 1GB/月的数据通过量。
  * [iron.io](https://www.iron.io/) - 具有免费层和 1 个月免费试用的异步任务处理（如 AWS Lambda）
  * [nhost.io](https://nhost.io) - 适用于网络和移动应用程序的无服务器后端。免费计划包括 PostgreSQL、GraphQL（Hasura）、身份验证、存储和无服务器函数。
  * [onesignal.com](https://onesignal.com/) - 无限免费推送通知。每月 10,000 封电子邮件发送，无限制的联系人访问权限和自动预热访问权限。
  ...
  * [pusher.com](https://pusher.com/beams) - 免费、无限的推送通知，适用于 2000 个每月活跃用户。适用于 iOS 和 Android 设备的单个 API。
  ...
  * [simperium.com](https://simperium.com/) - 立即在各个平台上随时随地移动数据，多平台，无限制发送和存储结构化数据，每月最多 2,500 个用户。
  ...
  * [stackstorm.com](https://stackstorm.com/) - 用于应用程序、服务和工作流的事件驱动自动化，免费使用，无流程、访问控制、LDAP
  ...
  * [zapier.com](https://zapier.com/) - 将你使用的应用程序连接起来，以自动执行任务。每 15 分钟五个 zaps 和每月 100 个任务
...
## 低代码平台
  ...
  * [outsystems.com](https://www.outsystems.com/)——企业网络开发 PaaS，提供内部部署或云的免费“个人环境”产品，允许无限代码和最多 1GB 数据库
  * [UI Bakery](https://uibakery.io)——低代码平台，可加快自定义 Web 应用程序的构建速度。支持使用拖放构建 UI，并通过 JavaScript、Python 和 SQL 进行高度定制。提供云和自托管解决方案。免费提供给最多 5 个用户。
...
## 虚拟主机
  ...
  * [DigitalOcean](https://www.digitalocean.com/pricing)——在应用平台入门层免费构建和部署三个静态站点。
  * [Drive To Web](https://drv.tw)——直接从 Google Drive 和 OneDrive 托管到网络。仅限静态站点。永久免费。每个 Google/Microsoft 帐户一个站点。
  * [Fenix Web Server](https://preview.fenixwebserver.com)——用于在本地托管站点并公开共享它们（实时）的开发者桌面应用程序。使用其美丽的用户界面、API 和/或 CLI，按照您喜欢的方式工作。
  ...
  * [Free Hosting](https://freehostingnoads.net/)——免费托管，提供 PHP 5、Perl、CGI、MySQL、FTP、文件管理器、POP 电子邮件、免费子域、免费域名托管、DNS 区域编辑器、网站统计信息、免费在线支持等其他免费主机不提供的功能。
  * [Freehostia](https://www.freehostia.com)——提供免费托管服务，包括行业最佳控制面板和 50+免费应用程序的一键安装。即时设置。无强制广告。
  ...
  * [Kinsta Static Site Hosting](https://kinsta.com/static-site-hosting/)——免费部署最多 100 个静态站点，自定义域名和 SSL，100GB 每月带宽，260+Cloudflare CDN 位置。
  * [Lecturify](https://www.lecturify.net/index.en.html)——提供 SFPT 访问的文件上传和下载的 Web 托管，支持 php。
  ...
  * [render.com](https://render.com)——统一的云，用于使用免费 SSL、全球 CDN、私有网络、从 Git 自动部署以及完全免费的计划构建和运行应用程序和站点，适用于 Web 服务、数据库和静态网页。
  * [SourceForge](https://sourceforge.net/)——免费查找、创建和发布开源软件。
  * [surge.sh](https://surge.sh/)——面向前端开发人员的静态 Web 发布。无限站点，支持自定义域名。
  * [telegra.ph](https://telegra.ph/)——使用 Quill 轻松创建网页。
  * [tilda.cc](https://tilda.cc/)——一个站点，50 页，50MB 存储空间，170 多个可用的主要预定义块，无字体，无 favicon，不支持自定义域名。
  ...
  * [fleek.co](https://fleek.co/)——在开放网络及其协议上免费构建现代网站和应用程序，无限制的网站和 50GB/月的带宽。
...
## 域名系统（DNS）
  ...
  * [1.1.1.1](https://developers.cloudflare.com/1.1.1.1/) - 由 Cloudflare 提供的免费公共 DNS 解析器，速度快且安全（加密 DNS 查询）。可用于绕过互联网提供商的 DNS 封锁、防止 DNS 查询监控以及[阻止成人和恶意软件内容](https://developers.cloudflare.com/1.1.1.1/1.1.1.1-for-families)。它也可以通过[API 使用](https://developers.cloudflare.com/1.1.1.1/encrypted-dns/dns-over-https/make-api-requests)。注意：只是一个 DNS 解析器，不是 DNS 主机。
  * [1984.is](https://www.1984.is/product/freedns/)——具有 API 和其他许多免费 DNS 功能的免费 DNS 服务。
  ...
  * [duckdns.org](https://www.duckdns.org/)——免费 DDNS，免费层最多可支持 5 个域名。提供各种设置的配置指南。
  * [Dynv6.com](https://dynv6.com/)——免费 DDNS 服务，支持[API](https://dynv6.com/docs/apis)，并管理许多 DNS 记录类型（如 CNAME、MX、SPF、SRV、TXT 等）。
  ...
  * [nextdns.io](https://nextdns.io)——基于 DNS 的防火墙，每月免费 300K 查询量
  * [noip.at](https://noip.at/)——免费 DDNS 服务，无注册、跟踪、日志记录或广告。域名不限
  ...
  * [zonewatcher.com](https://zonewatcher.com)——自动备份和 DNS 更改监控。免费提供 1 个域名
  ...
  * [Glauca](https://docs.glauca.digital/hexdns/)——最多可托管 3 个域名和 DNSSEC 支持的免费 DNS 托管
...
## 基础设施即服务（IaaS）
  ...
  * [filebase.com](https://filebase.com/) - 基于区块链的 S3 兼容对象存储。免费 5GB 存储空间，无限期使用
  ...
  * [Spheron](https://spheron.network/) - 从去中心化云存储和网络托管到为应用程序和开发者提供的去中心化计算，一个平台下的所有功能，免费计划提供 5GB 存储、100GB 带宽、无限域名和项目，以及 5 美元的计算资源（相对于 AWS 价值 50 美元）。
...
## 托管数据服务
  ...
  * [codehooks.io](https://codehooks.io/) — 使用简单的 JavaScript 无服务器 API/后端和 NoSQL 数据库服务，具有功能、类似 Mongdb 的查询、键/值查找、作业系统、实时消息、工作队列、强大的 CLI 和基于网络的数据管理器。免费计划有 5GB 存储和每分钟 60/API 调用。包含 2 名开发人员。无需信用卡。
  ...
  * [Turso by ChiselStrike](https://chiselstrike.com/) - Turso 是边缘数据库中的 SQLite 开发体验。Turso 提供免费永久入门计划，总存储量为 9GB，最多 500 个数据库，最多 3 个位置，每月读取 10 亿行，以及本地开发支持与 SQLite。
  * [InfluxDB](https://www.influxdata.com/) — 时间序列数据库，免费使用，写入最多 3MB/5 分钟，读取最多 30MB/5 分钟， cardinality 系列最多 10,000 个
  * [restdb.io](https://restdb.io/) - 一种快速且直接的 NoSQL 云数据库服务。使用 restdb.io，您可以获得模式、关系、自动 REST API（类似于 MongoDB 的查询）以及用于处理数据的高效多用户管理 UI。免费计划允许 3 个用户、2500 条记录和每秒 1 个 API 请求。
  ...
  * [Neo4j Aura](https://neo4j.com/cloud/aura/) — 管理原生图形数据库/分析平台，具有 Cypher 查询语言和 REST API。图形大小限制（50k 个节点，175k 个关系）。
  * [Neon](https://neon.tech/) — 托管 PostgreSQL，总存储量为 0.5GB，1 个项目，10 个分支，无限数据库，始终可用的主分支（非主分支计算后 5 分钟自动暂停），每月活动时间 20 小时
  * [Dgraph Cloud](https://cloud.dgraph.io/pricing?type=free) — 管理原生图形数据库，具有 GraphQL API。每天数据传输限制为 1MB。
  * [Tinybird](https://tinybird.co) - 无服务器托管的 ClickHouse，通过 HTTP 进行无连接数据摄取，并允许您将 SQL 查询发布为托管 HTTP API。免费层没有时间限制，10GB 存储+每天 1000 个 API 请求。
  ...
  * [8base.com](https://www.8base.com/) - 8base 是一个为 JavaScript 开发人员构建的全栈低代码开发平台，基于 MySQL 和 GraphQL 以及无服务器后端即服务。它允许您使用 UI 应用程序构建器快速构建 Web 应用程序并快速扩展，免费层包括行：2,500，存储：500，无服务器计算：1Gb/h，客户端应用程序用户：5。
...
## 隧道、WebRTC、WebSocket服务器和其他路由器
  ...
  * [Hamachi](https://www.vpn.net/)——LogMeIn Hamachi 是一项托管 VPN 服务，允许您使用免费计划创建无限个网络，每个网络最多可容纳 5 人，将类似 LAN 的网络安全扩展到分布式团队。
  * [Mirna Sockets](https://mirna.cloud/)——免费的套接字即服务平台，在部署 Web Socket 服务器代码时为您提供 wss://URL，还允许您监控其性能。
  ...
  * [Radmin VPN](https://www.radmin-vpn.com/)——通过 VPN 启用类似 LAN 的网络连接多台计算机。无限对等点。（Hamachi 替代品）
  * [segment.com](https://segment.com/)——将事件翻译成并路由到其他第三方服务的中心。免费提供 100,000 个事件/月。
  * Google STUN——[stun:stun.l.google.com:19302](stun:stun.l.google.com:19302)
  * Twilio STUN——[stun:global.stun.twilio.com:3478?transport=udp](stun:global.stun.twilio.com:3478?transport=udp)
  * [Tailscale](https://tailscale.com/)——使用开源的 WireGuard 协议的零配置 VPN。可安装在 MacOS、iOS、Windows、Linux 和 Android 设备上。个人免费使用计划可容纳 100 个设备和 3 个用户。
  ...
  * [Hookdeck](https://hookdeck.com/pricing)——从任何地方开发、测试和监控您的 Webhook。每月 100 万次请求和 100 万次尝试，保留时间为 3 天。
  * [Xirsys](https://www.xirsys.com/pricing/)——无限 STUN 使用量+500MB 每月 TURN 带宽，限制带宽，单个地理区域。
...
## 问题跟踪和项目管理
  ...
  * [Backlog](https://backlog.com)——您的团队在一个平台上发布优秀项目所需的一切。免费计划提供 1 个项目，最多 10 个用户和 100MB 存储空间。
  * [Basecamp](https://basecamp.com/personal)——待办事项列表、里程碑管理、论坛式消息传递、文件共享和时间跟踪。最多 3 个项目、20 个用户和 1GB 存储空间。
  * [bitrix24.com](https://www.bitrix24.com/)——内部网和项目管理工具。免费计划对无限用户提供 5GB。
  * [cacoo.com](https://cacoo.com/)——在线实时图表：流程图、UML、网络。免费最多 15 个用户/图表、25 张表
  ...
  * [Crosswork](https://crosswork.app/)——多功能项目管理平台。免费供最多 3 个项目、无限用户、1GB 存储空间使用。
  ...
  * [easyretro.io](https://www.easyretro.io/)——简单直观的冲刺回顾工具。免费计划每月每个板有三个公开板和一个调查。
  * [GForge](https://gforge.com)——用于复杂项目的项目管理和问题跟踪工具集，具有自托管和 SaaS 选项。SaaS 免费计划为前五个用户免费，并且对开源项目免费。
  * [gleek.io](https://www.gleek.io/)——免费的开发人员描述到图表工具。使用关键字创建非正式的 UML 类、对象或实体关系图。
  * [GraphQL Inspector](https://github.com/marketplace/graphql-inspector)——GraphQL Inspector 输出两个 GraphQL 模式之间的更改列表。每个差异都被精确解释，并标记为破坏性、非破坏性或危险的。
  * [huboard.com](https://huboard.com/)——针对您的 GitHub 问题的即时项目管理，对开源免费
  ...
  * [Ilograph](https://www.ilograph.com/)——允许用户从多个角度和详细程度查看其基础架构的交互式图表。图表可以用代码表示。免费层提供无限的私有图表，最多可容纳 3 个查看器。
  ...
  * [Kumu.io](https://kumu.io/)——具有动画、装饰、过滤器、聚类、电子表格导入等功能的关系图。免费层允许无限公开项目。图形大小不受限制。学生可免费使用私人项目。如果您不想将文件公开在线（上传、编辑、下载、丢弃），则提供沙盒模式。
  * [Linear](https://linear.app/)——界面简洁的问题跟踪器。免费供无限成员使用，文件上传大小最多为 10MB，问题数量最多为 250 个（不包括存档）
  * [leiga.com](https://www.leiga.com/)——Leiga 是一款使用 AI 自动管理项目的 SaaS 产品，帮助您的团队集中注意力并释放巨大潜力，确保项目按计划推进。免费供最多 10 个用户、20 个自定义字段、2GB 存储空间使用，视频录制 AI 限制为 5 分钟/视频，自动化运行频率为 20/用户/月。
  * [Lucidchart](https://www.lucidchart.com/)——具有协作功能的在线图表工具。免费计划有三个可编辑文档、100 个专业模板和基本协作功能。
  * [MeisterTask](https://www.meistertask.com/)——在线团队任务管理。免费供最多 3 个项目和无限项目成员使用。
  * [MeuScrum](https://www.meuscrum.com/en)——免费的在线 Scrum 工具，带有看板板
  * [nTask](https://www.ntaskmanager.com/)——项目管理软件，使您的团队能够协作、计划、分析和管理日常任务。Essential 计划永久免费，存储空间为 100MB，用户/团队数量不限。无限工作空间、会议、任务、时间表和问题跟踪。
  * [Ora](https://ora.pm/)——敏捷任务管理和团队协作。免费供最多 3 个用户使用，文件大小限制为 10MB。
  * [pivotaltracker.com](https://www.pivotaltracker.com/)——免费供无限公共项目和两个私人项目使用，每个项目有三个总活动用户（读写）和无限被动用户（只读）。
  ...
  * [point.poker](https://www.point.poker/)——在线规划扑克（基于共识的估计工具）。免费供无限用户、团队、会话、轮次和投票使用。您无需注册。
  * [ScrumFast](https://www.scrumfast.com)——具有非常直观界面的 Scrum 板，免费供最多 5 个用户使用。

  * [快捷键](https://shortcut.com/) - 项目管理平台。免费版最多可供 10 名用户永久使用。
  ...
  * [Tara AI](https://tara.ai/) — 简单的冲刺管理服务。免费版具有无限的任务、冲刺和工作区，且没有用户限制。
  * [targetprocess.com](https://www.targetprocess.com/) — 从看板和 Scrum 到几乎任何运营流程的可视化项目管理。免费版供无限用户使用，最多可容纳 1,000 个数据实体{[更多详细信息](https://www.targetprocess.com/pricing/) }
  * [taskade.com](https://www.taskade.com/) — 实时协作任务列表和团队大纲。免费版有一个工作区，其中包含无限的任务和项目；1GB 文件存储；项目历史记录为 1 周；以及每次视频会议最多 5 名参会者。
  ...
  * [teleretro.com](https://www.teleretro.com/) — 具有破冰游戏、动图和表情符号的简单有趣的回顾工具。免费版包括三个回顾和无限成员。
  * [testlio.com](https://testlio.com/) — 问题跟踪、测试管理和测试版测试平台。仅供私人使用免费
  * [terrastruct.com](https://terrastruct.com/) — 专门用于软件架构的在线图表制作工具。免费版每个图表最多可设置 4 层。
  ...
  * [Yodiz](https://www.yodiz.com/) — 敏捷开发和问题跟踪。免费版最多可供 3 名用户使用，无限项目。
  ...
  * [Zube](https://zube.io) — 具有免费计划的项目管理，最多可用于 4 个项目和 4 名用户。支持 GitHub 集成。
  * [Toggl](https://toggl.com/) — 提供两个免费的生产力工具。[Toggl Track](https://toggl.com/track/)用于时间管理和跟踪应用程序，其免费版提供了为自由职业者设计的无缝时间跟踪和报告。它具有无限的跟踪记录、项目、客户端、标签、报告等。以及[Toggl Plan](https://toggl.com/plan/)用于任务计划，其免费版适用于独奏开发人员，拥有无限的任务、里程碑和时间线。
...
## 存储和媒体处理
  ...
  * [cloudimage.io](https://www.cloudimage.io/en/home) - 具有全球 1500 多个 PoP 点的全面图像优化和 CDN 服务。多种图像缩放、压缩和水印功能。提供响应式图像、360 度图像制作和图像编辑的开源插件。免费计划包括每月 25GB 的 CDN 流量、25GB 的缓存存储和无限转换。
  * [cloudinary.com](https://cloudinary.com/) - 用于网站和应用的图像上传、强大的操作、存储和交付，提供 Ruby、Python、Java、PHP、Objective-C 等更多库。免费层包括 25 个每月信用额度。一个信用额度等于 1000 次图像转换、1GB 存储空间或 1GB CDN 使用量。
  * [embed.ly](https://embed.ly/) - 提供在网页中嵌入媒体、响应式图像缩放和从网页中提取元素的 API。免费使用高达 5000 个 URL/月，每秒 15 个请求
  * [filestack.com](https://www.filestack.com/) - 文件选择、转换和交付，免费 250 个文件、500 个转换和 3GB 带宽
  ...
  * [GoFile.io](https://gofile.io/) - 免费文件共享和存储平台，可通过基于网络的 UI 和 API 使用。无文件大小、带宽、下载数量等限制。但文件在不活动（10 天以上没有下载）时会被删除。
  ...
  * [ImgBB](https://imgbb.com/) - ImgBB 是一个无限制的图像托管服务。将您的图像拖放到屏幕上的任何位置。图像限制为 32MB。上传图像后接收直接图像链接、BBCode 和 HTML 缩略图。登录以查看上传历史记录。
  ...
  * [kraken.io](https://kraken.io/) - 网站性能优化的图像服务，免费计划最大文件大小为 1MB
  ...
  * [packagecloud.io](https://packagecloud.io/) - YUM、APT、RubyGem 和 PyPI 的托管包存储库。可通过请求获得有限的免费计划和开源计划
  ...
  * [podio.com](https://podio.com/) - 您可以使用 Podio 与最多五个人的团队合作，并试用基本计划的功能，不包括用户管理
  * [QuickChart](https://quickchart.io) - 生成可嵌入的图像图表、图形和 QR 码
  * [redbooth.com](https://redbooth.com) - 点对点文件同步，最多供 2 个用户使用
  ...
  * [Shotstack](https://shotstack.io) - 用于按比例生成和编辑视频的 API。每月免费提供高达 20 分钟的渲染视频
  * [tinypng.com](https://tinypng.com/) - 用于压缩和调整 PNG 和 JPEG 图像大小的 API，每月免费提供 500 次压缩
  * [transloadit.com](https://transloadit.com/) - 处理文件上传以及视频、音频、图像、文档的编码。免费提供给开源、慈善机构和学生，通过 GitHub 学生开发者包。商业应用在测试驱动时可获得 2GB 免费使用
  * [twicpics.com](https://www.twicpics.com) - 响应式图像即服务。它提供图像 CDN、媒体处理 API 和前端库，可自动优化图像。服务免费使用，每月最多 3GB 流量。
  * [uploadcare.com](https://uploadcare.com/hub/developers/) - Uploadcare 为开发人员提供基于尖端算法的媒体管道和终极工具包：文件上传 API 和 UI、图像 CDN 和源服务、自适应交付和智能压缩。免费层包括 3000 次上传、3GB 流量和 3GB 存储。
  * [imagekit.io](https://imagekit.io) - 具有自动优化、实时转换和存储的图像 CDN，您可以在几分钟内集成到现有设置中。免费计划包括每月最多 20GB 的带宽。
  * [internxt.com](https://internxt.com) - Internxt Drive 是基于绝对隐私和无可妥协的安全性的零知识文件存储服务。注册并获得免费的 10GB，永久！
  * [degoo.com](https://degoo.com/) - 基于人工智能的云存储，免费提供高达 20GB、三个设备、5GB 推荐奖金（90 天账户不活动）。

  * [ImageEngine](https://imageengine.io/)——ImageEngine 是一个易于使用的全球图像 CDN。设置时间少于 60 秒。支持 AVIF 和 JPEGXL，有 WordPress、Magento、React、Vue 等插件等。在此处[申请](https://imageengine.io/developer-program/)免费开发者账号。
  * [DocsParse](https://docsparse.com/)——GPT 驱动的 AI 处理 PDF、图像，将其转换为 JSON、CSV、EXCEL 格式的结构化数据。每月免费提供 30 个信用点。
...
## 设计和用户界面（UI）
  ...
  * [Float UI](https://floatui.com/) - 一个免费的 Web 开发工具，用于快速创建具有现代感和响应式的网站，即使是非设计师也能使用。
  * [Ant Design Landing Page](https://landing.ant.design/) - Ant Design Landing Page 提供了由 Ant Motion 的动画组件构建的模板。它有一个丰富的主页模板，下载模板代码包，并可以快速使用。你也可以使用编辑器快速构建自己的专用页面。
  * [Backlight](https://backlight.dev/) - 一个完整的编码平台，开发者和设计师可以在其中进行协作，团队可以在其中构建、记录、发布、扩展和维护设计系统。免费计划允许最多 3 个编辑器在一个设计系统上工作，并且没有观众数量限制。
  ...
  * [framer.com](https://www.framer.com/) - Framer 帮助你为下一个应用、网站或产品迭代和动画界面想法-从强大的布局开始。对于将 Framer 视为专业原型工具的任何人：无限的查看者，最多 2 个编辑器，最多 3 个项目。
  ...
  * [landen.co](https://www.landen.co) - 为你的初创公司生成、编辑和发布美丽的网站和登录页面。无需代码。免费层允许你拥有一个完全可定制的网站，并在网络上发布。
  * [Quant Ux](https://quant-ux.com/) - Quant Ux 是一个原型制作和设计工具。-它完全免费，也是开源的。
  * [lensdump.com](https://lensdump.com/) - 免费云图像托管。
  * [Lorem Picsum](https://picsum.photos/) - 一个免费的工具，易于使用，时尚的占位符。在我们的 URL 后面，添加你想要的图像大小（宽度和高度），你将得到一个随机图像。
  ...
  * [Mindmup.com](https://www.mindmup.com/) - 无限的思维导图免费使用，并存储在云中。你的思维导图在任何地方，瞬间，从任何设备。
  ...
  * [Mossaik](https://mossaik.app) - 具有不同工具的免费 SVG 图像生成器，如波浪、博客和图案。
  * [movingpencils.com](https://movingpencils.com/) - 快速的基于浏览器的向量编辑器。完全免费。
  * [Octopus.do](https://octopus.do) - 可视化站点地图生成器。实时构建你的网站结构，并迅速与你的团队或客户共享以进行协作。
  * [Pencil](https://github.com/evolus/pencil) - 使用 Electron 的开源设计工具。
  * [Penpot](https://penpot.app) - 基于网络的开源设计和原型制作工具。支持 SVG。完全免费。
  * [pexels.com](https://www.pexels.com/) - 免费的商业用途库存照片。有一个免费的 API，允许你按关键字搜索照片。
  ...
  * [Plasmic](https://www.plasmic.app/) - 一个快速、易于使用、强大的 Web 设计工具和页面构建器，可集成到你的代码库中。构建响应式页面或复杂组件；可选地使用代码扩展；并发布到生产站点和应用程序。
  * [Pravatar](https://pravatar.cc/) - 生成随机的占位符假头像，其 URL 可以直接在你的网络/应用程序中链接。
  * [Proto.io](https://www.proto.io) - 创建完全交互的 UI 原型，无需编码。免费层在免费试用结束后可用。免费层包括一个用户、一个项目、五个原型、100MB 的在线存储和 proto.io 应用程序的预览。
  * [resizeappicon.com](https://resizeappicon.com/) - 一个简单的服务，用于调整和管理你的应用程序图标。
  * [Rive](https://rive.app) - 创建并将美丽的动画发送到任何平台。个人用户免费永久使用。该服务是一个编辑器，也在其服务器上托管所有图形。他们还为许多平台提供运行时，以运行使用 Rive 创建的表示形式。
  * [storyset.com](https://storyset.com/) - 使用此工具为你的项目创建令人难以置信的免费定制插图。
  ...
  * [UI Avatars](https://ui-avatars.com/) - 使用名称的首字母生成头像。其 URL 可以直接在你的网络/应用程序中链接。支持通过 URL 配置参数。
  * [unDraw](https://undraw.co/) - 一个不断更新的美丽 SVG 图像集合，你可以完全免费使用，无需归属。
  ...
  * [Unicorn Platform](https://unicornplatform.com/)——轻松的着陆页构建器，提供托管。免费提供一个网站。
  ...
  * [svgrepo.com](https://www.svgrepo.com/)——使用各种向量库探索、搜索和查找最适合您项目的图标或向量。下载免费的 SVG 向量用于商业用途。
  ...
  * [Vertopal](https://www.vertopal.com)——Vertopal 是一个免费的在线文件转换平台。包括 JPG 到 SVG、GIF 到 APNG、PNG 到 WEBP、JSON 到 XML 等开发人员转换器。
  ...
  * [Logo.dev](https://www.logo.dev)——具有 4400 万多个品牌的公司徽标 API，使用起来就像调用 URL 一样简单。前 10,000 次 API 调用是免费的。
  ...
  * [Webstudio](https://webstudio.is/)——Webflow 的开源替代方案。免费计划在其域名上提供无限数量的网站。五个网站和自定义域名。每月十万次页面浏览量。2GB 资产存储。
...
## 设计灵感
  ...
  * [Lapa Ninja](https://www.lapa.ninja/) - [着陆页/UI 套件/网页截图] Lapa Ninja 是一个画廊，展示了最好的 6025 个着陆页示例，为设计师提供免费书籍和来自网络的免费 UI 套件。
  ...
  * [Mobile Patterns](https://www.mobile-patterns.com/) - [移动屏幕截图] 一个设计灵感库，其中包含设计师、开发人员和产品制造商可以参考的 iOS 和 Android 上最精美的 UI UX 模式。
  * [Page Flows](https://pageflows.com/) - [移动/web 视频和屏幕截图] 许多移动和网络应用的完整流程视频。还包括屏幕截图。可高度搜索和索引。
  * [Screenlane](https://screenlane.com/) - [移动屏幕截图] 获取灵感并跟上最新的网络和移动应用程序 UI 设计趋势。可以按模式和应用程序进行筛选。
  * [scrnshts](https://scrnshts.club/) - [移动屏幕截图] 精心挑选的最佳应用商店设计屏幕截图集合。
  * [UI Garage](https://uigarage.net/) - [移动/web 屏幕截图] 设计师和开发人员日常 UI 灵感和模式，以找到灵感、工具和项目的最佳资源。
...
## 地图上的数据可视化
  ...
  * [IP Geolocation](https://ipgeolocation.io/)——提供免费的开发者计划，每月有 30K 请求。
  ...
  * [here](https://developer.here.com/)——用于地图和位置感知应用的 API 和 SDK。免费使用 250k 笔交易/月。
  ...
  * [nextbillion.ai](https://nextbillion.ai/)——与地图相关的服务：地理编码、导航（方向、路由、路线优化、距离矩阵）、地图 SDK（矢量、静态、移动 SDK）。[免费使用指定配额](https://nextbillion.ai/pricing)每个服务。
...
## 集成开发环境（IDE）和代码编辑
  ...
  * [AndroidIDE](https://m.androidide.com/) - 在 Android 设备上开发基于 Gradle 的真实 Android 应用程序的开源 IDE。
  ...
  * [Binder](https://mybinder.org/) - 将 Git 存储库转换为一系列交互笔记本。这是一项免费的公共服务。
  * [BlueJ](https://bluej.org) - 一款免费的 Java 开发环境，专为初学者设计，全球有数百万人使用。由甲骨文提供支持，具有简单的 GUI 可帮助初学者。
  ...
  * [Cody](https://sourcegraph.com/cody) - 免费的 AI 编码助手，可以编写（代码块、自动完成、单元测试）、理解（对整个代码库的知识）、修复和查找代码。可用于 VS Code、JetBrains 和在线使用。
  * [codiga.io](https://codiga.io/) - 一种编码助手，可让您在 IDE 中直接搜索、定义和重用代码片段。个人和小组织免费使用。
  ...
  * [Eclipse Che](https://www.eclipse.org/che/) - 用于开发团队的基于 Web 和 Kubernetes 的 IDE，支持多种语言。开源且由社区驱动。红帽提供了一个在线实例，可在[workspaces.openshift.com](https://workspaces.openshift.com/)上访问。
  * [fakejson.com](https://fakejson.com/) - FakeJSON 可以帮助您使用其 API 快速生成虚假数据。发出描述您想要的内容和方式的 API 请求。API 以 JSON 格式返回所有内容。加快创意的推向市场进程，先假后真。
  * [GetVM](https://getvm.io) - 即时免费的 Linux 和 IDE 浏览器侧边栏。免费层包括每天 5 个 VM。
  ...
  * [MarsCode](https://www.marscode.com/) - 一个免费的基于人工智能的云托管 IDE。
  ...
  * [Mocklets](https://mocklets.com) - 基于 HTTP 的模拟 API 模拟器，可帮助模拟 API 以实现更快的并行开发和更全面的测试，具有终身免费层。
  ...
  * [Prepros](https://prepros.io/) - Prepros 可以开箱即用编译 Sass、Less、Stylus、Pug/Jade、Haml、Slim、CoffeeScript 和 TypeScript，刷新您的浏览器，使开发和测试您的网站变得容易，您可以专注于使它们完美。您还可以通过点击几下添加自己的工具。
  ...
  * [VSCodium](https://vscodium.com/) - 由社区驱动，无遥测/跟踪功能，且为 Microsoft 编辑器 VSCode 的自由许可二进制分发
  ...
  * [Zed](https://zed.dev/) - Zed 是一款由 Atom 和 Tree-sitter 的创建者开发的高性能、多人游戏代码编辑器。
...
## 分析、事件和统计
  ...
  * [Avo](https://avo.app/)——简化分析发布工作流程。单一来源的跟踪计划、类型安全的分析跟踪库、应用内调试器和数据可观测性，可在发布前捕获所有数据问题。免费提供给两个工作区成员和 1 小时的数据可观测性回溯。
  ...
  * [GoatCounter](https://www.goatcounter.com/)——GoatCounter 是一个开源的网络分析平台，可作为托管服务（免费供非商业使用）或自托管应用程序使用。它旨在提供易于使用和有意义的隐私友好型网络分析，作为 Google Analytics 或 Matomo 的替代方案。免费层适用于非商业用途，包括无限数量的网站、六个月的数据保留和每月 10 万次页面浏览量。
  ...
  * [Moesif](https://www.moesif.com)——API 分析，适用于 REST 和 GraphQL。（免费使用量高达每月 500 万次 API 调用）
  ...
  * [Row Zero](https://rowzero.io)——快速连接的电子表格。直接连接到数据数据库、S3 和 API。导入、分析、绘图和共享数百万行数据瞬间完成。三个免费（永久）工作簿。
  * [sematext.com](https://sematext.com/cloud/)——每月最多 50 K 次操作，1 天数据保留，无限仪表板、用户等。
  * [Similar Web](https://similarweb.com)——网络和移动应用分析。免费计划提供每个指标的五个结果，一个月的移动应用数据和三个月的网站数据。
  * [StatCounter](https://statcounter.com/)——网站访问者分析。免费计划适用于 500 名最近访问者的分析。
  * [Statsig](https://statsig.com)——跨分析、功能标志和 A/B 测试的一体化平台。免费提供高达每月 100 万次度量事件。
  ...
  * [usabilityhub.com](https://usabilityhub.com/)——在真实用户身上测试设计和模型并跟踪访问者。免费供一个用户使用，无限制的测试次数
  * [woopra.com](https://www.woopra.com/)——免费的用户分析平台，适用于 500K 次操作，90 天数据保留，30 多个一键集成。
  * [counter.dev](https://counter.dev)——简单易用的网络分析，因此具有隐私性。免费或按您的意愿通过捐赠支付。
  * [PostHog](https://posthog.com)——完整的产品分析套件，每月最多可跟踪 100 万次事件免费。还提供每月 250 次响应的无限应用内调查。
  ...
  * [Beampipe.io](https://beampipe.io)——Beampipe 是一种简单、注重隐私的网络分析。免费适用于最多 5 个域和每月 10k 次页面浏览量。
  ...
  * [TrackWith Dicloud](https://dicloud.net/trackwith-privacy-focused-analytics/)——免费的轻量级注重隐私的 Google Analytics 替代方案。无限制的页面浏览量、无限制的访问者、无限制的页面热图和目标跟踪。免费提供最多 3 个域和每个域 600 次会话回放。
  * [AppFit](https://appfit.io)——AppFit 是一款全面的分析和产品管理工具，旨在促进跨平台管理分析和产品更新的无缝衔接。免费计划包括每月 10,000 次事件、产品日记和每周见解。

**[⬆️ 返回顶部](# 目录 )**

## 访问者会话记录

  * [Reactflow.com](https://www.reactflow.com/)——每个站点：每天 1000 页浏览量，三个热点图，三个小部件，免费错误跟踪
  * [OpenReplay.com](https://www.openreplay.com)——开源会话重放，带有用于错误重现的开发工具，实时会话支持和产品分析套件。每月一千个会话，访问所有功能和 7 天保留期。
  * [LogRocket.com](https://www.logrocket.com)——每月 1000 个会话，30 天保留期，错误跟踪，实时模式
  ...
  * [hotjar.com](https://www.hotjar.com/)——每个站点：每月 1050 页浏览量，无限热点图，数据存储三个月
  ...
  * [smartlook.com](https://www.smartlook.com/)——网络和移动应用的免费套餐（每月 1500 次会话），三个热点图，一个漏斗，1 个月数据历史记录
...
## 支付和计费集成
  ...
  * [Glassfy](https://glassfy.io/) - 应用内订阅基础设施，实时订阅事件和即开即用的货币化工具，适用于 iOS、Android、Stripe 和 Paddle。每月免费收入高达$10k。
  ...
  * [CurrencyApi](https://currencyapi.net/) - 用于物理和加密货币的实时货币汇率，以 JSON 和 XML 形式提供。免费层每月提供 1,250 个 API 请求。
  ...
  * [RevenueCat](https://www.revenuecat.com/) - 应用内购买和订阅的托管后端（iOS 和 Android）。每月跟踪收入免费至$2.5k。
...
## Docker相关
  ...
  * [ttl.sh](https://ttl.sh/)——匿名且短暂的 Docker 镜像注册表
...
## 评论平台
  ...
  * [Utterances](https://utteranc.es/) - 一个基于 GitHub 问题的轻量级评论小部件。将 GitHub 问题用于博客评论、wiki 页面等！
  * [Disqus](https://disqus.com/) - Disqus 是一个网络社区平台，被数十万网站在互联网上使用。
  * [Remarkbox](https://www.remarkbox.com/) - 开源托管评论平台，可按需支付“在几个域中有一位管理员，可完全控制行为和外观”
...
## 屏幕截图API
  ...
  * [microlink.io](https://microlink.io/) - 它将任何网站转换为数据，例如元标记规范化、美观的链接预览、抓取功能或屏幕截图服务。每天免费 250 次请求。
...
## 与Flutter相关和在没有Mac的情况下构建IOS应用程序
  ...
  * [CodeMagic](https://codemagic.io/) - CodeMagic 是一个完全托管和管理的移动应用持续集成/持续部署服务。您可以使用基于图形界面的持续集成/持续部署工具进行构建、测试和部署。免费套餐提供 500 分钟/月的免费使用时间和一个配备 2.3GHz 处理器和 8GB 内存的 Mac Mini 实例。
...
## 隐私管理
  ...
  * [Bearer](https://www.bearer.sh/) - 通过审计和持续工作流程帮助实现隐私设计，使组织符合 GDPR 等法规。免费层限于较小的团队和 SaaS 版本。
...
## 杂项
  ...
  * [Carbon.now.sh](https://carbon.now.sh) - 以美观的截图形式创建和分享代码片段。通常用于在 Twitter 或博客文章上美观地分享/展示代码片段。
  * [Code Time](https://www.software.com/code-time) - VS Code、Atom、IntelliJ、Sublime Text 等中的扩展，用于跟踪时间和编码指标。
  ...
  * [FOSSA](https://fossa.com/) - 第三方代码、许可证合规性和漏洞的可扩展、端到端管理。
  ...
  * [kandi](https://kandi.openweaver.com/) - 启动应用程序开发：通过代码片段和开源库的重用，更快地构建自定义函数、用例和完整的应用程序。
  ...
  * [QuickType.io](https://quicktype.io/) - 从 JSON、模式和 GraphQL 快速自动生成数据模型/类/类型/接口和序列化程序，以便在任何编程语言中快速安全地处理数据。将 JSON 转换为任何语言的漂亮、类型安全的代码。
  ...
  * [superfeedr.com](https://superfeedr.com/) - 实时 PubSubHubbub 兼容的提要、导出、分析。免费版定制较少。
  ...
  * [Versionfeeds](https://versionfeeds.com) - 您喜爱的软件版本的自定义 RSS 饲料。将您编程语言、库或喜爱的工具的最新版本放在一个饲料中。（前 3 个饲料是免费的）
...
## 其他免费资源
  ...
  * [Wikimint 开发者](https://developer.wikimint.com/p/tools.html) - 面向网络开发者的免费工具，包括 CSS 压缩/解压、图像优化、图像大小调整、大小写转换、CSS 验证、JavaScript 编译器、HTML 编辑器等。
  ...
  * [Markdown 工具](https://markdowntools.com) - 将 HTML、CSV、PDF、JSON 和 Excel 文件转换为和从 Markdown 的工具。
  ...
  * [SimpleBackups.com](https://simplebackups.com/) - 服务器和数据库（MySQL、PostgreSQL、MongoDB）的备份自动化服务，直接存储到云存储提供商（AWS、DigitalOcean 和 Backblaze）。提供一个免费计划，可进行 1 次备份。
  ...
  * [SmallDev.tools](https://smalldev.tools/) - 一款免费的开发者工具，可让您对各种格式进行编码/解码、HTML/CSS/Javascript 压缩、美化、生成假/测试数据集（JSON/CSV 等）以及许多其他功能。具有令人愉悦的界面。
  * [UseCSV by Layercode](https://layercode.com/usecsv) - 在您的网络应用程序中几分钟内添加 CSV 和 Excel 导入。为您的用户提供愉快且强大的数据导入体验。免费开始，无需任何信用卡详细信息，立即开始集成 UseCSV。您可以创建无限的导入器，上传的文件最大可达 100Mb。
  ...
  * [PageTools](https://pagetools.co/) - 提供一套永久免费的人工智能驱动的工具，帮助您生成基本的网站政策，创建社交媒体个人资料、帖子和网页，只需点击一下即可。
  * [MySQL Visual Explain](https://mysqlexplain.com) - 易于理解且免费的 MySQL EXPLAIN 输出可视化工具，可优化慢速查询。
  * [Killer Coda](https://killercoda.com/) - 在您的浏览器中交互式的学习环境，用于研究 Linux、Kubernetes、容器、编程、DevOps、网络
