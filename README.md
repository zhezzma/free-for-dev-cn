...
## APIs、数据和 ML
  ...
  * [Diggernaut](https://www.diggernaut.com/) - 基于云的网络抓取和数据提取平台，用于将任何网站转换为数据集或作为 API 与之协作。免费计划每月包括 5K 页面请求。
...
## 团队协作工具
  ...
  * [Notion](https://www.notion.so/) - Notion 是一款支持 Markdown 的笔记和协作应用程序，集成了任务、维基和数据库。该公司将该应用程序描述为一个用于笔记、项目管理和任务管理的一体化工作区。除了跨平台应用程序外，还可以通过大多数网络浏览器访问它。
  ...
  * [Revolt.chat](https://revolt.chat/) - [Discord](https://discord.com/)的开源替代品，尊重您的隐私。它还免费提供大多数来自 Discord 的专有功能。Revolt 是一个安全、快速且 100%免费的一体化应用程序。所有功能都是免费的。与大多数主流聊天应用程序不同，它们还支持（官方和非官方）插件。
...
## 测试
  ...
  * [Applitools.com](https://applitools.com/) - 适用于网络、原生移动和桌面应用的智能视觉验证。与几乎所有自动化解决方案（如 Selenium 和 Karma）以及远程运行器（Sauce Labs、Browser Stack）集成。对开源免费。免费层级为单个用户提供每周有限的检查点。
  ...
  * [Keploy](https://keploy.io/) - Keploy 是一个面向开发人员的功能测试工具包。记录 API 调用为 API（KTests）和模拟或存根（KMocks）生成 E2E 测试。对开源项目免费。
  * [loadmill.com](https://www.loadmill.com/) - 通过分析网络流量自动创建 API 和负载测试。每月免费模拟多达 50 个并发用户，最长 60 分钟。
  * [octomind.dev](https://www.octomind.dev/) - 使用 AI 辅助测试用例生成自动生成、运行和维护 Playwright UI 测试
  * [preflight.com](https://preflight.com) - 无代码自动化 Web 测试。在浏览器上记录对 UI 更改具有弹性的测试，并在 Windows 机器上运行它们。您可以与您的 CI/CD 集成吗？免费计划包括每月 50 次带有视频、HTML 会话等的测试运行。
  * [Argos](https://argos-ci.com) - 针对开发人员的开源视觉测试。无限制项目，每月 5,000 个截图。对开源项目免费。
  ...
  * [Repeato](https://repeato.app/) 基于计算机视觉和 AI 构建的无代码移动应用测试自动化工具。适用于原生应用、Flutter、React Native、Web、Ionic 等许多应用框架。免费计划仅限于 iOS 的 10 次测试和 Android 的 10 次测试，但包括付费计划的大多数功能，包括无限次测试运行。
  * [Requestly](https://requestly.com/) 开源 Chrome 扩展程序，用于拦截、重定向和模拟 HTTP 请求。具有[调试器](https://requestly.com/products/web-debugger/)、[模拟服务器](https://requestly.com/products/mock-server/)、[API 客户端](https://requestly.com/products/api-client/)和[会话记录](https://requestly.com/products/session-book/)。重定向 URL、修改 HTTP 标头、模拟 API、注入自定义 JS、修改 GraphQL 请求、生成模拟 API 端点、记录带有网络和控制台日志的会话。在免费层级中创建最多 10 条规则。对开源免费。
  * [seotest.me](https://seotest.me/) - 免费的页面 SEO 网站测试器。每天 10 次免费网站抓取。有用的 SEO 学习资源和关于如何改善任何网站的页面 SEO 结果的建议，无论技术如何。
  * [snippets.uilicious.com](https://snippets.uilicious.com) - 它就像 CodePen，但用于跨浏览器测试。UI-licious 允许您像用户故事一样编写测试，并提供一个免费平台 - UI-licious Snippets - 允许您在 Chrome 上运行无限次测试，无需注册，每次测试运行最多 3 分钟。发现了一个错误？您可以复制您的测试的唯一 URL，以向您的开发人员准确展示如何重现该错误。
  * [TestCollab](https://testcollab.com) - 一个用户友好的测试管理软件，其免费计划包括 Jira 集成、无限制项目、使用 CSV/XLSx 进行测试用例导入、时间跟踪和 1GB 文件存储。
  * [testingbot.com](https://testingbot.com/) - Selenium 浏览器和设备测试，[对开源免费](https://testingbot.com/open-source)
  * [Testspace.com](https://testspace.com/) - 用于发布自动化测试结果的仪表板和使用 GitHub 将手动测试作为代码实现的框架。该服务[对开源免费](https://github.com/marketplace/testspace-com)，每月可处理 450 个结果。
  ...
  * [qase.io](https://qase.io) - 面向开发和 QA 团队的测试管理系统。管理测试用例、编写测试运行、执行测试、跟踪缺陷并衡量影响。免费层包括所有核心功能，附件可用空间为 500MB，最多可支持 3 个用户。
  * [knapsackpro.com](https://knapsackpro.com) - 通过在任何 CI 提供商上进行最佳测试套件并行化来加速您的测试。在并行 CI 节点上拆分 Ruby、JavaScript 测试以节省时间。免费计划提供最多 10 分钟的测试文件，开源项目可免费使用无限计划。
  ...
  * [webhook-test.com](https://webhook-test.com) - 在集成过程中使用唯一 URL 调试和检查 Webhooks 和 HTTP 请求。完全免费，您可以创建无限的 URL 并接收推荐。

**[⬆️ 返回顶部](#table-of-contents)**

## 安全与 PKI

  * [aikido.dev](https://www.aikido.dev) — 涵盖 SCA、SAST、CSPM、DAST、机密、IaC、恶意软件、容器扫描、EOL 等的一体化应用安全平台。免费计划包括两名用户、10 个仓库、1 个云、2 个容器和 1 个域名的扫描。
  ...
  * [Doppler](https://doppler.com/) — 通用机密管理器，用于应用程序机密和配置，支持同步到各种云提供商。基本访问控制下的五个用户免费。
  * [Dotenv](https://dotenv.org/) — 同步您的.env 文件，快速安全。停止通过不安全的渠道（如 Slack 和电子邮件）共享您的.env 文件，再也不会丢失重要的.env 文件。最多 3 名队友免费。
  * [GitGuardian](https://www.gitguardian.com) — 通过自动检测和修复机密来防止机密进入您的源代码。扫描您的 git 存储库中的 350 多种类型的机密和敏感文件 - 个人和 25 名或更少开发人员的团队免费。
  * [Have I been pwned?](https://haveibeenpwned.com) — 获取违规信息的 REST API。
  * [hostedscan.com](https://hostedscan.com) — 用于 Web 应用程序、服务器和网络的在线漏洞扫描程序。每月免费扫描十次。
  * [Infisical](https://infisical.com/) — 开源平台，可让您在团队和基础架构中管理开发人员机密：从本地开发到暂存/生产第三方服务的任何地方。最多 5 名开发人员免费。
  ...
  * [opswat.com](https://www.opswat.com/) — 计算机、设备、应用程序、配置的安全监控，免费 25 名用户和 30 天历史用户。
  ...
  * [pyup.io](https://pyup.io) — 监控 Python 依赖项的安全漏洞并自动更新它们。一个私有项目免费，开源项目无限制。
  ...
  * [seclookup.com](https://seclookup.com/) - Seclookup API 可以在 SIEM 中丰富域威胁指标，提供有关域名的全面信息，并改进威胁检测和响应。在此处获取 50K 次免费查找 [here](https://account.seclookup.com/)。
  * [snyk.io](https://snyk.io) — 可以在您的开源依赖项中查找和修复已知的安全漏洞。开源项目的无限制测试和修复。您的私有项目每月限制为 200 次测试。
  ...
  * [StackHawk](https://www.stackhawk.com/) 在整个管道中自动化应用程序扫描，以在它们进入生产之前查找和修复安全漏洞。单个应用程序的无限制扫描和环境。
  ...
  * [threatconnect.com](https://threatconnect.com) — 威胁情报：它专为开始了解网络威胁情报的个人研究人员、分析师和组织而设计。最多 3 个用户免费
  * [tinfoilsecurity.com](https://www.tinfoilsecurity.com/) — 自动化漏洞扫描。免费计划允许每周进行 XSS 扫描
  * [Ubiq Security](https://ubiqsecurity.com/) — 用三行代码和自动密钥管理加密和解密数据。一个应用程序免费，每月最多 1,000,000 次加密。
  * [Virgil Security](https://virgilsecurity.com/) — 在您的数字解决方案中实施端到端加密、数据库保护、物联网安全等的工具和服务。最多 250 个用户的应用程序免费。
* [Vulert](https://vulert.com) - Vulert 持续监测你的开源依赖项是否存在新漏洞，推荐修复方案，无需安装或访问你的代码库。开源项目免费。
...
## 认证、授权和用户管理
  ...
  * [Aserto](https://www.aserto.com) - 为应用程序和 API 提供细粒度的授权服务。免费使用，每月活跃用户数（MAU）高达 1000 人，授权实例数 100 个。
  * [asgardeo.io](https://wso2.com/asgardeo) - 无缝集成单点登录（SSO）、多因素认证（MFA）、无密码认证等。包括前端和后端应用的 SDK。免费使用，每月活跃用户数（MAU）高达 1000 人，支持五个身份提供商。
  * [Auth0](https://auth0.com/) - 托管的单点登录服务。每月活跃用户数（MAU）高达 7000 人，支持两个社交身份提供商。
  * [Authgear](https://www.authgear.com) - 几分钟内为您的应用添加无密码、OTP、2FA、SSO 等功能。包括所有前端。免费使用，每月活跃用户数（MAU）高达 5000 人。
  * [Authress](https://authress.io/) - 认证登录和访问控制，为任何项目提供无限的身份提供商。支持 Facebook、Google、Twitter 等。前 1000 次 API 调用免费。
  * [Authy](https://authy.com) - 在多个设备上进行双因素认证（2FA），并支持备份。可替代 Google Authenticator。免费使用，最多支持 100 次成功认证。
  * [Cerbos Hub](https://www.cerbos.dev/product-cerbos-hub) - 一个完整的授权管理系统，用于创作、测试和部署访问策略。细粒度的授权和访问控制，每月活跃主体数高达 100 人。
  * [Clerk](https://clerk.com) - 用户管理、认证、2FA/MFA、登录、注册、用户配置文件等预构建的 UI 组件。免费使用，每月活跃用户数（MAU）高达 10,000 人。
  * [Cloud-IAM](https://www.cloud-iam.com/) - Keycloak 身份和访问管理即服务。免费使用，最多支持 100 个用户和一个领域。
  * [Corbado](https://www.corbado.com/) - 为新应用或现有应用添加 passkey-first 认证。免费使用，每月活跃用户数（MAU）不限。
  * [Descope](https://www.descope.com/) - 高度可定制的 AuthN 流程，具有无代码和 API/SDK 两种方法，每月活跃用户数（MAU）高达 7,500 人，租户数 50 个（最多 5 个 SAML/SSO 租户）。
  * [duo.com](https://duo.com/) - 网站或应用的双因素认证（2FA）。免费使用，最多支持 10 个用户，支持所有认证方法，无限制集成，硬件令牌。
  * [Kinde](https://kinde.com/) - 简单、强大的认证，您可以在几分钟内将其集成到您的产品中。提供 7,500 个免费的每月活跃用户数（MAU）。
  * [logintc.com](https://www.logintc.com/) - 通过推送通知进行双因素认证（2FA），免费使用，最多支持 10 个用户，支持 VPN、网站和 SSH。
  * [MojoAuth](https://mojoauth.com/) - MojoAuth 使您可以在几分钟内轻松在您的网络、移动或任何应用中实现无密码认证。
  * [Okta](https://developer.okta.com/signup/) - 用户管理、认证和授权。免费使用，每月活跃用户数（MAU）高达 100 人。
  * [onelogin.com](https://www.onelogin.com/) - 身份即服务（IDaaS）、单点登录身份提供商、云 SSO IdP、三个公司应用和五个个人应用，用户数不限。
  * [Ory](https://ory.sh/) - AuthN/AuthZ/OAuth2.0/零信任管理安全平台。永远免费的开发者账户，具有所有安全功能，团队成员不限，每日活跃用户数 200 人，每月权限检查 25,000 次。
  * [Phase Two](https://phasetwo.io) - Keycloak 开源身份和访问管理。免费领域，最多支持 1000 个用户，最多支持 10 个 SSO 连接，利用 Phase Two 的 Keycloak 增强容器，其中包括[组织](https://phasetwo.io/product/organizations/)扩展。
  * [Stytch](https://www.stytch.com/) - 灵活的认证 API 和 SDK，具有抗攻击性密码、无密码登录流程、MFA、SSO 等。内置电子邮件/SMS 发送+故障转移和欺诈保护。提供 5,000 个每月活跃用户数（MAU）免费（B2C）或 1,000 个每月活跃用户数（MAU）和 25 个组织免费（B2B）。
  * [Stack Auth](https://stack-auth.com) - 开源认证，不会让您失望。最开发者友好的解决方案，让您在短短五分钟内开始使用。可免费自托管，或提供具有 10,000 个免费每月活跃用户数（MAU）的托管 SaaS 版本。
  * [SuperTokens](https://supertokens.com/) - 开源用户认证，可原生集成到您的应用中 - 使您能够快速开始使用，同时控制用户和开发者体验。免费使用，每月活跃用户数（MAU）高达 5000 人。
  * [Warrant](https://warrant.dev/) - 为您的应用提供托管的企业级授权和访问控制服务。免费层包括每月 100 万次 API 请求和 1,000 个授权规则。
  * [ZITADEL Cloud](https://zitadel.com) - 一个为您工作并支持多租户（B2B）用例的一站式用户和访问管理。免费使用，每月最多支持 25,000 次认证请求，具有所有安全功能（OTP、无密码、策略等无付费墙）。
  * [PropelAuth](https://propelauth.com) - 通过几行代码立即向任何规模的公司销售，最多支持 200 个用户和 10,000 个事务性电子邮件（带有水印品牌：“由 PropelAuth 提供支持”）。
  * [Logto](https://logto.io/) - 开发、保护和管理您产品的用户身份 - 用于认证和授权。免费使用，每月活跃用户数（MAU）高达 5,000 人，提供开源自托管选项。
  * [WorkOS](https://workos.com/) - 免费用户管理和认证，每月活跃用户数（MAU）高达 100 万。支持电子邮件+密码、社交认证、Magic Auth、MFA 等。
...
## 移动应用分发和反馈
  ...
  * [TestApp.io](https://testapp.io) - 确保您的移动应用按预期工作的首选平台。免费计划：一个应用、分析、无限版本和安装以及反馈收集。
  * [Loadly](https://loadly.io) - iOS 和 Android 测试应用分发服务，提供完全免费的服务，无限下载、高速下载和无限上传。
  * [Diawi](https://www.diawi.com) - 直接将 iOS 和 Android 应用部署到设备上。免费计划：应用上传、密码保护链接、1 天过期、10 次安装。
  * [InstallOnAir](https://www.installonair.com) - 通过空中分发 iOS 和 Android 应用。免费计划：无限上传、私人链接、访客 2 天过期、注册用户 60 天过期。
...
## 管理系统
  ...
  * [bitnami.com](https://bitnami.com/) - 在 IaaS 上部署准备好的应用。免费管理一个 AWS 微型实例。
  * [Esper](https://esper.io) - 具有 DevOps 的 Android 设备的 MDM 和 MAM。免费提供 100 个设备，一个用户许可证和 25MB 应用存储空间。
  * [jamf.com](https://www.jamf.com/) - iPad、iPhone 和 Mac 的设备管理，免费提供三个设备。
  * [Miradore](https://miradore.com) - 设备管理服务。免费保持您的设备舰队最新状态，并安全地管理无限数量的设备。免费计划提供基本功能。
  * [moss.sh](https://moss.sh) - 帮助开发人员部署和管理他们的 Web 应用和服务器。每月免费最多 25 次 git 部署。
  * [runcloud.io](https://runcloud.io/) - 主要专注于 PHP 项目的服务器管理。免费提供一个服务器。
...
## 消息传递和流媒体
  ...
  * [Ably](https://www.ably.com/) - 具有存在性、持久性和保证交付的实时消息传递服务。免费计划包括每月 300 万条消息、100 个峰值连接和 100 个峰值通道。
  ...
  * [NotificationAPI.com](https://www.notificationapi.com/) - 在 5 分钟内为任何软件添加用户通知。免费计划包括每月 10,000 个通知+100 个短信和自动呼叫。
  * [Novu.co](https://novu.co) - 为开发人员提供的开源通知基础设施。用于在一个地方管理所有通信渠道的简单组件和 API：电子邮件、短信、直接、应用内和推送。免费计划包括每月 30,000 个通知，保留 90 天。
  ...
  * [eyeson API](https://developers.eyeson.team/) - 基于 WebRTC（SFU、MCU）的视频通信 API 服务，用于构建视频平台。允许实时数据注入、视频布局、录制、功能齐全的托管 Web UI（快速入门）或自定义 UI 包。为开发人员提供[免费层](https://apiservice.eyeson.com/api-pricing)，每月有 1000 分钟的会议时间。
  ...
  * [httpSMS](https://httpsms.com) - 使用您的 Android 手机作为 SMS 网关发送和接收文本消息。每月免费发送和接收多达 200 条消息。
...
## 日志管理
  ...
  * [bugfender.com](https://bugfender.com/) - 免费提供多达 10 万条日志行/天，保留 24 小时。
  * [logentries.com](https://logentries.com/) - 免费提供多达 5GB/月，保留 7 天。
  * [loggly.com](https://www.loggly.com/) - 免费提供给单个用户，每天 200MB，保留 7 天。
  * [logz.io](https://logz.io/) - 免费提供多达 1GB/天，保留 1 天。
  ...
  * [sematext.com](https://sematext.com/logsene) - 免费提供多达 500MB/天，保留 7 天。
  * [sumologic.com](https://www.sumologic.com/) - 免费提供多达 500MB/天，保留 7 天。
  * [logflare.app](https://logflare.app/) - 每个应用每月最多 12960000 条记录免费，保留 3 天。
  * [logtail.com](https://logtail.com/) - 基于 ClickHouse 的 SQL 兼容日志管理。每月最多 1GB 免费，保留 3 天。
  * [logzab.com](https://logzab.com/) - 审计跟踪管理系统。每月免费提供 1000 条用户活动日志，保留 1 个月，最多 5 个项目。

**[⬆️ 返回顶部](#table-of-contents)**

## 翻译管理

  * [crowdin.com](https://crowdin.com/) - 开源项目无限，字符串无限，协作者无限。
  ...
  * [localazy.com](https://localazy.com) - 最多 1000 个源语言字符串免费，语言无限，贡献者无限，启动和开源交易。
  ...
  * [weblate.org](https://weblate.org/) - 对于自由项目免费，免费层最多 10,000 个字符串源，并且无限制自托管本地。
...
## 监控
  ...
  * [appdynamics.com](https://www.appdynamics.com/) — 免费提供 24 小时指标，应用性能管理代理仅限于一个 Java、一个.NET、一个 PHP 和一个 Node.js。
  * [appneta.com](https://www.appneta.com/) — 免费提供 1 小时的数据保留。
  * [appspector.com](https://appspector.com/) - 用于远程 iOS/Android/Flutter 调试的任务控制。小流量使用免费（64MB 日志）。
  ...
  * [checklyhq.com](https://checklyhq.com) - 面向开发人员的开源 E2E/综合监控和深度 API 监控。免费计划包括五个用户和 50k+次检查运行。
  ...
  * [deadmanssnitch.com](https://deadmanssnitch.com/) — 用于 cron 作业的监控。一个免费的告密者（监视器），如果你推荐其他人注册，则可以获得更多。
  * [downtimemonkey.com](https://downtimemonkey.com/) — 提供 60 个正常运行时间监视器，间隔为 5 分钟。支持电子邮件、Slack 警报。
  * [economize.cloud](https://economize.cloud) — 通过组织云资源来优化和报告，帮助揭开云基础设施成本的神秘面纱。每月在 Google Cloud Platform 上花费高达 5,000 美元时免费。
  ...
  * [healthchecks.io](https://healthchecks.io) — 监控你的 cron 作业和后台任务。最多可免费用于 20 个检查。
  ...
  * [linkok.com](https://linkok.com) - 在线损坏链接检查器，小型网站（最多 100 页）免费，开源项目完全免费。
  ...
  * [newrelic.com](https://www.newrelic.com) — New Relic 可观测性平台旨在帮助工程师创建更完美的软件。从单体到无服务器，你可以对所有内容进行仪器化，然后分析、故障排除和优化你的整个软件堆栈。免费层级提供每月 100GB 的免费数据摄取、一个免费的完全访问用户和无限的免费主要用户。
  * [Middleware.io](https://middleware.io/) - 中间件可观测性平台提供对你的应用程序和堆栈的完全可见性，因此你可以大规模地监控和诊断问题。他们为开发社区使用提供了一个永远免费的计划，允许对多达 1M 个日志事件进行日志监控，对多达 2 个主机进行基础设施监控和 APM。
  ...
  * [opsgenie.com](https://www.opsgenie.com/) — 强大的警报和值班管理，用于运营始终在线的服务。最多可免费用于 5 个用户。
  * [paessler.com](https://www.paessler.com/) — 强大的基础设施和网络监控解决方案，包括警报、强大的可视化功能和基本报告。最多可免费用于 100 个传感器。
  * [pagecrawl.io](https://pagecrawl.io/) - 监控网站更改，每天检查最多可免费用于 6 个监视器。
  * [syagent.com](https://syagent.com/) — 非商业免费服务器监控服务，警报和指标。
  * [pagerly.io](https://pagerly.io/) - 在 Slack 上管理值班（与 Pagerduty、OpsGenie 集成）。最多可免费用于 1 个团队（一个团队指一个值班）。
  * [pagertree.com](https://pagertree.com/) - 用于警报和值班管理的简单界面。最多可免费用于 5 个用户。
  * [pingbreak.com](https://pingbreak.com/) — 现代正常运行时间监控服务。检查无限的 URL，并通过 Discord、Slack 或电子邮件获取停机通知。
  * [pingpong.one](https://pingpong.one/) — 具有监控功能的高级状态页面平台。免费层级包括一个带有 SSL 子域名的公共可定制状态页面。开源项目和非营利组织可免费使用专业计划。
  ...
  * [stathat.com](https://www.stathat.com/) — 免费开始使用十个统计信息，无过期时间。
  ...
  * [zenduty.com](https://www.zenduty.com/) — 端到端事件管理、警报、值班管理和响应编排平台，适用于网络运营、站点可靠性工程和 DevOps 团队。最多 5 个用户免费
  * [instatus.com](https://instatus.com) - 10 秒内获得漂亮的状态页面。永远免费，无限子域和无限团队
  * [Squadcast.com](https://squadcast.com) - Squadcast 是一款端到端事件管理软件，旨在帮助您推广 SRE 最佳实践。永远免费计划，最多可供 10 个用户使用
  * [RoboMiri.com](https://robomiri.com/) - RoboMiri 是一款稳定的正常运行时间监视器，提供广泛的监视器：cronjob、关键字、网站、端口、ping。免费提供 25 次正常运行时间检查，检查间隔为 3 分钟。通过电话、短信、电子邮件和 Webhooks 发出警报
  * [Better Stack](https://betterstack.com/better-uptime) - 正常运行时间监控、事件管理、值班调度/警报和状态页面在一个产品中。免费计划包括十个监视器，检查频率为 3 分钟，并提供状态页面
  * [Pulsetic](https://pulsetic.com) - 10 个监视器，6 个月的历史正常运行时间/日志，无限状态页面和自定义域包括在内！无限时间和无限电子邮件警报免费。您不需要信用卡
...
## 崩溃和异常处理
  ...
  * [CatchJS.com](https://catchjs.com/) - 提供带屏幕截图和点击路径的 JavaScript 错误跟踪。对开源项目免费。
  * [bugsnag.com](https://www.bugsnag.com/) — 初始试用后，每月最多可免费处理 2,000 个错误。
  * [elmah.io](https://elmah.io/) — 为 Web 开发人员提供错误日志记录和正常运行时间监控。开源项目的免费小型企业订阅。
  ...
  * [GlitchTip](https://glitchtip.com/) — 简单、开源的错误跟踪。与开源 Sentry SDK 兼容。每月免费处理 1000 个事件，或可自托管无限制。
  ...
  * [rollbar.com](https://rollbar.com/) — 异常和错误监控，免费计划每月处理 5,000 个错误，无限制用户，30 天保留期。
  * [sentry.io](https://sentry.io/) — Sentry 实时跟踪应用程序异常，并提供一个小的免费计划。每月免费处理 5k 个错误/1 个用户，如果自托管则无限制使用。
  * [Axiom](https://axiom.co/) — 存储多达 0.5TB 的日志，保留期为 30 天。包括与 Vercel 等平台的集成以及使用电子邮件/Discord 通知程序的高级数据查询。
  * [Semaphr](https://semaphr.com) — 为您的移动应用提供免费的一体化终止开关。
  * [Jam](https://jam.dev) - 一键生成开发者友好的错误报告。免费计划无限制使用。
  * [Whitespace](https://whitespace.dev) - 在浏览器中一键直接生成错误报告。免费计划无限制录制，仅供个人使用。

**[⬆️ 返回顶部](#table-of-contents)**

## 搜索

  * [algolia.com](https://www.algolia.com/) — 提供具有容错性、相关性和 UI 库的托管搜索解决方案，可轻松创建搜索体验。免费的“构建”计划包括 100 万份文档和每月 10,000 次搜索。还免费提供[开发者文档搜索](https://docsearch.algolia.com/)。
  * [bonsai.io](https://bonsai.io/) — 免费提供 1GB 内存和 1GB 存储空间。
  * [CommandBar](https://www.commandbar.com/) - 统一搜索栏即服务，基于 Web 的 UI 小部件/插件，允许您的用户在您的产品中搜索内容、导航、功能等，有助于发现性。每月活跃用户最多 1,000 个，命令无限制。
  * [Magny](https://magny.io) - SaaS 服务，帮助实现命令面板（例如应用内搜索），利用用户体验和效率，显著减少用户在应用中查找任何内容的时间。
...
## 教育和职业发展
  ...
  * [Free Professional Resume Templates & Editor](https://www.overleaf.com/latex/templates/tagged/cv) - 免费平台，提供大量经验丰富的专业人员的简历模板，可完全克隆和编辑并下载，ATS 优化。
  * [DeepLearning.AI Short Courses](https://www.deeplearning.ai/short-courses/) - 来自行业领先专家的免费短期课程，可在一小时或更短时间内获得最新生成 AI 工具和技术的实践经验。
  ...
  * [MIT OpenCourseWare](https://ocw.mit.edu/) - MIT OpenCourseWare 是一个在线出版材料的平台，来自超过 2,500 个 MIT 课程，免费与全球学习者和教育者分享知识。Youtube 频道可在[@mitocw](https://www.youtube.com/@mitocw/featured)找到。
...
## 电子邮件
  ...
  * [CloudMailin](https://www.cloudmailin.com/) - 通过 HTTP POST 接收电子邮件并进行事务性外发 - 每月免费发送 10000 封电子邮件。
  * [Contact.do](https://contact.do/) - 链接中的联系表单（bitly 用于联系表单）。
  * [debugmail.io](https://debugmail.io/) - 易于使用的开发人员测试邮件服务器。
  * [DNSExit](https://dnsexit.com/) - 在您的域名下免费提供最多 2 个电子邮件地址，存储空间为 100MB。支持 IMAP、POP3、SMTP、SPF/DKIM。
  ...
  * [EmailJS](https://www.emailjs.com/) - 这不是一个完整的电子邮件服务器；这只是一个电子邮件客户端，您可以使用它从客户端直接发送电子邮件，而无需暴露您的凭据，免费层每月有 200 次请求，2 个电子邮件模板，请求大小可达 50Kb，有限的联系人历史记录。
  * [EtherealMail](https://ethereal.email) - Ethereal 是一个虚假的 SMTP 服务，主要针对 Nodemailer 和 EmailEngine 用户（但不限于）。它是一个完全免费的反事务性电子邮件服务，邮件永远不会被传递。
  * [Temp-Mail.org](https://temp-mail.org/en/) - 利用各种域名的临时/一次性邮件生成工具。每次刷新页面时，电子邮件地址都会刷新。它完全免费，不包括任何服务的定价。
  ...
  * [FakeMailGenerator.com](https://www.fakemailgenerator.com/) - 一个德国的临时/一次性邮件生成器。支持 10 个域名，同时允许您自由创建无限的地址。（包括广告）但除此之外，该服务不包括任何定价，完全免费。
  * [forwardemail.net](https://forwardemail.net) - 免费的自定义域名电子邮件转发。使用您的域名创建并转发无限数量的电子邮件地址（**注意**：如果您使用.casa、.cf、.click、.email、.fit、.ga、.gdn、.gq、.lat、.loan、.london、.men、.ml、.pl、.rest、.ru、.tk、.top、.work TLDs，则需要付费，因为存在垃圾邮件）。
  * [Imitate Email](https://imitate.email) - 用于测试跨构建/质量保证和持续集成/持续部署的电子邮件功能的沙箱电子邮件服务器。免费帐户每天永远获得 15 封电子邮件。
  * [ImprovMX](https://improvmx.com) - 免费的电子邮件转发。
  * [EForw](https://www.eforw.com) - 一个域名的免费电子邮件转发。从您的域名接收和发送电子邮件。
  * [Inboxes App](https://inboxesapp.com) - 每天创建多达 3 个临时电子邮件，然后在完成后从方便的 Chrome 扩展中删除它们。非常适合测试注册流程。
  ...
  * [Mailcheck.ai](https://www.mailcheck.ai/) - 防止用户使用临时电子邮件地址注册，每小时 120 次请求（约每月 86400 次）。
  * [Mailchimp](https://mailchimp.com/) - 每月免费 500 个订阅者和 1000 封电子邮件。
  * [Maildroppa](https://maildroppa.com) - 最多 100 个订阅者和无限的电子邮件以及免费的自动化。
  * [MailerLite.com](https://www.mailerlite.com) - 每月免费 1000 个订阅者，12000 封电子邮件。
  ...
  * [pepipost.com](https://pepipost.com) - 第一个月免费发送 30000 封电子邮件，然后每天免费发送前 100 封电子邮件。
  * [Plunk](https://useplunk.com) - 每月免费发送 3000 封电子邮件。
  * [Postmark](https://postmarkapp.com/) - 每月免费发送 100 封电子邮件，每周无限量的 DMARC 摘要。
  * [Proton Mail](https://proton.me/mail) - 免费的安全电子邮件帐户服务提供商，内置端到端加密。免费提供 1GB 存储空间。
  * [Queuemail.dev](https://queuemail.dev) - 可靠的电子邮件交付 API。免费层（每月 10000 封电子邮件）。异步发送。使用多个 SMTP 服务器。阻止列表、日志记录、跟踪、Webhooks 等。
  ...
  * [Sendpulse](https://sendpulse.com) - 每月免费 500 个订阅者，15000 封电子邮件。
  ...
  * [Sweego](https://www.sweego.io/) - 欧洲开发人员的事务性电子邮件 API。每天免费发送 500 封电子邮件。
  * [Takeout](https://takeout.bysourfruit.com) - 一个不断更新的电子邮件服务，使发送电子邮件变得容易。每月免费提供 500 封交易邮件。
  * [temp-mail.io](https://temp-mail.io) — 免费的一次性临时电子邮件服务，可同时使用多个电子邮件并进行转发
  * [tinyletter.com](https://tinyletter.com/) — 每月免费提供 5,000 名订阅者
  * [Touchlead](https://touchlead.app) - 一种多功能营销自动化工具，具有潜在客户管理、表单生成器和自动化功能。有限数量的潜在客户和自动化免费
  ...
  * [Zoho](https://www.zoho.com) — 最初是一家电子邮件提供商，但现在提供一系列服务，其中一些有免费计划。具有免费计划的服务列表：
     ...
     - [文档](https://zoho.com/docs) — 免费提供给 5 个用户，上传限制为 1GB 和 5GB 的存储空间。Zoho Office Suite（Writer、Sheets 和 Show）捆绑在一起。
     - [项目](https://zoho.com/projects) — 免费提供给 3 个用户、2 个项目和 10MB 的附件限制。相同的计划适用于[Bugtracker](https://zoho.com/bugtracker)。
     - [连接](https://zoho.com/connect) — 团队协作免费提供给 25 个用户，包括三个组、三个自定义应用程序、3 个看板、3 个手册和 10 个集成以及频道、事件和论坛。
     - [会议](https://zoho.com/meeting) — 最多可容纳 3 名会议参与者和 10 名网络研讨会参与者的会议。
     ...
     - [Wiki](https://zoho.com/wiki) — 免费提供给 3 个用户，存储空间为 50MB，页面数量不限，支持 zip 备份、RSS 和 Atom 提要、访问控制和可定制的 CSS。
     - [订阅](https://zoho.com/subscriptions) — 对 20 个客户/订阅和 1 个用户的循环计费管理免费，所有付款托管均由 Zoho 完成。存储最后 40 个订阅指标
     - [结账](https://zoho.com/checkout) — 产品计费管理，有 3 个页面和最多 50 笔付款。
     - [Desk](https://zoho.com/desk) — 客户支持管理，有三个代理、私有知识库和电子邮件票证。与[Assist](https://zoho.com/assist)集成，用于一名远程技术人员和 5 台无人值守的计算机。
     - [Cliq](https://zoho.com/cliq) — 团队聊天软件，存储空间为 100GB，用户数量不限，每个频道 100 个用户和单点登录。
...
## 功能切换管理平台
  ...
  * [GrowthBook](https://growthbook.io) - 具有内置贝叶斯统计分析引擎的开源功能标志和 A/B 测试提供商。最多可供 3 个用户免费使用，功能标志和实验数量不限。
  * [Hypertune](https://www.hypertune.com) - 类型安全的功能标志、A/B 测试、分析和应用程序配置，具有 Git 风格的版本控制和同步的内存中本地标志评估。最多可供 5 个团队成员免费使用，功能标志和 A/B 测试数量不限。
...
## 字体
  ...
  * [Font Squirrel](https://www.fontsquirrel.com/) - 免费软件字体，授权用于商业工作。精心挑选这些字体并以易于使用的格式呈现。
  * [Google Fonts](https://fonts.google.com/) - 许多免费字体可以通过下载或链接到 Google 的 CDN 轻松快速地安装在网站上。
  * [FontGet](https://www.fontget.com/) - 有多种字体可供下载，并通过标签整齐地分类。
...
## 表单
  ...
  * [Feathery](https://feathery.io) - 强大、开发者友好的表单构建器。构建注册和登录、用户入职、支付流程、复杂的金融应用程序等。免费计划允许每月最多 250 次提交和五个活动表单。
  * [Form-Data](https://form-data.com) - 无代码表单后端。垃圾邮件过滤器、电子邮件通知和自动响应、Webhooks、Zapier、重定向、AJAX 或 POST 等。免费计划提供无限表单、每月 20 次提交以及带有 Form-Data 徽章的额外 2000 次提交。
  * [FabForm](https://fabform.io/) - 面向智能开发者的表单后端平台。免费计划允许每月 250 次表单提交。友好的现代 GUI。与 Google Sheets、Airtable、Slack、电子邮件等集成。
  * [Form.taxi](https://form.taxi/) — HTML 表单提交的端点。具有通知、垃圾邮件阻止程序和符合 GDPR 的数据处理。基本使用的免费计划。
  ...
  * [Hyperforms.app](https://hyperforms.app/) — 在几秒钟内创建表单以发送电子邮件等，无需后端代码。个人帐户免费为您提供每月最多 50 次表单提交。
  ...
  * [Screeb](https://screeb.app/) - 应用内调查和产品分析，用于解码用户行为。永远免费的计划允许每月 500 个活跃用户、无限响应和事件、许多集成、导出和定期报告。
  * [smartforms.dev](https://smartforms.dev/) - 为您的网站提供强大而简单的表单后端，永远免费的计划允许每月 50 次提交、250MB 文件存储、Zapier 集成、CSV/JSON 导出、自定义重定向、自定义响应页面、Telegram 和 Slack 机器人、单个电子邮件通知。
  * [Survicate](https://survicate.com/) — 从所有来源收集反馈并使用一个工具发送后续调查。使用 AI 自动分析反馈并提取见解。免费电子邮件、网站、产品内或移动调查、AI 调查创建者和每月 25 个响应。
  ...
  * [Tapform.com](https://tapform.com/) — 包括无限表单、无限字段和无限提交，免费。表单可以以标准格式或聊天格式显示。
  * [Typeform.com](https://www.typeform.com/) — 在网站上包含设计精美的表单。免费计划每个表单仅允许十个字段和每月 100 个响应。
  * [WaiverStevie.com](https://waiverstevie.com) - 具有 REST API 的电子签名平台。您可以通过 Webhooks 接收通知。免费计划为已签名的文档添加水印，但允许无限信封+签名。
  * [Web3Forms](https://web3forms.com) - 用于静态和 JAMStack 网站的联系表单，无需编写后端代码。免费计划允许每月无限表单、无限域和 250 次提交。
  ...
  * [Formester.com](https://formester.com) - 在您的网站上分享和嵌入外观独特的表单——创建的表单数量或计划限制的功能没有限制。每月免费获得多达 100 次提交。
  * [SimplePDF.eu](https://simplepdf.eu/embed) - 在您的网站上嵌入 PDF 编辑器并将任何 PDF 转换为可填写的表单。免费计划允许每个 PDF 无限制的 PDF 和每个 PDF 三个提交。
  * [forms.app](https://forms.app/) — 创建具有强大功能（如条件逻辑、自动评分计算器和 AI）的在线表单。免费计划最多可收集 100 个回复，将表单嵌入网站，或通过链接使用它们。
  * [Qualli](https://usequalli.com) - 应用内调查，专为移动设计。使用 Qualli AI 制作完美的问题。您可以在我们的免费计划上试用，最多 500 个 MAU，创建无限的表单和触发器。
  * [Sprig](https://sprig.com/) - 每月 1 次产品内调查或带有 GPT 驱动的 AI 分析的重播调查。
...
## 生成式 AI
  ...
  * [Keywords AI](https://keywordsai.co) - 最佳的 LLM 监控平台。只需两行代码，即可调用 200 多个 LLM。每月免费提供 10,000 次请求，平台功能免费！
  * [Portkey](https://portkey.ai/) - 生成式 AI 应用的控制面板，具有可观测性套件和 AI 网关。每月免费发送和记录多达 10,000 次请求。
  * [OpenPipe](https://openpipe.ai) - 面向开发人员的完全托管微调。免费计划允许您对每个数据集最多使用 2,000 行数据微调一个模型。
  * [Braintrust](https://www.braintrustdata.com/) - 用于生成式 AI 的评估、提示游乐场和数据管理。免费计划每周提供多达 1,000 个私有评估行。
  * [Findr](https://www.usefindr.com/) - 通用搜索，让您一次搜索所有应用。搜索助手，让您使用自己的信息回答问题。免费计划提供无限的统一搜索和每天 5 次的 co-pilot 查询。
  * [ReportGPT](https://report-gpt.io) - AI 驱动的写作助手。只要您提供自己的 API 密钥，整个平台都是免费的。
  * [Clair](https://askclair.ai/) - 临床 AI 参考。学生可以免费访问专业工具套件，包括开放搜索、临床摘要、医学评论、药物相互作用、ICD-10 代码和管理。此外，还提供专业套件的免费试用。
...
## CDN 和保护
  ...
  * [toranproxy.com](https://toranproxy.com/) — Packagist 和 GitHub 的代理。永远不会失败的 CD。个人使用免费，一个开发人员，没有支持
  ...
  * [Gcore](https://gcorelabs.com/) 全球内容分发网络，每月免费提供 1TB 和 100 万次请求，免费提供 DNS 托管
  * [CacheFly](https://portal.cachefly.com/signup/free2023) - 每月最多提供 5TB 的免费 CDN 流量，19 个核心 PoP，1 个域名和通用 SSL。

**[⬆️ 返回顶部](#table-of-contents)**

## PaaS

  * [anvil.works](https://anvil.works) - 仅使用 Python 进行 Web 应用开发。免费层级，应用数量无限制，超时时间为 30 秒。
  * [appwrite](https://appwrite.io) - 无项目暂停（支持 WebSockets）和身份验证服务的无限项目。免费层级每个项目包含 1 个数据库、3 个存储桶、5 个函数。
  * [configure.it](https://www.configure.it/) - 移动应用开发平台，免费用于两个项目，功能有限，但资源无限制。
  * [codenameone.com](https://www.codenameone.com/) - 针对 Java/Kotlin 开发者的开源、跨平台移动应用开发工具链。商业用途免费，项目数量无限制。
  * [Cosmonic](https://cosmonic.com) - 功能丰富的 WebAssembly PaaS 和 SDK，默认情况下低样板、灵活且安全的微服务。始终免费层级包括托管主机、25 个微服务以及强大的键值存储、负载均衡的公共 HTTP 端点等功能。
  * [deco.cx](https://www.deco.cx/en/dev) - 边缘原生前端平台，具有从 TypeScript 代码自动生成的可视化 CMS。内置 A/B 测试、内容细分和实时分析。非常适合内容繁重的企业电子商务网站。免费，每月最多 5k 页面浏览量或开源/个人项目。
  * [Deno Deploy](https://deno.com/deploy) - 分布式系统，在全球边缘运行 JavaScript、TypeScript 和 WebAssembly。免费层级包括每天 100,000 次请求和每月 100 GiB 数据传输。
  ...
  * [flightcontrol.dev](https://flightcontrol.dev/) - 使用 Git 推送风格的工作流程在您自己的 AWS 账户上部署 Web 服务、数据库等。个人 GitHub 存储库上有 1 个开发者的用户免费层级。AWS 费用通过 AWS 计费，但您可以使用信用额度和 AWS 免费层级。
  * [gigalixir.com](https://gigalixir.com/) - Gigalixir 提供一个永不休眠的免费实例和一个限制为 2 个连接、10,000 行和无备份的免费层级 PostgreSQL 数据库，用于 Elixir/Phoenix 应用程序。
  ...
  * [Mendix](https://www.mendix.com/) - 企业快速应用开发，无限制的可访问沙箱环境，支持每个应用程序的总用户数、0.5GB 存储和 1GB RAM。此外，免费层级允许使用 Studio 和 Studio Pro IDE。
  * [m3o.com](https://m3o.com) - API 服务开发的云平台。M3O 是一个完全托管的微服务，专注于云中的 Go 微服务开发。免费层级提供足够的资源来运行五个服务并与他人协作。
  * [pipedream.com](https://pipedream.com) - 为开发人员构建的集成平台。根据任何触发器开发任何工作流程。工作流程是您可以免费运行的代码[免费](https://docs.pipedream.com/pricing/)。无需管理服务器或云资源。
  ...
  * [Divio](https://www.divio.com/) - 一个仅使用 Docker 部署云应用程序的平台。开发项目可免费订阅。需要卡且不支持自定义域。
  * [Koyeb](https://www.koyeb.com) - Koyeb 是一个对开发人员友好的无服务器平台，可在全球范围内部署应用程序。通过基于 git 的部署、原生自动扩展、全球边缘网络和内置服务网格和发现，无缝运行 Docker 容器、Web 应用程序和 API。免费实例允许您在德国法兰克福或美国华盛顿特区部署 Web 服务。在法兰克福（德国）、华盛顿特区（美国）和新加坡提供免费托管的 PostgreSQL 数据库。512MB 内存、2GB 存储和 0.1 CPU。无需信用卡即可开始使用。
  * [Napkin](https://www.napkin.io/) - FaaS，具有 500Mb 内存，默认超时时间为 15 秒，每月 5,000 次免费 API 调用，速率限制为 5 次/秒。
  * [Meteor Cloud](https://www.meteor.com/cloud) - Galaxy 托管。Meteor 的平台即服务，用于 Meteor 应用程序，包括免费的 MongoDB 共享托管和自动 SSL。
  ...
  * [Platformatic Cloud](https://platformatic.dev/) - Platformatic 提供许多开源包，可在 Platformatic Cloud 中包装和部署您的 Fastify 应用程序。内置 CD 与 GitHub Action。[免费计划](https://platformatic.dev/pricing/)适用于爱好者，只需简单的[GitHub 登录](https://platformatic.cloud/)。
  * [YepCode](https://yepcode.io) - 一个在无服务器环境中连接 API 和服务的一体化平台。它带来了 NoCode 工具的所有敏捷性和优势，但具有使用编程语言的所有功能。免费层级包括[1.000 yeps](https://yepcode.io/pricing/)。
  * [WunderGraph](https://cloud.wundergraph.com) - 一个开源平台，允许您快速构建、交付和管理现代 API。内置 CI/CD、GitHub 集成和自动 HTTPS。在[免费计划](https://wundergraph.com/pricing)上，最多 3 个项目，1GB 出口，每月 300 分钟的构建时间。
  * [Zeabur](https://zeabur.com) - 一键部署您的服务。免费提供三个服务，每月提供 5 美元的免费信用额度。
...
## BaaS
  ...
  * [Activepieces](https://www.activepieces.com) - 在你的应用后端构建自动化流程，将多个应用连接在一起。例如，当你的应用中触发事件时发送 Slack 消息或添加 Google Sheet 行。每月最多免费执行 5,000 个任务。
  * [back4app.com](https://www.back4app.com) - Back4App 是一个基于 Parse Platform 的易于使用、灵活且可扩展的后端。
  * [backendless.com](https://backendless.com/) — 移动和 Web BaaS，提供 1GB 的免费文件存储、每月 50,000 次的推送通知以及表中的 1000 个数据对象。
  * [bismuth.cloud](https://www.bismuth.cloud/) — 我们的 AI 将在我们的函数运行时和托管存储上为你的 Python API 提供支持，在我们的在线编辑器中免费构建和托管，或在本地使用你喜欢的工具。
  * [BMC Developer Program](https://developers.bmc.com/site/global/bmc_helix_platform/program/overview/index.gsp) — BMC 开发者计划提供文档和资源，帮助你为企业构建和部署数字创新。访问一个全面的个人沙盒，包括平台、SDK 和可用于构建和定制应用的组件库。
  * [connectycube.com](https://connectycube.com) - 无限聊天消息、p2p 语音和视频通话、文件附件和推送通知。对于最多 1000 个用户的应用免费。
  * [convex.dev](https://convex.dev/) - 响应式后端即服务，托管你的数据（具有关系和可序列化 ACID 事务的文档）、无服务器函数和 WebSockets，以将更新流式传输到各种客户端。对于小项目免费 - 最多 100 万条记录，每月 500 万次函数调用。
  ...
  * [hasura.io](https://hasura.io/) — Hasura 扩展你现有的数据库，无论它托管在哪里，并提供一个即时的 GraphQL API，可以安全地访问用于 Web、移动和数据集成工作负载。对于 1GB/月的数据传递免费。
  ...
  * [nudge-hook.net](https://nudge-hook.net/client) — 作业调度 API（带有 swagger/openapi 客户端）。允许你尽可能多地安排临时/cron/定期 Webhook 交付。对每个人免费（无需注册），但无限计划限制为最多 500 个“推动”。接受捐赠。
  * [onesignal.com](https://onesignal.com/) — 无限免费推送通知。每月发送 10,000 封电子邮件，具有无限的联系人并可以访问自动预热。
  * [paraio.com](https://paraio.com) — 具有灵活身份验证、全文搜索和缓存的后端服务 API。一个应用免费，1GB 的应用数据。
  * [progress.com](https://www.progress.com/kinvey) — 移动后端，入门计划具有无限的请求/秒，1GB 的数据存储。企业应用支持
  * [pubnub.com](https://www.pubnub.com/) — 每月最多 100 万条消息和 100 个活跃日常设备的免费推送通知
  * [pushbots.com](https://pushbots.com/) — 推送通知服务。每月最多 150 万次推送免费
  * [pushcrew.com](https://pushcrew.com/) — 推送通知服务。最多 2,000 个订阅者的无限通知
  * [pusher.com](https://pusher.com/beams) — 每月活跃用户 2000 个以内免费、无限推送通知。适用于 iOS 和 Android 设备的单个 API。
  * [quickblox.com](https://quickblox.com/) — 即时消息、视频和语音通话以及推送通知的通信后端
  * [restspace.io](https://restspace.io/) - 配置一个带有身份验证、数据、文件、电子邮件 API、模板等服务的服务器，然后组合成管道并转换数据。
  * [Salesforce Developer Program](https://developer.salesforce.com/signup) — 使用拖放工具快速构建应用。通过点击自定义你的数据模型。使用 Apex 代码更进一步。使用强大的 API 与任何东西集成。使用企业级安全性保持保护。通过点击或任何领先的 Web 框架自定义 UI。免费开发者计划可访问完整的 Lightning 平台。
  * [ServiceNow Developer Program](https://developer.servicenow.com/) — 快速构建、测试和部署为你的组织提供更好工作的应用。免费实例和早期预览访问。
  * [simperium.com](https://simperium.com/) — 即时自动移动数据，多平台，无限发送和存储结构化数据，最多 2,500 个用户/月
  * [Singlebase.cloud](https://singlebase.cloud) — SinglebaseCloud 是一个 AI 驱动的一体化后端平台，可加速应用开发。它提供了向量 DB、关系文档 DB、Auth、搜索和存储等工具，旨在简化后端开发。免费/入门计划提供关系文档 DB、Auth、搜索、存储。
  * [stackstorm.com](https://stackstorm.com/) — 应用、服务和工作流的事件驱动自动化，免费无流程、访问控制、LDAP
  ...
  * [LeanCloud](https://leancloud.app/) — 移动后端。1GB 的数据存储、256MB 的实例、3K API 请求/天和 10K 推送/天免费。（API 与 Parse Platform 非常相似）

**[⬆️ 返回顶部](#table-of-contents)**

## 低代码平台

  * [Clappia](https://www.clappia.com) — 一款专为构建具有可定制移动和网络应用程序的业务流程应用程序而设计的低代码平台。提供拖放界面，具有离线支持、实时位置跟踪和与各种第三方服务集成等功能。
  ...
  * [ReTool](https://retool.com/) — 用于构建内部应用程序的低代码平台。Retool 高度可定制。如果您可以使用 JavaScript 和 API 编写它，您就可以在 Retool 中制作它。免费层允许每月最多五个用户，无限的应用程序和 API 连接。
  * [DronaHQ](https://www.dronahq.com/) — DronaHQ - 一个低代码平台，帮助工程团队和产品经理构建内部工具、自定义用户旅程、数字体验、自动化、自定义管理面板、操作应用程序的速度提高 10 倍。
  * [ILLA Cloud](https://www.illacloud.com/) — ILLA Cloud - 一个强大的开源低代码平台，供开发人员构建内部工具。通过使用 ILLA 的组件和操作库，开发人员可以在构建工具上节省大量时间。免费提供给 5 名团队成员。
  * [outsystems.com](https://www.outsystems.com/) — 用于本地或云的企业 Web 开发 PaaS，免费的“个人环境”提供允许无限制的代码和高达 1GB 的数据库。
  * [UI Bakery](https://uibakery.io) — 支持使用拖放更快地构建自定义 Web 应用程序的低代码平台。通过 JavaScript、Python 和 SQL 支持高度定制的 UI 构建。提供云解决方案和自托管解决方案。免费提供给最多 5 个用户。
...
## Web 托管
  ...
  * [Bohr](https://bohr.io) — 非商业项目免费+开发人员优先部署和开发平台，最大限度地减少基础设施麻烦并加快设置速度。
  * [Bubble](https://bubble.io/) — 可视化编程，无需代码即可构建 Web 和移动应用程序，带有 Bubble 品牌的免费版本。
  ...
  * [Fenix Web Server](https://preview.fenixwebserver.com) - 一个用于本地托管站点并公开共享它们（实时）的开发人员桌面应用程序。使用其漂亮的用户界面、API 和/或 CLI 以您喜欢的方式工作。
  ...
  * [Free hosting](https://freehostingnoads.net/) — 免费托管，支持 PHP 5、Perl、CGI、MySQL、FTP、文件管理器、POP E-Mail、免费子域、免费域名托管、DNS 区域编辑器、网站统计、免费在线支持以及许多其他免费主机不提供的功能。
  ...
  * [pantheon.io](https://pantheon.io/) — Drupal 和 WordPress 托管，自动化 DevOps 和可扩展基础设施。免费提供给开发人员和机构。没有自定义域。
  ...
  * [tilda.cc](https://tilda.cc/) — 一个站点，50 页，50MB 存储空间，170 多个可用的主要预定义块中只有一个，没有字体，没有图标，没有自定义域。
  * [Vercel](https://vercel.com/) — 免费构建、部署和托管 Web 应用程序，具有免费 SSL、全球 CDN 和每次“git push”时的唯一预览 URL。非常适合 Next.js 和其他静态站点生成器。
  * [Versoly](https://versoly.com/) — 以 SaaS 为重点的网站建设者 - 无限网站，70 多个块，五个模板，自定义 CSS，图标，SEO 和表单。没有自定义域。
  * [Qoddi](https://qoddi.com) - 类似于 Heroku 的 PaaS 服务，具有以开发人员为中心的方法和全包含的功能。静态资产、暂存和开发人员应用程序的免费层。
  * [FreeFlarum](https://freeflarum.com/) - 社区驱动的免费 Flarum 托管，最多可容纳 250 个用户（捐赠以从页脚删除水印）。
  * [fleek.co](https://fleek.co/) - 在开放网络及其协议上无缝构建现代站点和应用程序，免费提供无限网站和 50GB/月带宽。
...
## DNS
  ...
  * [1.1.1.1](https://developers.cloudflare.com/1.1.1.1/) - 由 Cloudflare 提供的快速、安全（加密 DNS 查询）的免费公共 DNS 解析器。可用于绕过互联网提供商的 DNS 封锁、防止 DNS 查询窥探，以及[阻止成人和恶意软件内容](https://developers.cloudflare.com/1.1.1.1/1.1.1.1-for-families)。也可以[通过 API 使用](https://developers.cloudflare.com/1.1.1.1/encrypted-dns/dns-over-https/make-api-requests)。注意：只是一个 DNS 解析器，不是 DNS 托管商。
  ...
  * [Zonomi](https://zonomi.com/) - 免费 DNS 托管服务，具有即时 DNS 传播。免费计划：1 个 DNS 区域（域名），最多包含 10 条 DNS 记录。
  * [dnspod.com](https://www.dnspod.com/) - 免费 DNS 托管。
  * [duckdns.org](https://www.duckdns.org/) - 免费 DDNS，免费层最多可支持 5 个域名。提供各种设置的配置指南。
  * [Dynv6.com](https://dynv6.com/) - 具有[API 支持](https://dynv6.com/docs/apis)的免费 DDNS 服务，可管理许多 DNS 记录类型（如 CNAME、MX、SPF、SRV、TXT 等）。
  * [freedns.afraid.org](https://freedns.afraid.org/) - 免费 DNS 托管。还根据众多公共用户[贡献的域名](https://freedns.afraid.org/domain/registry/)提供免费子域名。注册后从“子域名”菜单中获取免费子域名。
  ...
  * [Glauca](https://docs.glauca.digital/hexdns/) - 最多可托管 3 个域名的免费 DNS 托管，并支持 DNSSEC。
...
## IaaS
  ...
  * [4EVERLAND](https://www.4everland.org/) - 兼容 AWS S3 - APIs、接口操作、CLI 和其他上传方法，以安全、方便、高效的方式上传和存储来自 IPFS 和 Arweave 网络的文件。注册用户可免费获得 6GB 的 IPFS 存储和 300MB 的 Arweave 存储。任何小于 150KB 的 Arweave 文件上传都是免费的。
  * [backblaze.com](https://www.backblaze.com/b2/) - Backblaze B2 云存储。免费提供 10GB（类似于 Amazon S3）的对象存储，无时间限制。
  * [filebase.com](https://filebase.com/) - 由区块链驱动的 S3 兼容对象存储。免费提供 5GB 的无限期存储。
  ...
  * [Spheron](https://spheron.network/) - 从去中心化云存储和网络托管到一个平台下的去中心化应用和开发人员计算，免费计划提供 5GB 存储、100GB 带宽、无限域名和项目、价值 5 美元的计算资源（相对于 AWS 价值 50 美元）。
...
## 托管数据服务
  ...
  * [airtable.com](https://airtable.com/) — 看起来像电子表格，但它是一个关系型数据库，无限的基础，1,200 行/基础，和 1,000 API 请求/月
  * [Astra](https://www.datastax.com/products/datastax-astra/) — 云原生 Cassandra 作为服务，具有[80GB 免费层级](https://www.datastax.com/products/datastax-astra/pricing)
  ...
  * [Upstash](https://upstash.com/) — 无服务器 Redis，免费层级高达每天 10,000 个请求，最大数据库大小为 256MB，并发连接数为 20
  ...
  * [scalingo.com](https://scalingo.com/) — 主要是一个 PaaS，但提供 128MB 到 192MB 的 MySQL、PostgreSQL 或 MongoDB 免费层级
  * [SeaTable](https://seatable.io/) — 由 Seafile 团队构建的灵活、类似电子表格的数据库。无限的表格，2,000 行，1 个月的版本控制，最多 25 个团队成员。
  ...
  * [Turso by ChiselStrike](https://chiselstrike.com/) - Turso 是边缘数据库中的 SQLite 开发人员体验。Turso 提供了一个永远免费的入门计划，9GB 的总存储，最多 500 个数据库，最多 3 个位置，每月 10 亿行读取，以及对 SQLite 的本地开发支持。
  * [InfluxDB](https://www.influxdata.com/) — 时间序列数据库，免费高达 3MB/5 分钟写入，30MB/5 分钟读取和 10,000 基数系列
  * [restdb.io](https://restdb.io/) - 一种快速直接的 NoSQL 云数据库服务。使用 restdb.io，您可以获得模式、关系、自动 REST API（具有类似 MongoDB 的查询）和用于处理数据的高效多用户管理 UI。免费计划允许 3 个用户、2500 条记录和每秒 1 个 API 请求。
  ...
  * [Neon](https://neon.tech/) — 托管 PostgreSQL，0.5GB 存储（总计），1 个项目，10 个分支，无限数据库，始终可用的主分支（5 分钟后自动暂停），每月 20 小时的非主分支计算活动时间（总计）。
  * [Dgraph Cloud](https://cloud.dgraph.io/pricing?type=free) — 具有 GraphQL API 的托管原生图形 DBMS。每天限制为 1MB 数据传输。
  * [Tinybird](https://tinybird.co) - 一种无服务器托管 ClickHouse，通过 HTTP 进行无连接数据摄取，并允许您将 SQL 查询发布为托管 HTTP API。免费层级没有时间限制，10GB 存储+每天 1000 个 API 请求。
  * [TigerGraph Cloud](https://www.tigergraph.com/cloud/) — 具有类似 SQL 的图形查询语言和 REST API 的托管原生图形 DBMS/分析平台。一个免费实例，具有两个 vCPU、8GB 内存和 50GB 存储，在闲置 1 小时后休眠。
  * [TerminusCMS](https://terminusdb.com/pricing) — 用于 TerminusDB 的托管免费服务，TerminusDB 是一个用 Prolog 和 Rust 编写的文档和图形数据库。免费用于开发，付费服务用于企业部署和支持。
  ...
  * [8base.com](https://www.8base.com/) - 8base 是一个全栈低代码开发平台，专为 JavaScript 开发人员构建，基于 MySQL 和 GraphQL 以及无服务器后端即服务。它允许您使用 UI 应用程序构建器快速开始构建 Web 应用程序并快速扩展，免费层级包括行：2,500，存储：500，无服务器计算：1Gb/h，客户端应用程序用户：5。

**[⬆️ 返回顶部](#table-of-contents)**

## 隧道、WebRTC、Web Socket 服务器和其他路由器

  * [Pinggy](https://pinggy.io) — 只需一个命令即可为 localhost 创建公共 URL，无需下载。支持 HTTPS / TCP / TLS 隧道。免费计划有 60 分钟的隧道生命周期。
  * [conveyor.cloud](https://conveyor.cloud/) — Visual Studio 扩展，可将 IIS Express 暴露到本地网络或通过隧道到公共 URL。
  * [Hamachi](https://www.vpn.net/) — LogMeIn Hamachi 是一项托管 VPN 服务，可让您安全地将类似 LAN 的网络扩展到分布式团队，免费计划允许无限数量的网络，最多可容纳 5 人。
  ...
  * [segment.com](https://segment.com/) — 用于转换和将事件路由到其他第三方服务的中心。每月 100,000 个事件免费。
  * Google STUN — [stun:stun.l.google.com:19302](stun:stun.l.google.com:19302)
  * Twilio STUN — [stun:global.stun.twilio.com:3478?transport=udp](stun:global.stun.twilio.com:3478?transport=udp)
  * [Tailscale](https://tailscale.com/) — 零配置 VPN，使用开源 WireGuard 协议。可安装在 MacOS、iOS、Windows、Linux 和 Android 设备上。个人使用免费计划，可支持 100 台设备和 3 个用户。
  * [webhookrelay.com](https://webhookrelay.com) — 管理、调试、扇出和代理所有 Webhooks 到公共或内部（即 localhost）目的地。还可以通过获取公共 HTTP 端点（`https://yoursubdomain.webrelay.io <----> http://localhost:8080`）将在私有网络中运行的服务器通过隧道暴露。
  ...
  * [ZeroTier](https://www.zerotier.com) — 作为服务的 FOSS 管理虚拟以太网。免费计划包括 25 个客户端的无限端到端加密网络。适用于桌面/移动/NA 的客户端；用于配置自定义路由规则和批准私有网络上新客户端节点的 Web 界面。
  * [LocalXpose](https://localxpose.io) — 反向代理，使您能够将 localhost 服务器暴露到互联网。免费计划有 15 分钟的隧道生命周期。
  * [Traefik-Hub](https://traefik.io/traefik-hub/) - 通过隧道将本地运行的服务发布到公共自定义 URL，并使用访问控制保护它们。一个集群中 5 个服务免费。
...
## 问题跟踪和项目管理
  ...
  * [cacoo.com](https://cacoo.com/) — 在线实时图表：流程图、UML、网络。免费最多 15 名用户/图表，25 张图表
  * [Chpokify](https://chpokify.com/) — 基于团队的规划扑克，可节省冲刺估算时间。最多 5 名用户免费，免费 Jira 集成，无限视频通话，无限团队，无限会话。
  ...
  * [Cloudcraft](https://cloudcraft.co/) — 使用 Cloudcraft 可视化设计器在几分钟内设计专业的架构图，针对 AWS 进行优化，具有显示实时数据的智能组件。免费计划为单个用户提供无限的私有图表。
  ...
  * [GForge](https://gforge.com) — 用于复杂项目的项目管理和问题跟踪工具集，具有自托管和 SaaS 选项。SaaS 免费计划为前五个用户提供免费服务，并为开源项目提供免费服务。
  ...
  * [Hygger](https://hygger.io) — 项目管理平台。免费计划提供无限用户、项目和看板，以及 100MB 存储空间。
  * [Instabug](https://instabug.com) — 适用于移动应用程序的综合错误报告和应用内反馈 SDK。免费计划最多支持 1 个应用程序和一名成员。
  * [WishKit](https://wishkit.io) — 为您的 iOS/macOS 应用程序收集应用内用户反馈，并根据用户投票确定功能优先级。免费计划最多支持 1 个应用程序。
  * [Ilograph](https://www.ilograph.com/)  — 交互式图表，允许用户从多个角度和详细程度查看其基础架构。图表可以用代码表示。免费层提供无限的私有图表，最多可容纳 3 名查看者。
  ...
  * [kanbantool.com](https://kanbantool.com/) — 基于看板的项目管理。免费计划有两个看板和两名用户，不允许附件或文件。
  * [Kitemaker.co](https://kitemaker.co) - 通过产品开发过程的所有阶段进行协作，并跟踪 Slack、Discord、Figma 和 Github 上的工作。无限用户，无限空间。免费计划最多支持 250 个工作项。
  * [Kiter.app](https://www.kiter.app/) - 让任何人组织他们的求职并跟踪面试、机会和联系。强大的网络应用程序和 Chrome 扩展程序。完全免费。
  * [Kumu.io](https://kumu.io/)  — 具有动画、装饰、过滤器、聚类、电子表格导入等功能的关系图。免费层允许无限的公共项目。图形大小不受限制。学生可免费使用私有项目。如果您不想将文件公开在线（上传、编辑、下载、丢弃），则可以使用沙盒模式。
  * [Linear](https://linear.app/) — 具有简化界面的问题跟踪器。无限成员免费，最多 10MB 文件上传大小，250 个问题（不包括存档）
  * [leiga.com](https://www.leiga.com/) — Leiga 是一款 SaaS 产品，使用 AI 自动管理您的项目，帮助您的团队保持专注并释放巨大潜力，确保您的项目按计划进行。最多 10 名用户、20 个自定义字段、2GB 存储空间、AI 视频录制限制为 5 分钟/视频、自动化运行限制为 20 次/用户/月。
  ...
  * [Ora](https://ora.pm/) - 敏捷任务管理和团队协作。最多 3 名用户免费，文件大小限制为 10MB。
  * [pivotaltracker.com](https://www.pivotaltracker.com/) — 无限公共项目和两个私人项目免费，总共三名活跃用户（读写）和无限被动用户（只读）。
  * [plan.io](https://plan.io/) — 具有存储库托管和更多选项的项目管理。两名用户免费，提供十个客户和 500MB 存储空间
  ...
  * [point.poker](https://www.point.poker/) - 在线规划扑克（基于共识的估算工具）。无限用户、团队、会话、回合和投票免费。您无需注册。
  * [ScrumFast](https://www.scrumfast.com) - 具有非常直观界面的 Scrum 看板，最多 5 名用户免费。
  * [Shake](https://www.shakebugs.com/) - 适用于移动应用程序的应用内错误报告和反馈工具。免费计划，每个应用程序每月最多 10 个错误报告。
  * [Shortcut](https://shortcut.com/) - 项目管理平台。永远免费供多达 10 个用户使用。
  * [SpeedBoard](https://speedboard.app) - 用于敏捷和 Scrum 回顾的看板 - 免费。
  * [SuperPM](https://superpm.app/) - 多功能项目管理平台。免费供多达 3 个项目、无限用户、1GB 存储空间使用。
  * [Tadum](https://tadum.app) - 为定期会议设计的会议议程和会议记录应用程序，免费供多达 10 人的团队使用
  * [taiga.io](https://taiga.io/) - 适用于初创公司和敏捷开发者的项目管理平台，开源免费
  * [Tara AI](https://tara.ai/) - 简单的冲刺管理服务。免费计划具有无限任务、冲刺和工作区，且无用户限制。
  ...
  * [taskade.com](https://www.taskade.com/) - 实时协作任务列表和团队大纲。免费计划具有一个工作区，其中包含无限任务和项目；1GB 文件存储；1 周项目历史记录；以及每个视频会议最多 5 名参与者。
  * [taskulu.com](https://taskulu.com/) - 基于角色的项目管理。免费供多达 5 个用户使用。与 GitHub/Trello/Dropbox/Google Drive 集成
  * [Teaminal](https://www.teaminal.com) - 适用于远程团队的站立会议、回顾和冲刺规划工具。免费供多达 15 个用户使用。
  * [teamwork.com](https://teamwork.com/) - 项目管理和团队聊天。免费供 5 个用户和 2 个项目使用。提供高级计划。
  * [teleretro.com](https://www.teleretro.com/) - 具有破冰游戏、GIF 和表情符号的简单有趣的回顾工具。免费计划包括 3 次回顾和无限成员。
  ...
  * [todoist.com](https://todoist.com/) - 协作和个人任务管理。免费计划包括：5 个活动项目、项目中的 5 个用户、文件上传最大 5MB、3 个过滤器和 1 周活动历史记录。
  ...
  * [vabotu](https://vabotu.com/) - 用于项目管理的协作工具。提供免费和其他计划。自由职业者计划供 10 个用户使用，包括消息传递、任务板、5GB 在线存储、工作区和导出数据。
  * [Wikifactory](https://wikifactory.com/) - 具有项目、VCS 和问题的产品设计服务。免费计划提供无限项目和协作者以及 3GB 存储空间。
  * [Yodiz](https://www.yodiz.com/) - 敏捷开发和问题跟踪。免费供 3 个用户使用，无限项目。
  * [YouTrack](https://www.jetbrains.com/youtrack/buy/#edition=incloud) - 适用于 FOSS 项目和私人项目的免费托管 YouTrack（InCloud）（免费供 3 个用户使用）。包括时间跟踪和敏捷板
  * [zenhub.com](https://www.zenhub.com) - GitHub 内部唯一的项目管理解决方案。公共存储库、OSS 和非营利组织免费
  * [zenkit.com](https://zenkit.com) - 项目管理和协作工具。免费供多达 5 个成员使用，5GB 附件。
  * [Zube](https://zube.io) - 项目管理，提供免费计划供 4 个项目和 4 个用户使用。可与 GitHub 集成。
  * [Toggl](https://toggl.com/) - 提供两个免费的生产力工具。[Toggl Track](https://toggl.com/track/) 用于时间管理和跟踪应用程序，免费计划提供无缝的时间跟踪和报告，专为自由职业者设计。它具有无限的跟踪记录、项目、客户、标签、报告等。[Toggl Plan](https://toggl.com/plan/) 用于任务规划，免费计划供独立开发者使用，具有无限任务、里程碑和时间表。
  * [Sflow](https://sflow.io) - sflow.io 是一款专为敏捷软件开发、营销、销售和客户支持构建的项目管理工具，特别适用于外包和跨组织协作项目。免费计划最多可支持 3 个项目和 5 个成员。
  * [Pulse.red](https://pulse.red) - 用于项目的免费极简时间跟踪器和时间表应用程序。

**[⬆️ 返回顶部](#table-of-contents)**

## 存储和媒体处理

  * [AndroidFileHost](https://androidfilehost.com/) - 免费的文件共享平台，速度、带宽、文件数量、下载次数等均无限制。主要针对 Android 开发相关文件，如 APK 构建、自定义 ROM 和修改等，但似乎也接受任何其他文件。
  ...
  * [sirv.com](https://sirv.com/) - 具有即时图像优化和调整大小功能的智能图像 CDN。免费套餐包括 500MB 存储空间和 2GB 带宽。
  * [cloudimage.io](https://www.cloudimage.io/en/home) - 全球拥有 1500 多个存在点的完整图像优化和 CDN 服务。提供各种图像调整大小、压缩和水印功能。开源插件用于响应式图像、360 度图像制作和图像编辑。免费月度计划包括 25GB CDN 流量、25GB 缓存存储和无限转换。
  * [cloudinary.com](https://cloudinary.com/) - 图像上传、强大的操作、存储和交付网站和应用程序，支持 Ruby、Python、Java、PHP、Objective-C 等库。免费套餐包括每月 25 个信用额度。一个信用额度等于 1000 次图像转换、1GB 存储空间或 1GB CDN 使用量。
  ...
  * [file.io](https://www.file.io) - 提供 2GB 文件存储空间。文件在一次下载后自动删除。提供与存储交互的 REST API。速率限制为每分钟一个请求。
  * [freetools.site](https://freetools.site/) - 免费的在线工具。转换或编辑文档、图像、音频、视频等。
  * [GoFile.io](https://gofile.io/) - 免费的文件共享和存储平台，可通过基于 Web 的 UI 和 API 使用。文件大小、带宽、下载次数等均无限制。但如果文件处于非活动状态（超过十天没有下载），则会被删除。
  * [gumlet.com](https://www.gumlet.com/) - 通过 CDN 进行图像和视频托管、处理和流式传输。为视频提供慷慨的免费层，每月 250GB，为图像提供每月 30GB。
  * [image-charts.com](https://www.image-charts.com/) - 无水印的无限图像图表生成。
  * [Imgbot](https://github.com/marketplace/imgbot) - Imgbot 是一个友好的机器人，可以优化您的图像并节省您的时间。优化后的图像意味着更小的文件大小，而不会牺牲质量。它对开源免费。
  * [ImgBB](https://imgbb.com/) - ImgBB 是一个无限的图像托管服务。将图像拖放到屏幕上的任何位置。每个图像限制为 32MB。上传图像后，接收直接图像链接、BBCode 和 HTML 缩略图。登录以查看上传历史记录。
  ...
  * [nitropack.io](https://nitropack.io/) - 通过完整的前端优化（缓存、图像和代码优化、CDN）自动加速您网站的速度。每月最多 5000 次页面浏览免费。
  * [otixo.com](https://www.otixo.com/) - 从一个地方加密、共享、复制和移动您所有的云存储文件。基本计划提供无限文件传输，最大文件大小为 250MB，允许五个加密文件。
  ...
  * [Pinata IPFS](https://pinata.cloud) - Pinata 是上传和管理 IPFS 文件的最简单方法。我们友好的用户界面和 IPFS API 使 Pinata 成为平台、创作者和收藏家最简单的 IPFS 固定服务。提供 1GB 免费存储空间，以及访问 API。
  ...
  * [redbooth.com](https://redbooth.com) - P2P 文件同步，最多支持两个用户免费使用。
  ...
  * [transloadit.com](https://transloadit.com/) - 处理文件上传和视频、音频、图像、文档的编码。通过 GitHub 学生开发者包为开源、慈善机构和学生提供免费服务。商业应用程序可获得 2GB 免费试用。
  * [twicpics.com](https://www.twicpics.com) - 作为服务的响应式图像。它提供图像 CDN、媒体处理 API 和前端库，以自动化图像优化。该服务每月最多 3GB 流量免费。
  * [uploadcare.com](https://uploadcare.com/hub/developers/) - Uploadcare 提供基于尖端算法的终极工具包的媒体管道。所有功能都绝对免费提供给开发人员：文件上传 API 和 UI、图像 CDN 和源服务、自适应交付和智能压缩。免费层有 3000 次上传、3GB 流量和 3GB 存储空间。
  ...
  * [MConverter.eu](https://mconverter.eu/) - 批量转换文件。支持许多文件格式，包括新格式，如[AVIF](https://mconverter.eu/convert/to/avif/)。从视频中提取所有图像帧。每天最多可免费转换十个 100MB 文件，以两个为一批处理。
  * [ImageEngine](https://imageengine.io/) – ImageEngine 是一个易于使用的全球图像 CDN。设置时间不到 60 秒。支持 AVIF 和 JPEGXL，提供 WordPress-、Magento-、React-、Vue-插件等。在此处[领取免费开发者账号](https://imageengine.io/developer-program/)。
...
## 设计与用户界面
  ...
  * [Float UI](https://floatui.com/) - 免费的网络开发工具，即使是非设计师也能快速创建具有时尚设计的现代响应式网站。
  * [Ant Design 登陆页面](https://landing.ant.design/) - Ant Design 登陆页面提供了一个由 Ant Motion 的运动组件构建的模板。它有丰富的主页模板，下载模板代码包后即可快速使用。您还可以使用编辑器快速构建自己的专用页面。
  * [Backlight](https://backlight.dev/) - Backlight 是一个完整的编码平台，团队可以在其中构建、记录、发布、扩展和维护设计系统，它的核心是开发人员和设计师之间的协作。免费计划允许最多 3 个编辑器在一个设计系统上工作，并且可以有无限的查看者。
  ...
  * [CodeMyUI](https://codemyui.com) - 精选的网页设计和用户界面灵感与代码片段的集合。
  ...
  * [figma.com](https://www.figma.com) - 在线、团队协作设计工具；免费层包括无限的文件和查看者，最多有 2 个编辑器和 3 个项目。
  * [framer.com](https://www.framer.com/) - Framer 帮助您为下一个应用程序、网站或产品迭代和动画界面想法 - 从强大的布局开始。对于任何验证 Framer 作为专业原型工具的人：无限的查看者，最多 2 个编辑器，最多 3 个项目。
  * [freeforcommercialuse.net](https://freeforcommercialuse.net/) - FFCU 无忧模型/属性发布库存照片
  * [Gradientos](https://www.gradientos.app) - 使选择渐变快速和容易。
  * [Icon Horse](https://icon.horse) - 从我们简单的 API 中获取任何网站的最高分辨率的 favicon。
  * [Iconoir](https://iconoir.com) - 一个开源图标库，有成千上万的图标，支持 React、React Native、Flutter、Vue、Figma 和 Framer。
  * [Icons8](https://icons8.com) - 图标、插图、照片、音乐和设计工具。免费计划提供低分辨率的有限格式。当您使用我们的资产时，请链接到 Icons8。
  * [landen.co](https://www.landen.co) - 为您的初创公司生成、编辑和发布美丽的网站和登陆页面。所有这些都无需代码。免费层允许您拥有一个网站，完全可定制并发布在网络上。
  * [Quant Ux](https://quant-ux.com/) - Quant Ux 是一个原型和设计工具。 - 它完全免费，也是开源的。
  ...
  * [LottieFiles](https://lottiefiles.com/) - 世界上最大的针对设计师、开发人员等的世界上最小动画格式的在线平台。访问适用于 Android、iOS 和 Web 的 Lottie 动画工具和插件。
  * [MagicPattern](https://www.magicpattern.design/tools) - 一组用于渐变、图案和斑点的 CSS 和 SVG 背景生成器和工具。
  * [marvelapp.com](https://marvelapp.com/) - 设计、原型制作和协作，免费计划限于一个用户和一个项目。
  * [Mindmup.com](https://www.mindmup.com/) - 免费的无限思维导图，并将它们存储在云中。您的思维导图可在任何地方、即时、从任何设备访问。
  ...
  * [Octopus.do](https://octopus.do) - 可视化网站地图构建器。实时构建您的网站结构，并快速与您的团队或客户分享以进行协作。
  ...
  * [Proto.io](https://www.proto.io) - 创建完全交互式的 UI 原型，无需编码。免费试用结束后可使用免费层。免费层包括一个用户、一个项目、五个原型、100MB 的在线存储和 proto.io 应用程序的预览。
...
* [walkme.com](https://www.walkme.com/) — 企业级引导和参与平台，免费计划提供多达 5 步/次的三次演练。
...
* [SVGmix.com](https://www.svgmix.com/) - 300K+免费 SVG 图标、集合和品牌标志的海量存储库。它在浏览器中有一个简单的矢量编辑程序，可用于快速文件编辑。
...
* [TeleportHQ](https://teleporthq.io/) - 低代码前端设计和开发平台。TeleportHQ 是协作前端平台，可立即创建和发布无头静态网站。三个免费项目，无限协作者，免费代码导出。
...
* [hypercolor.dev](https://hypercolor.dev/) -- 精心策划的 Tailwind CSS 颜色渐变集合，还提供各种生成器来创建您自己的。
...
* [Image BG Blurer](https://imagebgblurer.com/) -- 为图像生成模糊背景框架，使用该图像源作为背景模糊，适用于 Notion、Trello、Jira 等更多工具
* [Webstudio](https://webstudio.is/) -- Webflow 的开源替代品。免费计划在其域上提供无限网站。五个自定义域名的网站。每月 10,000 次页面浏览量。2GB 资产存储。
* [Nappy](https://nappy.co/) -- 免费的美丽黑人照片。用于商业和个人用途。
...
## 设计灵感
  ...
  * [Behance](https://www.behance.net/) - [设计展示] 设计师展示其作品的地方。可通过 UI/UX 项目类别进行筛选。
  * [dribbble](https://dribbble.com/) - [设计展示] 独特的设计灵感，通常不是来自真实应用。
  * [Landings](https://landings.dev/) - [网页截图] 根据您的偏好找到最佳的登录页面设计灵感。
  * [Lapa Ninja](https://www.lapa.ninja/) - [登录页面/UI 工具包/网页截图] Lapa Ninja 是一个画廊，展示了最佳的 6025 个登录页面示例、免费设计师书籍和来自网络的免费 UI 工具包。
  * [LovelyLanding.net](https://www.lovelylanding.net/) - [登录页面设计] 经常更新的登录页面截图。包括桌面、平板电脑和移动设备截图。
  * [Mobbin](https://mobbin.design/) - [移动设备截图] 使用我们的 50,000 多个完全可搜索的移动应用截图库节省数小时的 UI 和 UX 研究时间。
...
## 地图上的数据可视化
  ...
  * [developers.arcgis.com](https://developers.arcgis.com) — 用于地图、地理空间数据存储、分析、地理编码、路由等的 API 和 SDK，适用于网络、桌面和移动设备。每月有 200 万免费基础地图瓦片、20,000 个非存储地理编码、20,000 条简单路线、5,000 次行车时间计算和 5GB 免费瓦片+数据存储。
  ...
  * [here](https://developer.here.com/) — 用于地图和位置感知应用的 API 和 SDK。每月免费 250,000 次交易。
...
## IDE 和代码编辑
  ...
  * [apiary.io](https://apiary.io/) - 具有即时 API 模拟和生成文档的协作式 API 设计（对于无限的 API 蓝图和具有一个管理员帐户和托管文档的无限用户免费）。
  * [BBEdit](https://www.barebones.com/) - BBEdit 是一款流行且可扩展的 macOS 编辑器。免费模式提供了一个强大的核心功能集和升级到高级功能的途径。
  * [Binder](https://mybinder.org/) - 将 Git 存储库转换为一组交互式笔记本。它是一项免费的公共服务。
  * [BlueJ](https://bluej.org) - 一个免费的 Java 开发环境，专为初学者设计，全球数百万人使用。由 Oracle 提供支持，并具有简单的 GUI 以帮助初学者。
  ...
  * [cacher.io](https://www.cacher.io) - 具有标签和支持 100 多种编程语言的代码片段管理器。
  ...
  * [cocalc.com](https://cocalc.com/) - （以前称为 cloud.sagemath.com 上的 SageMathCloud）- 云中的协作计算。浏览器访问完整的 Ubuntu，内置协作和大量用于数学、科学、数据科学的免费软件，预装：Python、LaTeX、Jupyter Notebooks、SageMath、scikitlearn 等。
  * [code.cs50.io](https://code.cs50.io/) - 适用于 CS50 的 Visual Studio Code 是一个位于 code.cs50.io 的 Web 应用程序，适用于学生和教师的 GitHub Codespaces。
  ...
  * [fakejson.com](https://fakejson.com/) - FakeJSON 帮助您使用其 API 快速生成假数据。发出描述您想要什么以及如何想要它的 API 请求。API 以 JSON 格式返回所有内容。加快创意的上市进程并假装直到您成功。
  * [GitPod](https://www.gitpod.io) - GitHub 项目的即时、可立即编码的开发环境。免费层包括每月 50 小时。
  * [ide.goorm.io](https://ide.goorm.io) goormIDE 是完整的云端 IDE。多语言支持，通过功能齐全的基于 Web 的终端、端口转发、自定义 URL、实时协作和聊天、共享链接、Git/Subversion 支持的基于 Linux 的容器。还有更多功能（免费层包括每个容器 1GB RAM 和 10GB 存储空间，5 个容器插槽）。
  * [JDoodle](https://www.jdoodle.com) - 支持 60 多种编程语言的在线编译器和编辑器，免费计划每天最多可编译 200 个信用的 REST API 代码。
  ...
  * [jsfiddle.net](https://jsfiddle.net/) - JS Fiddle 是一个支持协作的前端 Web 游乐场和代码共享站点。
  ...
  * [MarsCode](https://www.marscode.com/) - 一个免费的基于 AI 的云 IDE。
  * [micro-jaymock](https://micro-jaymock.now.sh/) - 用于生成假 JSON 数据的小型 API 模拟微服务。
  * [mockable.io](https://www.mockable.io/) - Mockable 是一个简单可配置的服务，用于模拟 RESTful API 或 SOAP Web 服务。此在线服务允许您快速定义 REST API 或 SOAP 端点，并让它们返回 JSON 或 XML 数据。
  ...
  * [Paiza](https://paiza.cloud/en/) - 在浏览器中开发 Web 应用程序，无需设置任何内容。免费计划提供一台服务器，24 小时生命周期，每天运行时间 4 小时，具有 2 个 CPU 内核、2GB RAM 和 1GB 存储空间。
  * [Prepros](https://prepros.io/) - Prepros 可以开箱即用地编译 Sass、Less、Stylus、Pug/Jade、Haml、Slim、CoffeeScript 和 TypeScript，重新加载您的浏览器并使开发和测试您的网站变得容易，因此您可以专注于使它们完美。您还可以通过点击几下添加自己的工具。
  * [Replit](https://replit.com/) - 一个用于各种编程语言的云编码环境。
  * [SoloLearn](https://code.sololearn.com) - 一个适合运行代码片段的云编程游乐场。支持各种编程语言。运行代码不需要注册，但在其平台上保存代码时是必要的。还为初学者和中级程序员提供免费课程。
  ...
  * [VSCodium](https://vscodium.com/) - 社区驱动，无遥测/跟踪，自由许可的 Microsoft 编辑器 VSCode 的二进制分发
  * [wakatime.com](https://wakatime.com/) — 使用文本编辑器插件对您的编码活动进行量化的自我指标，有限的免费计划。
  * [Wave Terminal](https://waveterm.dev/) - Wave 是一个开源、跨平台的终端，用于无缝工作流程。内联渲染任何内容。保存会话和历史记录。由开放的 Web 标准提供支持。MacOS 和 Linux。
...
## 分析、事件和统计
  ...
  * [Hightouch](https://hightouch.com/) - Hightouch 是一个反向 ETL 平台，可帮助您将客户数据从数据仓库同步到 CRM、营销和支持工具。免费层为您提供一个同步数据的目标。
  * [Avo](https://avo.app/) - 简化的分析发布工作流程。单一来源的真相跟踪计划、类型安全的分析跟踪库、应用内调试器和数据可观测性，可在发布前捕获所有数据问题。免费提供给两名工作区成员和 1 小时的数据可观测性回溯。
  * [Branch](https://branch.io) - 移动分析平台。免费层提供多达 10K 移动应用用户的深度链接和其他服务。
  ...
  * [Databox](https://databox.com) - 通过结合其他分析和 BI 平台实现业务洞察和分析。免费计划提供 3 个用户、仪表板和数据源。1100 万历史数据记录。
  * [Hitsteps.com](https://hitsteps.com/) - 每月为 1 个网站提供 2000 次页面浏览
  * [amplitude.com](https://amplitude.com/) - 每月 100 万次事件，最多 2 个应用
  * [GoatCounter](https://www.goatcounter.com/) - GoatCounter 是一个开源的网络分析平台，可作为托管服务（非商业用途免费）或自托管应用程序使用。它旨在提供易于使用和有意义的隐私友好型网络分析，作为 Google Analytics 或 Matomo 的替代品。免费层用于非商业用途，包括无限站点、六个月的数据保留和 10 万次页面浏览/月。
  * [Google Analytics](https://analytics.google.com/) - Google Analytics
  * [MetricsWave](https://metricswave.com) - 开发者的隐私友好型 Google Analytics 替代品。免费计划允许每月 20K 次页面浏览，无需信用卡。
  * [Expensify](https://www.expensify.com/) - 费用报告，免费的个人报告审批工作流程
  * [getinsights.io](https://getinsights.io) - 以隐私为重点，无 cookie 分析，每月最多 3K 次事件免费。
  * [heap.io](https://heap.io) - 自动捕获 iOS 或网络应用程序中的每个用户操作。每月最多 10K 次会话免费。
  * [Hotjar](https://hotjar.com) - 网站分析和报告。免费计划允许每天 2000 次页面浏览。每天一百个快照（最大容量：300）。可以存储三个快照热图 365 天。无限团队成员。还包括应用内和独立调查、带有屏幕截图的反馈小部件。免费层允许创建 3 个调查和 3 个反馈小部件，并每月收集 20 个响应。
  ...
  * [Mixpanel](https://mixpanel.com/) - 每月 100,000 名跟踪用户，无限数据历史和座位，美国或欧盟数据驻留
  ...
  * [Row Zero](https://rowzero.io) - 速度极快、连接的电子表格。直接连接到数据数据库、S3 和 API。即时导入、分析、图形化和共享数百万行。三个免费（永远）工作簿。
  * [sematext.com](https://sematext.com/cloud/) - 每月最多 50K 次操作免费，1 天数据保留，无限仪表板、用户等。
  * [Similar Web](https://similarweb.com) - 网络和移动应用的分析。免费计划提供每个指标的五个结果，一个月的移动应用数据和三个月的网站数据。
  * [StatCounter](https://statcounter.com/) - 网站查看器分析。免费计划为最近 500 名访客的分析。
  * [Statsig](https://statsig.com) - 涵盖分析、功能标记和 A/B 测试的一体化平台。每月最多 100 万次计量事件免费。
  * [Tableau Developer Program](https://www.tableau.com/developer) - 创新、创建并使 Tableau 完美适用于您的组织。免费开发者计划为 Tableau Online 提供个人开发沙箱许可证。该版本是最新的预发布版本，因此数据开发人员可以测试这个出色平台的每个功能。
  * [usabilityhub.com](https://usabilityhub.com/) - 在真实人员上测试设计和模型并跟踪访客。免费提供给一名用户，无限制测试
  * [woopra.com](https://www.woopra.com/) - 免费的用户分析平台，提供 500K 次操作、90 天数据保留、30 多个一键式集成。
  * [counter.dev](https://counter.dev) - 简单且因此隐私友好的网络分析。免费或通过捐赠支付您想要的费用。
  * [PostHog](https://posthog.com) - 每月最多 100 万次跟踪事件的完整产品分析套件免费。还提供无限制的应用内调查，每月 250 个响应。
  * [Uptrace](https://uptrace.dev) - 分布式跟踪工具，帮助开发人员确定故障并找到性能瓶颈。有免费计划，为开源项目提供免费个人订阅，并有开源版本。
  * [Microsoft Clarity](https://clarity.microsoft.com/) - Clarity 是一个免费、易于使用的工具，可捕获真实人员如何使用您的网站。
  * [Beampipe.io](https://beampipe.io) - Beampipe 是简单、以隐私为重点的网络分析。每月最多 5 个域名和 10K 次页面浏览免费。
  * [Aptabase](https://aptabase.com) - 适用于移动和桌面应用的开源、隐私友好且简单的分析。SDK 适用于 Swift、Kotlin、React Native、Flutter、Electron 等。每月最多 20,000 次事件免费。
  ...
  * [Umami](https://umami.is/) - 简单、快速、以隐私为重点的开源替代品 Google Analytics。
  * [TrackWith Dicloud](https://dicloud.net/trackwith-privacy-focused-analytics/) - 免费的轻量级隐私友好型替代品 Google Analytics。无限页面浏览量，无限访客，无限页面热图和目标跟踪。最多 3 个域名和每个域名 600 个会话回放免费。
...
## 访客会话录制
  ...
  * [OpenReplay.com](https://www.openreplay.com) - 具有开发工具的开源会话回放，用于错误重现，实时会话用于实时支持，以及产品分析套件。每月一千个会话，可访问所有功能，保留 7 天。
  ...
  * [Microsoft Clarity](https://clarity.microsoft.com/) - 会话录制完全免费，“无流量限制”，无项目限制，无抽样
  * [mouseflow.com](https://mouseflow.com/) — 一个网站每月免费 500 个会话
  * [mousestats.com](https://www.mousestats.com/) — 一个网站每月免费 100 个会话
  * [smartlook.com](https://www.smartlook.com/) — 网络和移动应用程序的免费套餐（每月 1500 个会话），三个热图，一个漏斗，1 个月的数据历史记录
  * [usersurge.com](https://www.usersurge.com/) — 个人每月 250K 个会话。
  * [howuku.com](https://howuku.com) — 跟踪用户交互、参与度和事件。每月最多 5,000 次访问免费
  * [UXtweak.com](https://www.uxtweak.com/) — 记录并观看访客如何使用您的网站或应用程序。小型项目免费无限制时间
...
## 支付和计费集成
  ...
  * [Qonversion](http://qonversion.io/) - 一体化跨平台订阅管理平台，提供分析、A/B 测试、Apple Search Ads、远程配置和增长工具，用于优化应用内购买和货币化。与 iOS、Android、React Native、Flutter、Unity、Cordova、Stripe 和网络兼容。每月跟踪收入高达 10,000 美元免费。
  * [Glassfy](https://glassfy.io/) - 应用内订阅基础设施、实时订阅事件和开箱即用的货币化工具，适用于 iOS、Android、Stripe 和 Paddle。每月收入高达 10,000 美元免费。
  * [Adapty.io](https://adapty.io/) - 具有开源 SDK 的一站式解决方案，用于移动应用内订阅集成到 iOS、Android、React Native、Flutter、Unity 或网络应用程序。每月收入高达 10,000 美元免费。
  * [CoinMarketCap](https://coinmarketcap.com/api/) — 提供加密货币市场数据，包括最新的加密货币和法定货币汇率。免费层提供每月 10,000 个调用信用。
  * [CurrencyFreaks](https://currencyfreaks.com/) — 提供当前和历史货币汇率。免费的 DEVELOPER 计划可用，每月 1000 个请求。
  * [CoinGecko](https://www.coingecko.com/en/api) — 提供加密货币市场数据，包括最新的加密货币汇率和历史数据。演示 API 具有稳定的每分钟 30 次调用限制和每月 10,000 次调用上限。
  * [CurrencyApi](https://currencyapi.net/) — 实时货币汇率，包括实物货币和加密货币，以 JSON 和 XML 形式提供。免费层每月提供 1,250 个 API 请求。
  ...
  * [Moesif API Monetization](https://www.moesif.com/) - 通过基于使用的计费从 API 生成收入。连接到 Stripe、Chargebee 等。免费层每月提供 30,000 个事件。
  * [Nami ML](https://www.namiml.com/) - 用于 iOS 和 Android 上的应用内购买和订阅的完整平台，包括无代码付费墙、CRM 和分析。所有基本功能免费运行 IAP 业务。
  * [RevenueCat](https://www.revenuecat.com/) — 用于应用内购买和订阅的托管后端（iOS 和 Android）。每月跟踪收入高达 2.5 万美元免费。
...
## 开发博客网站
  ...
  * [BearBlog](https://bearblog.dev/) - 简约的、Markdown 驱动的博客和网站构建器。
...
## 评论平台
  ...
  * [Remarkbox](https://www.remarkbox.com/) - 开源托管评论平台，您可以根据自己的能力为“一个在几个域上具有完全控制权的主持人”付费
...
## 截图 API
  ...
  * [ApiFlash](https://apiflash.com) — 一个基于 Aws Lambda 和 Chrome 的截图 API。处理整页截图、捕获定时和视口尺寸。
  * [microlink.io](https://microlink.io/) — 它将任何网站转换为数据，例如元标记规范化、美观的链接预览、抓取功能或作为服务的截图。每天免费提供 250 次请求。
...
## Flutter 相关和无需 Mac 构建 IOS 应用
  ...
  * [CodeMagic](https://codemagic.io/) - Codemagic 是一个完全托管的移动应用 CI/CD。您可以使用基于 GUI 的 CI/CD 工具进行构建、测试和部署。免费层提供每月 500 分钟免费和一个具有 2.3 GHz 和 8 GB RAM 的 Mac Mini 实例。
...
## 隐私管理
  ...
  * [Bearer](https://www.bearer.sh/) - 通过审计和持续工作流程帮助实施隐私设计，以便组织符合 GDPR 和其他法规。免费层仅限于较小的团队，并且仅适用于 SaaS 版本。
...
## 杂项
  ...
  * [Blynk](https://blynk.io) - 一个带有 API 的 SaaS，用于控制、构建和评估物联网设备。免费开发者计划，可连接 5 个设备，提供免费云服务和数据存储。也有移动应用程序。
  * [Bricks Note Calculator](https://free.getbricks.app/) - 一个具有强大内置多行计算器的笔记应用程序（PWA）。
  * [Carbon.now.sh](https://carbon.now.sh) - 以美学截图般的图像格式创建和分享代码片段。通常用于在 Twitter 或博客文章中美学地分享/炫耀代码片段。
  ...
  * [Cronhooks](https://cronhooks.io/) - 安排准时或定期的网络钩子。免费计划允许 5 个临时时间表。
  * [cron-job.org](https://cron-job.org) - 在线 cronjobs 服务。无限的作业是免费的。
  * [datelist.io](https://datelist.io) - 在线预订/预约调度系统。每月最多可免费预订 5 次，包括 1 个日历。
  * [Domain Forward](https://domain-forward.com/) - 一个简单的工具，用于转发任何 URL 或域名。每月最多可免费转发 5 个域名和 200k 次请求。
  ...
  * [FOSSA](https://fossa.com/) - 可扩展的端到端第三方代码管理、许可证合规性和漏洞管理。
  * [fullcontact.com](https://www.fullcontact.com/developer/pricing/) - 通过在您的应用程序中添加社交配置文件，帮助您的用户了解更多关于他们的联系人。每月免费提供 500 次个人 API 匹配。
  * [Hook Relay](https://www.hookrelay.dev/) - 为您的应用程序添加网络钩子支持，无需麻烦：为您完成排队、带有退避的重试和日志记录。免费计划每天有 100 次交付，14 天保留和 3 个钩子端点。
  ...
  * [newreleases.io](https://newreleases.io/) - 通过电子邮件、Slack、Telegram、Discord 和自定义网络钩子接收 GitHub、GitLab、Bitbucket、Python PyPI、Java Maven、Node.js NPM、Node.js Yarn、Ruby Gems、PHP Packagist、.NET NuGet、Rust Cargo 和 Docker Hub 上的新版本通知。
  ...
  * [Pika Code Screenshots](https://pika.style/templates/code-image) - 使用扩展创建代码片段和 VS Code 的美丽、可定制截图。
  ...
  * [readme.com](https://readme.com/) - 轻松制作美丽的文档，免费用于开源。
  ...
  * [snappify](https://snappify.com) - 使开发人员能够创建令人惊叹的视觉效果。从美丽的代码片段到完全展开的技术演示。免费计划包括一次最多 3 个快照，无限下载和每月 5 个 AI 驱动的代码解释。
...
## 远程桌面工具
  ...
  * [Getscreen.me](https://getscreen.me) - 免费用于 2 个设备，无会话数量和持续时间限制。
...
## 游戏开发
  ...
  * [CraftPix](https://craftpix.net) — 免费/付费的资源，如 2D、3D、音频、GUI、背景、图标、瓦片集、游戏套件。
  * [Game Icons](https://game-icons.net/) - 免费可定制的 SVG/PNG 图标，提供 CC-BY 许可证。
  * [LoSpec](https://lospec.com/) — 用于创建像素艺术和其他限制性数字艺术的在线工具，有大量的教程/调色板列表可供选择用于您的游戏
  * [ArtStation](https://www.artstation.com/) - 免费/付费的 2D、3D 资源和音频、图标、瓦片集、游戏套件的市场。也可以用于展示您的艺术作品集。
  ...
  * [Kenney](https://www.kenney.nl/assets/) - 免费（CC0 1.0 通用许可证）2D、3D、音频和 UI 游戏资源。
  * [Poliigon](https://www.poliigon.com/) - 免费和付费的纹理（具有可变分辨率）、模型、HDRIs 和画笔。提供免费插件导出到 Blender 等软件。
  * [Freesound](https://freesound.org/) - 免费的合作声音库，提供不同的 CC 许可证。

**[⬆️ 返回顶部](#table-of-contents)**

## 其他免费资源

  * [Wikimint Developer](https://developer.wikimint.com/p/tools.html) - 始终为 Web 开发人员提供免费工具，包括 CSS 压缩/解压缩、图像优化器、图像调整器、大小写转换器、CSS 验证器、JavaScript 编译器、HTML 编辑器等。
  * [ElevateAI](https://www.elevateai.com) - 每月免费获得多达 200 小时的音频转录。
  * [get.localhost.direct](https://get.localhost.direct) - 一个更好的`*.localhost.direct`通配符公共 CA 签名 SSL 证书，用于带有子域支持的本地主机开发。
  ...
  * [Microsoft 365 Developer Program](https://developer.microsoft.com/microsoft-365/dev-program) - 获取免费的沙箱、工具和其他资源，用于构建 Microsoft 365 平台的解决方案。订阅是 90 天的[Microsoft 365 E5 Subscription](https://www.microsoft.com/microsoft-365/enterprise/e5)（不包括 Windows），可续订。如果您在开发中活跃（使用遥测数据和算法衡量），则会续订。
  ...
  * [SimpleBackups.com](https://simplebackups.com/) - 用于服务器和数据库（MySQL、PostgreSQL、MongoDB）的备份自动化服务，直接存储到云存储提供商（AWS、DigitalOcean 和 Backblaze）中。提供一个免费计划，用于 1 个备份。
  * [SnapShooter](https://snapshooter.com/) - 用于 DigitalOcean、AWS、LightSail、Hetzner 和 Exoscale 的备份解决方案，支持直接将数据库、文件系统和应用程序备份到基于 s3 的存储。提供一个免费计划，每天备份一个资源。
  ...
  * [SmallDev.tools](https://smalldev.tools/) - 一个免费的开发人员工具，允许您对各种格式进行编码/解码、压缩 HTML/CSS/JavaScript、美化、在 JSON/CSV 和多种其他格式中生成假/测试数据集等更多功能。具有令人愉悦的界面。
  * [UseCSV by Layercode](https://layercode.com/usecsv) - 在几分钟内将 CSV 和 Excel 导入添加到您的 Web 应用程序中。为您的用户提供愉快且强大的数据导入体验。无需任何信用卡详细信息即可免费开始，并立即开始集成 UseCSV。您可以创建无限的导入器并上传高达 100Mb 的文件。
  ...
  * [Free Code Tools](https://freecodetools.org/) - 100%免费的有效代码工具。Markdown 编辑器、代码压缩/美化器、QR 码生成器、Open Graph 生成器、Twitter 卡生成器等。
  * [regex101](https://regex101.com/) - 这个免费网站允许您测试和调试正则表达式（regex）。它提供了一个正则表达式编辑器和测试器，以及学习正则表达式的有用文档和资源。
  ...
  * [OpenUtils](https://openutils.org/) - 为开发人员提供了各种免费工具，如 HTML/CSS/JavaScript 格式化程序、压缩器、转换器、编码器/解码器等。
  * [SimpleRestore](https://simplerestore.io) - 轻松的 MySQL 备份恢复。无需代码或服务器，将 MySQL 备份恢复到任何远程数据库。
  * [360Converter](https://www.360converter.com/) - 免费层有用的网站来转换：视频到文本 && 音频到文本 && 语音到文本 && 实时音频到文本 && YouTube 视频到文本 && 添加视频字幕。也许它在短视频转换或短 YouTube 教程中会有所帮助：）
  * [QRCodeBest](https://qrcode.best/) - 使用 13 个模板创建自定义 QR 码，完全隐私和个人品牌。在 QRCode.Best 上具有跟踪像素、项目分类和无限团队席位的功能。
  * [PostPulse](https://post-pulse.io) - 通过每月 AI 撰写的帖子到 SEO 优化的域名来提升您的在线形象，增强您的 SEO 和网站排名。免费计划允许您每月在我们的网站上手动发布一篇帖子。
